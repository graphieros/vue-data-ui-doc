    ...
    state: () => {
        return {
            vue_ui_dag: {
                dataset: {
                    nodes: [
                        { id: "fd275806-8680-4225-9b9b-31efc58a7720", label: "Node 0",},
                        { id: "aa301c5b-0b34-4bd1-909f-da80a4fb5c58", label: "Node 1",},
                        { id: "28fcad54-192d-419c-8c36-899f35195067", label: "Node 2",},
                        // { id: "D", label: "D" },
                    ],
                    edges: [
                        { from: "fd275806-8680-4225-9b9b-31efc58a7720", to: "aa301c5b-0b34-4bd1-909f-da80a4fb5c58",},
                        { from: "fd275806-8680-4225-9b9b-31efc58a7720", to: "28fcad54-192d-419c-8c36-899f35195067" },
                        { from: "aa301c5b-0b34-4bd1-909f-da80a4fb5c58", to: "28fcad54-192d-419c-8c36-899f35195067" },
                        // { from: "B", to: "A" },
                        // { from: "C", to: "A" },
                        // { from: "B", to: "D" },
                        // { from: "C", to: "D" },
                ...
                model: [
                    ...
                    { key: 'userOptions.buttons.zoom', def: true, type: 'checkbox', label: ['button', 'zoom', 'is', 'show'], category: 'userOptions'},
                    ...
                    {key: 'userOptions.buttonTitles.zoom', def: 'Toggle zoom lock', type: 'text', label: ['button', 'zoom', 'title', 'is', 'textContent'], category: 'userOptions'},
                    ...
                    { key: 'style.chart.layout.rankDirection', def: 'TB', type: 'select', label: ['orientation'], options: ['TB', 'LR', 'BT', 'RL'], category: 'layout'},
                    { key: 'style.chart.layout.rankSeparation', def: 60, type: 'range', label: ['rank', 'is', 'separation'], min: 10, max: 100, step: 1,category: 'layout'},
                    { key: 'style.chart.layout.nodeSeparation', def: 50, type: 'range', label: ['node', 'is', 'separation'], min: 10, max: 100, step: 1,category: 'layout'},
                    { key: 'style.chart.layout.edgeSeparation', def: 30, type: 'range', label: ['edge', 'is', 'separation'], min: 10, max: 100, step: 1,category: 'layout'},
                    { key: 'style.chart.layout.nodeWidth', def: 100, type: 'range', label: ['node', 'is', 'width'], min: 40, max: 200, step: 1, category: 'layout'},
                    { key: 'style.chart.layout.nodeHeight', def: 40, type: 'range', label: ['node', 'is', 'height'], min: 20, max: 100, step: 1, category: 'layout'},
                    { key: 'style.chart.layout.curvedEdges', def: true, type: 'checkbox', label: ['edge', 'is', 'curved'], category: 'layout' },
                    { key: 'style.chart.layout.padding', def: 48, type: 'number', label: ['padding'], min: 10, max: 200, step: 2, category: 'layout'},
                    { key: 'style.chart.layout.arrowShape', def: 'vee', type: 'select', options: ['undirected', 'normal', 'vee'], label: ['arrow', 'is', 'shape'], category: 'layout'},
                    { key: 'style.chart.layout.arrowSize', def: 8, type: 'number', label: ['arrow', 'is', 'size'], min: 4, max: 12, category: 'layout'},
                    { key: 'style.chart.layout.align', def: '', type: 'select', options: ['', 'UR', 'UL', 'DR', 'DL'], label: ['alignment'], category: 'layout'},

                    { key: 'style.chart.nodes.stroke', def: '#CCCCCC', type: 'color', label: ['border', 'is', 'color'], category: 'nodes'},
                    { key: 'style.chart.nodes.strokeWidth', def: 1, type: 'number', min: 0, max: 12, label: ['border', 'is', 'thickness'], category: 'nodes'},
                    { key: 'style.chart.nodes.borderRadius', def: 3, type: 'number', min: 0, max: 24, label: ['border', 'is', 'radius'], category: 'nodes'},
                    { key: 'style.chart.nodes.backgroundColor', def: '#FFFFFF', type: 'color', label: ['backgroundColor'], category: 'nodes'},
                    { key: 'style.chart.nodes.labels.color', def: '#1A1A1A', type: 'color', label: ['label', 'is', 'textColor'], category: 'nodes'},
                    { key: 'style.chart.nodes.labels.fontSize', def: 12, type: 'number', min: 6, max: 24, label: ['label', 'is', 'fontSize'], category: 'nodes'},
                    { key: 'style.chart.nodes.labels.bold', def: false, type: 'checkbox', label: ['label', 'is', 'bold'], category: 'nodes'},
                    { key: 'style.chart.nodes.tooltip.showOnClick', def: true, type: 'checkbox', label: ['tooltip', 'is', 'showOnClick'], category: 'nodes'},
                    { key: 'style.chart.ndoes.tooltip.backgroundColor', def: '#E1E5E8', type: 'color', label: ['tooltip', 'is', 'backgroundColor'], category: 'nodes'},
                    { key: 'style.chart.nodes.tooltip.color', def: '#1A1A1A', type: 'color', label: ['tooltip', 'is', 'textColor'], category: 'nodes'},
                    { key: 'style.chart.nodes.tooltip.maxWidth', def: '300px', type: 'text', label: ['tooltip', 'is', 'max width'], category: 'nodes'},
                    ...
                    { key: 'style.chart.midpoints.stroke', def: '#CCCCCC', type: 'color', label: ['border', 'is', 'color'], category: 'midpoints'},
                    { key: 'style.chart.midpoints.fill', def: '#FFFFFF', type: 'color', label: ['backgroundColor'], category: 'midpoints'},
                    { key: 'style.chart.midpoints.strokeWidth', def: 1, type: 'number', min: 1, max: 4, label: ['border', 'is', 'thickness'], category: 'midpoints'},
                    { key: 'style.chart.midpoints.tooltip.maxWidth', def: '300px', type: 'text', label: ['tooltip', 'is', 'max width'], category: 'midpoints'},
                    { key: 'style.chart.midpoints.tooltip.backgroundColor', def: '#E1E5E8', type: 'color', label: ['tooltip', 'is', 'backgroundColor'], category: 'midpoints'},
                    { key: 'style.chart.midpoints.tooltip.color', def: '#1A1A1A', type: 'color', label: ['tooltip', 'is', 'textColor'], category: 'midpoints'},

                    { key: 'style.chart.controls.show', def: true, type: 'checkbox', label: 'show', category: 'controls'},
                    { key: 'style.chart.controls.position', def: 'bottom', type: 'select', options: ['top', 'bottom'], category: 'controls'},
                    { key: 'style.chart.controls.backgroundColor', def: '#E1E5E8', type: 'color', label: 'backgroundColor', category: 'controls'},
                    { key: 'style.chart.controls.buttonColor', def: '#E1E5E8', type: 'color', label: ['button', 'is', 'backgroundColor'], category: 'controls'},
                    { key: 'style.chart.controls.color', def: '#1A1A1A', type: 'color', label: ['button', 'is', 'textColor'], category: 'controls'},
                    { key: 'style.chart.controls.fontSize', def: 14, type: 'number', min: 8, max: 24, label: ['fontSize'], category: 'controls'},
                    { key: 'style.chart.controls.border', def: '1px solid #CCCCCC', type: 'text', label: ['border'], category: 'controls'},
                    { key: 'style.chart.controls.padding', def: '0.5rem', type: 'text', label: ['padding'], category: 'controls'},
                    { key: 'style.chart.controls.borderRadius', def: '0.25rem', type: 'text', label: ['border', 'is', 'radius'], category: 'controls'}
                ]
            },
            vue_ui_chord: {
                dataset: {
            ...
            vue_ui_world: {
                ...
                model: [
                    ...
                    { key: 'style.chart.dataLabels.rounding', def: 0, type: 'number', min: 0, max: 6, label: 'rounding', category: 'labels'},
                    ...
                    { key: 'style.chart.territory.strokeWidthSelected', def: 2, type: 'number', min: 0.1, max: 12, step: 0.1, label: ['country', 'selected', 'border', 'is', 'thickness'], category: 'general'},
                    { key: 'style.chart.territory.emptyColor', def: '#E0E0E0', type: 'color', label: ['country', 'is', 'emptyColor'], category: 'general'},
                    { key: 'style.chart.territory.showTaiwanAsPartOfChina', def: false, type: 'checkbox', label: 'showTaiwanAsPartOfChina', category: 'general' },
                    { key: 'style.chart.territory.colors.min', def: '#E0E0E0', type: 'color', label: ['min', 'is', 'color'], category: 'general'},
                    { key: 'style.chart.territory.colors.max', def: '#bf4819', type: 'color', label: ['max', 'is', 'color'], category: 'general'},
                    ...
                    { key: 'table.columnNames.category', def: 'Category', type: 'text', label: ['columnName', 'is', 'category'], category: 'table'},
                    { key: 'table.th.backgroundColor', def: '#FFFFFF', type: 'color', label: 'backgroundColorHeader', category: 'table'},
                    { key: 'table.th.color', def: '#1A1A1A', type: 'color', label: 'textColorHeader', category: 'table'},
                    { key: 'table.th.outline', def: 'none', type: 'text', label: 'outlineHeader', category: 'table' },
                    { key: 'table.td.backgroundColor', def: '#FFFFFF', type: 'color', label: 'backgroundColorRow', category: 'table' },
            ...
            vue_ui_circle_pack: {
                ...
                model: [
                    ...
                    { key: 'style.chart.circles.selectedShadowColor', def: '#1A1A1A', type: 'color', label: ['selected', 'circle', 'shadow', 'is', 'color'], category: 'general'},
            ...
            vue_ui_bullet: {
                ...
                model: [
                    ...
                    { key: 'style.chart.legend.position', def: 'bottom', type: 'select', options: ['top', 'bottom'], label: 'position', category: 'legend'},
            ...
            vue_ui_stackbar: {
                ...
                model: [
                    ...
                    { key: 'style.chart.zoom.enableSelectionDrag', def: true, type: 'checkbox', label: ['zoom', 'is', 'enable', 'handles'], category: 'zoom'},
                    { key: 'style.chart.zoom.enableSelectionDrag', def: true, type: 'checkbox', label: ['zoom', 'is', 'enable', 'selection', 'drag'], category: 'zoom'},

                    { key: 'style.chart.zoom.minimap.show', def: true, type: 'checkbox', label: ['zoom', 'minimap', 'is', 'show'], category: 'zoom'},
                    { key: 'style.chart.zoom.minimap.selectedColor', def: '#1f77b4', type: 'color', label: ['zoom', 'minimap', 'selected', 'is', 'color'], category: 'zoom'},
                    { key: 'style.chart.zoom.minimap.selectedColorOpacity', def: 0.2, type: 'range', min: 0, max: 1, step: 0.01, label: ['zoom', 'minimap', 'selected', 'color', 'is', 'opacity'], category: 'zoom'},
                    { key: 'style.chart.zoom.minimap.indicatorColor', def: '#1A1A1A', type: 'color', label: ['zoom', 'minimap', 'indicator', 'is', 'color'], category: 'zoom'},
                    { key: 'style.chart.zoom.minimap.frameColor', def: '#A1A1A1', type: 'color', label: ['zoom', 'minimap', 'frame', 'is', 'color'], category: 'zoom'},

                    { key: 'style.chart.zoom.preview.enable', def: true, type: 'checkbox', label: ['zoom', 'preview', 'is', 'enable'], category: 'zoom'},
                    { key: 'style.chart.zoom.preview.stroke', def: '#6A6A6A', type: 'color', label: ['zoom', 'preview', 'border', 'is', 'color'], category: 'zoom'},
                    { key: 'style.chart.zoom.preview.strokeWidth', def: 2, type: 'number', min: 0, max: 12, step: 0.1, label: ['zoom', 'preview', 'border', 'is', 'thickness'], category: 'zoom'},
                    { key: 'style.chart.zoom.preview.strokeDasharray', def: 0, type: 'number', min: 0, max: 24, label: ['zoom', 'preview', 'border', 'is', 'strokeDasharray'], category: 'zoom'},
            ...
            vue_ui_stackline: {
                ...
                model: [
                    ...
                    { key: 'style.chart.highlighter.color', def: '#1A1A1A', type: 'color', label: 'highlighterColor', category: "highlight" },
                    { key: 'style.chart.highlighter.opacity', def: 5, type: 'range', min: 0, max: 30, label: 'highlighterOpacity', category: 'highlight' },
                    { key: 'style.chart.highlighter.useLine', def: false, type: 'checkbox', label: ['use line'], category: 'highlight' },
                    { key: 'style.chart.highlighter.lineDasharray', def: 2, type: 'range', min: 0, max: 30, label: ['line :', 'dasharray'], category: 'highlight' },
                    ...
                    { key: 'style.chart.lines.distributed', def: false, type: 'checkbox', label: ['distributed'], category: 'line'},
                    { key: 'style.chart.lines.useArea', def: true, type: 'checkbox', label: ['area', 'is', 'show'], category: 'line'},
                    { key: 'style.chart.lines.areaOpacity', def: 0.5, type: 'range', min: 0, max: 1, step: 0.01, label: ['area', 'is', 'opacity'], category: 'line'},
                    { key: 'style.chart.lines.showDistributedPercentage', def: true, type: 'checkbox', label: ['distributed', 'percentage', 'is', 'show'], category: 'line'},
                    { key: 'style.chart.lines.strokeWidth', def: 1, type: 'number', min: 0, max: 6, label: ['border', 'is', 'thickness'], category: 'line'},
                    { key: 'style.chart.lines.gradient.show', def: true, type: 'checkbox', label: ['gradient', 'is', 'show'], category: 'line'},
                    { key: 'style.chart.lines.gradient.intensity', def: 20, type: 'range', min:0, max: 50, label: ['gradient', 'is', 'intensity'], category: 'line'},
                    { key: 'style.chart.lines.totalValues.show', def: true, type: 'checkbox', label: ['total', 'value', 'is', 'show'], category: 'line'},
                    { key: 'style.chart.lines.totalValues.offsetY', def: 0, type: 'number', min: -100, max: 100, label: ['total', 'value', 'is', 'offsetY'], category: 'line'},
                    { key: 'style.chart.lines.totalValues.fontSize', def: 16, type: 'number', min: 8, max: 42, label: ['total', 'value', 'is', 'fontSize'], category: 'line'},
                    { key: 'style.chart.lines.totalValues.bold', def: false, type: 'checkbox', label: ['total', 'value', 'is', 'bold'], category: 'line'},
                    { key: 'style.chart.lines.totalValues.color', def: '#1A1A1A', type: 'color', label: ['total', 'value', 'is', 'textColor'], category: 'line'},

                    { key: 'style.chart.lines.dot.useSerieColor', def: true, type: 'checkbox', label: ['plot', 'is', 'use series color'], category: 'line'},
                    { key: 'style.chart.lines.dot.fill', def: '#FFFFFF', type: 'color', label: ['plot', 'is', 'color'], category: 'line'},
                    { key: 'style.chart.lines.dot.strokeWidth', def: 0.5, type: 'range', min: 0.1, max: 6, step: 0.1, label: ['plot', 'is', 'strokeWidth'], category: 'line'},
                    { key: 'style.chart.lines.dot.radius', def: 4, type: 'range', min: 1, max: 24, label: ['plot', 'is', 'radius'], category: 'line'},

                    { key: 'style.chart.lines.dataLabels.show', def: true, type: 'checkbox', label: 'show', category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.hideEmptyValues', def: false, type: 'checkbox', label: ['empty values', 'is', 'hide'], category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.hideEmptyPercentages', def: false, type: 'checkbox', label: ['empty percentages', 'is', 'hide'], category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.adaptColorToBackground', def: true, type: 'checkbox', label: ['textColor', 'is', 'auto'], category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.color', def: '#1A1A1A', type: 'color', label: ['textColor', 'is', 'default'], category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.fontSize', def: 14, type: 'number', min: 8, max: 42, label: ['fonSize'], category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.bold', def: false, type: 'checkbox', label: 'bold', category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.rounding', def: 0, type: 'number', min: 0, max: 6, label: 'rounding', category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.prefix', def: '', type: 'text', label: 'prefix', category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.suffix', def: '', type: 'text', label: 'suffix', category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.hideUnderValue', def: null, type: 'number', label: 'hideUnderValue', min: 0, max: 100000, category: 'labels'},
                    { key: 'style.chart.lines.dataLabels.hideUnderPercentage', def: null, type: 'number', label: 'hide under percentage', min: 0, max: 100000, category: 'labels'},
            ...
            vue_ui_xy: {
                ...
                model: [
                    ...
                    { key: 'downsample.threshold', def: 1500, type: 'number', min: 100, max: 5000, label: ['LTTB', 'algorithm', 'is', 'threshold'], category: 'general'},
                    ...
                    { key: 'chart.zoom.enableRangeHandles', def: true, type: 'checkbox', label: ['zoom', 'is', 'enable', 'handles'], category: 'zoom'},
                    { key: 'chart.zoom.enableSelectionDrag', def: true, type: 'checkbox', label: ['zoom', 'is', 'enable', 'selection', 'drag'], category: 'zoom'},

                    { key: 'chart.zoom.minimap.show', def: true, type: 'checkbox', label: ['zoom', 'minimap', 'is', 'show'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.smooth', def: false, type: 'checkbox', label: ['zoom', 'minimap', 'is', 'smooth'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.selectedColor', def: '#1F77B4', type: 'color', label: ['zoom', 'minimap', 'selected', 'is', 'color'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.selectedColorOpacity', def: 0.2, type: 'range', min: 0.1, max: 0.5, step: 0.01, label: ['zoom', 'minimap', 'selected', 'is', 'opacity'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.lineColor', def: '#1A1A1A', type: 'color', label: ['zoom', 'minimap', 'line', 'is', 'color'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.selectionRadius', def: 2, type: 'range', min: 0, max: 24, label: ['zoom', 'minimap', 'selection', 'is', 'radius'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.indicatorColor', def: '#1A1A1A', type: 'color', label: ['zoom', 'minimap', 'indicator', 'is', 'color'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.verticalHandles', def: false, type: 'checkbox', label: ['zoom', 'minimap', 'vertical', 'handles'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.compact', def: true, type: 'checkbox', label: ['zoom ', 'minimap', 'is', 'compact'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.merged', def: true, type: 'checkbox', label: ['zoom ', 'minimap', 'is', 'merged'], category: 'zoom'},
                    { key: 'chart.zoom.minimap.frameColor', def: '#CCCCCC', type: 'color', label: ['zoom ', 'minimap', 'frame', 'is', 'color'], category: 'zoom'},

                    { key: 'chart.zoom.preview.enable', def: true, type: 'checkbox', label: ['zoom', 'preview', 'is', 'show'], category: 'zoom'},
                    { key: 'chart.zoom.preview.stroke', def: '#6A6A6A', type: 'color', label: ['zoom', 'preview', 'stroke', 'is', 'color'], category: 'zoom'},
                    { key: 'chart.zoom.preview.strokeWidth', def: 2, type: 'number', min: 0, max: 12, label: ['zoom', 'preview', 'is', 'strokeWidth'], category: 'zoom'},
                    { key: 'chart.zoom.preview.strokeDasharray', def: 0, type: 'number', min: 0, max: 12, label: ['zoom', 'preview', 'border', 'is', 'thickness'], category: 'zoom'},
            ...
            vue_ui_donut: {
                ...
                model: [
                    ...
                    { key: 'autoSize', def: false, type: 'checkbox', label: 'autoSize', category: 'general' },
                    ...
                    { key: 'style.chart.layout.curvedMarkers', def: false, type: 'checkbox', label: ['markers', 'is', 'curved'], category: 'labels'},
            ...
            vue_ui_wheel: {
                ...
                model: [
                    { key: 'debug', def: false, type: 'checkbox', label: 'debug', category: 'general' },
                    { key: 'loading', def: false, type: 'checkbox', label: 'loading', category: 'general' },
                    { key: 'layout', def: 'classic', type: 'select', options: ['classic', '3d'], label: 'layout', category: 'general'},
                    { key: 'style.fontFamily', def: 'inherit', type: 'text', label: 'fontFamily', category: 'general' },
                    { key: 'style.chart.backgroundColor', def: '#FFFFFF', type: 'color', label: 'backgroundColor', category: 'general' },
                    { key: 'style.chart.color', def: '#1A1A1A', type: 'color', label: 'textColor', category: 'general' },
                    ...
                    { key: 'style.chart.layout.wheel.radiusRatio', def: 1, type: 'number', min: 0.1, max: 1, step: 0.1, label: ['wheel', 'is', 'radius ratio'], category: 'general'},
                    { key: 'style.chart.layout.wheel.tiltAngle3d', def: 50, type: 'range', min: 10, max: 80, label: ['wheel', '3d', 'is', 'tilt angle'], category: 'general'},
                    ...
                    { key: 'style.chart.layout.innerCircle.radiusRatio', def: 1, type: 'range', min: 0, max: 2, step: 0.01, label: ['hollow', 'circle', 'is', 'radius ratio'], category: 'general'},
                    ...
                    { key: 'style.chart.layout.percentage.offsetX', def: 0, type: 'number', min: -100, max: 100, label: 'offsetX', category: 'labels'},
                    { key: 'style.chart.layout.percentage.offsetY', def: 0, type: 'number', min: -100, max: 100, label: 'offsetY', category: 'labels'},
                    { key: 'style.chart.layout.percentage.stroke', def: 'transparent', type:'color', label: ['border', 'is', 'color'], category: 'labels'},
                    { key: 'style.chart.layout.percentage.strokeWidth', def: 0, type: 'number', min: 0, max: 24, label: ['border', 'is', 'thickness'], category: 'labels'},
            ...
            vue_ui_horizontal_bar: {
                ...
                model: [
                    ...
                    { key: 'useCssAnimation', def: true, type: 'checkbox', label: 'useCssAnimation', category: 'general' },
                    { key: 'style.fontFamily', def: 'inherit', type: 'text', label: 'fontFamily', category: 'general' },
                    { key: 'style.chart.width', def: 512, type: 'number', min: 200, max: 1000, label: 'width', category: 'general'},
                    { key: 'style.chart.height', def: 316, type: 'number', min: 200, max: 1000, label: 'height', category: 'general'},
                    { key: 'style.chart.backgroundColor', def: '#FFFFFF', type: 'color', label: 'backgroundColor', category: 'general' },
                    { key: 'style.chart.color', def: '#1A1A1A', type: 'color', label: 'textColor', category: 'general' },
            ...
            vue_ui_sparkhistogram: {
                ...
                model: [
                    ...
                    { key: 'style.backgroundColor', def: '#FFFFFF', type: 'color', label: 'backgroundColor', category: 'general' },
                    { key: 'style.fontFamily', def: 'inherit', type: 'text', label: 'fontFamily', category: 'general' },
                    { key: 'style.layout.height', def: 96, type: 'number', step:10,  min: 70, max: 500, label: 'height', category: 'general' },
                    { key: 'style.layout.width', def: 640, type: 'number', step:10,  min: 500, max: 1200, label: 'width', category: 'general' },
                    ...
                    { key: 'style.bars.colors.positive', def: '#6376DD', type: 'color', label: ['color', 'is', 'positive'], category: 'general', old: true },
                    { key: 'style.bars.colors.negative', def: '#ff6400', type: 'color', label: ['color', 'is', 'negative'], category: 'general', old: true },
            ...
            vue_ui_rings: {
                ...
                model: [
                    ...
                    { key: 'style.chart.layout.labels.dataLabels.show', def: false, type: 'checkbox', label: 'show', category: 'labels'},
                    ...
                    { key: 'style.chart.layout.labels.dataLabels.color', def: '#1A1A1A', type: 'color', label: 'textColor', category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.fontSize', def: 12, type: 'number', min: 8, max: 24, label: 'fontSize', category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.bold', def: false, type: 'checkbox', label: 'bold', category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.offsetX', def: 0, type: 'number', min: -24, max: 24, label: 'offsetX', category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.markers.stroke', def: '#8A8A8A', type: 'color', label: ['marker', 'is', 'color'], category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.markers.strokeWidth', def: 1, type: 'number', min: 0, max: 12, label: ['marker', 'is','thickness'], category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.markers.radius', def: 3, type: 'number', min: 0, max: 10, label: ['marker', 'is', 'radius'], category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.markers.position', def: 'right', type: 'select', options:['left', 'right'], label: ['position'], category: 'labels'},

                    { key: 'style.chart.layout.labels.dataLabels.prefix', def: '', type: 'text', label: ['labels', 'is', 'prefix'], category: 'labels' },
                    { key: 'style.chart.layout.labels.dataLabels.suffix', def: '', type: 'text', label: ['labels', 'is', 'suffix'], category: 'labels' },
                    { key: 'style.chart.layout.labels.dataLabels.showValueFirst', def: true, type: 'checkbox', label: ['value', 'is', 'show first'], category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.usePercentageParens', def: true, type: 'checkbox', label: ['percentage', 'is', 'parens'], category: 'labels'},
                    { key: 'style.chart.layout.labels.dataLabels.useValueParens', def: false, type: 'checkbox', label: ['value', 'is', 'parens'], category: 'labels'},
