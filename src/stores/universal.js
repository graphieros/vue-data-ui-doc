        ...
        return {
            translations: {
                features: {
                    ...
                    ja: 'VueDataUiコンポーネントは、使用しているコンポーネントのすべての機能 (イベント、スロット、公開メソッド、テーマ) を所有します。',
                ...
                presentation:  {
                    ...
                    ja: 'ライブラリから多くのコンポーネントを使用している場合は、ユニバーサル VueDataUi コンポーネントのみをインポートすることを選択できます。必要なコンポーネントの名前、そのデータセットおよび構成プロパティを指定すると、このラッパーは要求されたコンポーネントの非同期インポートを実行します。',
