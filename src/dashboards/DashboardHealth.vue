...
const DATASET_LIFE_EXPECTANCY = ref([
    {
        ...
        series: [
            66.4, 66.8, 67.1, 67.4, 67.7, 68.1, 68.6, 69, 69.3, 69.7, 70.1,
            70.4, 70.8, 71.1, 71.4, 71.6, 71.9, 72.1, 72.4, 72.6, 71.9, 70.9,
            72.6, 73.2, 73.33, 73.49,
        ],
        type: "line",
    },
]);
...
<template>
    <div
        class="grid grid-cols-1 sm:grid-cols-2 max-w-[1200px] mx-auto gap-4 mt-12 p-4 bg-white dark:bg-[#3A3A3A] min-h-[520px]"
    >
                    ...
                    >
                        ...
                        <template #source>
                            <div class="text-xs px-4 text-left text-[#8A8A8A]">
                                Source: UN WPP (2024); HMD (2024); Zijdeman et
                                al. (2015); Riley (2005)
                            </div>
                        </template>
                    </VueDataUi>
