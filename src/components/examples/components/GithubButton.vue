...
<template>
    <a href="https://github.com/graphieros/vue-data-ui" target="_blank" class="hover:-translate-y-[2px] transition-all z-50 fixed bottom-[90px] right-2 rounded-full p-2 flex place-items-center justify-center border h-[42px] w-[42px] border-[#fdd663] hover:shadow-md bg-gradient-to-b from-[#f7e2a3] to-[#fdd663]">
    ...
    <a v-if="issues" href="https://github.com/graphieros/vue-data-ui/issues" target="_blank" class="hover:-translate-y-[2px] transition-all z-50 fixed bottom-[170px] right-2 rounded-full p-2 flex place-items-center justify-center border h-[42px] w-[42px] border-[#dd7963] hover:shadow-md bg-gradient-to-b from-[#ffa793] to-[#dd7963]">
        <BrandGithubFilledIcon class="text-black" size="24"/>
