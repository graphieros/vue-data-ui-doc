...
const dataset = ref([
    {
        name: "Europe",
        values: [255, 325, 412, 241, 315, 243, 413, 367, 200, 125, 400, 629],
        color: "#6376DD",
    },
    {
        name: "America",
        values: [540, 620, 512, 455, 670, 312, 225, 650, 570, 455, 900, 1200],
        color: "#42d392",
    },
    {
        name: "China",
        values: [459, 412, 125, 112, 115, 540, 655, 259, 325, 368, 678, 887],
        color: "#ff6400",
    },
]);
