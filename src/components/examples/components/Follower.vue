...
<template>
    <svg
        ...
        :style="`z-index: 9999999999; pointer-events: none;background: transparent; position:fixed; top:${position.y}px; left:${position.x}px;`"
        viewBox="0 0 100 100"
        height="100"
        width="100"
    >
        ...
        <circle
            ...
            r="49"
            fill="url(#follower)"
            :stroke="isDarkMode ? '#CCCCCC20' : '#1A1A1A20'"
        />
        <circle
            cx="50"
            cy="50"
            ...
            stroke="#42d392"
            :class="{
                'follower-action': !isFetching,
                'follower-action-fetching': isFetching,
            }"
        />
    </svg>
</template>
