...
const types = ref({
    ...
    combined: ["vue_ui_chestnut", "vue_ui_donut_evolution"],
    tables: [
        "vue_ui_table",
    ...
    rating: ["vue_ui_rating", "vue_ui_smiley"],
    utilities: [
        "vue_ui_skeleton",
        "vue_ui_dashboard",
        "vue_ui_annotator",
...
const dataset = computed(() => {
    const classic = Object.keys(CONFIG)
        .map((c) => {
            return {
    ...
    const combined = Object.keys(CONFIG)
        .map((c) => {
            return {
                name: c.replace("vue_ui_", ""),
                value: countAttributes(CONFIG[c]),
    ...
    const rating = Object.keys(CONFIG)
        .map((c) => {
            return {
                name: c.replace("vue_ui_", ""),
                value: countAttributes(CONFIG[c]),
    ...
    const utilities = Object.keys(CONFIG)
        .map((c) => {
            return {
                name: c.replace("vue_ui_", ""),
                value: countAttributes(CONFIG[c]),
