...
<template>
    <div
        class="max-w-[1200px] mx-auto flex gap-4 flex-wrap mt-12 justify-center"
    >
        <VueDataUi
            component="VueUiKpi"
            :dataset="135.42"
            :config="{
                ...
                layoutClass:
                    'p-4 rounded-md shadow-md bg-white dark:bg-[#2A2A2A]',
        ...
        >
            <template #comment-before>
                <div class="max-w-[200px] text-xs my-2 text-gray-500">
                    2025 data collected from all shops located in eastern
                    Europe.
                </div>
            </template>
        ...
        >
            <template #comment-before>
                <div class="max-w-[300px] text-xs my-2 text-gray-500">
                    2026 projections based on 2025 revenue collected from all
                    shops located in eastern Europe.
                </div>
            </template>
        ...
        >
            <template #comment-before>
                <div class="max-w-[300px] text-xs my-2 text-gray-500">
                    2025 results based on data collected from all shopw located
                    in eastern Europe.
                </div>
            </template>
    ...
    <div
        class="max-w-[927px] mx-auto bg-white dark:bg-[#2A2A2A] mt-4 rounded p-2 shadow-md relative"
    >
        <VueDataUi
        ...
        >
            <template #caption>
                <div
                    ...
                    class="pb-8 font-black text-[#3A3A3A] dark:text-gray-400 text-left pl-2"
                >
            ...
            <template
                #cell="{ value, rowIndex, colIndex, type, color, textColor }"
            >
                <div
