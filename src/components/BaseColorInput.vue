...
<template>
    <BaseCard padding="0" type="light" :class="wrapperTw">
        <div class="inline-flex flex-col flex-wrap px-2 mt-2 pb-2">
            <slot name="before" />
            <code v-if="labelAsCode" class="text-black dark:text-[#CCCCCC]">{{
                label
            }}</code>
            <label v-else class="text-xs text-black dark:text-white">{{
                label
            }}</label>
                            ...
                            >
                                <BaseCard type="light" padding="p-2">
                                    <div class="flex flex-col">
                                        <div
                                            class="flex flex-row flex-wrap max-w-[150px] p-1 gap-1 text-xs justify-center mx-auto"
                                        >
                                            <button
                                                v-for="p in themePalettes"
                                                @click="setPalette(p)"
                                                class="pl-1 pr-2 bg-white shadow-md dark:bg-[#5A5A5A] text-black dark:text-[#FFFFFF] rounded-full flex flex-row place-items-center gap-1"
                                                :style="{
                                                    outline:
                                                        selectedPalette ===
                                                        p.name
                                        ...
                                        <div
                                            class="color-picker-dialog bg-transparent"
                                            :style="{
                                        ...
                                        >
                                            ...
                                            <div />
                                            <div
                                                class="absolute -top-3 -right-3 bg-white dark:bg-[#2A2A2A] shadow-md rounded-full"
                                            >
                                                <button
                                                    @click="close"
