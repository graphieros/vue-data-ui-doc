...
<template>
    <router-link :to="link" :class="{'link-disabled': isSelected(link), 'text-black-100 dark:text-gray-200': !isSelected(link), 'text-black dark:text-app-green': isSelected(link)}">
