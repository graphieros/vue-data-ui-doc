...
<template>
    ...
    <BaseCard>
        <div class="flex flex-col bg-white dark:bg-[#2A2A2A] p-4 rounded-lg">
            ...
            >
                <div
                    class="w-[100px] text-right text-black dark:text-[#CCCCCC]"
                    :style="`margin-bottom:${i === 0 ? '-40px' : '0'}`"
                >
                    {{ item.title }}
                </div>
                <div class="w-full">
    ...
    <CodeParser class="my-4" language="javascript" :content="codeScript" />
    <CodeParser language="html" :content="codeTemplate" />
</template>
