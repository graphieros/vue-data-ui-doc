    ...
    <div>
            ...
            >
                ...
                <template #layer-under="{ value, size, focusedValue }">
                    <svg viewBox="0 0 10 10" :style="{ overflow: 'visible' }">
                        <path
                            v-if="value === 1"
                            :stroke="
                                focusedValue === value ? colorUnder : colorFocus
                            "
                ...
                >
                    <svg viewBox="0 0 10 10" :style="{ overflow: 'visible' }">
                        <path
                            v-if="value === 1"
                            :fill="colorsAbove_1[value]"
                            :stroke="colorsAbove_1[value]"
                            stroke-linecap="round"
                            d="M 0 5 L 10 4 L 10 6 L 0 5 Z"
                            :style="{
        ...
        <div class="flex justify-center mt-6">
            ...
            >
                ...
                <a
                    href="https://github.com/graphieros/vue-data-ui-doc/blob/master/src/components/useCases/uc-rating.vue"
                    target="_blank"
                >
