...
const translations = ref({
    description: {
        ...
        ja: "タイムスタンプとして提供された x 軸の値は、datetimeFormatter を使用してフォーマットできます：",
    ...
    enable: {
        ...
        ja: "true に設定されているとフォーマッターが有効になります。false に設定されている場合、x 軸の値は提供したものと同じままになります。",
    ...
    locale: {
        ...
        ja: "公式のロケール省略形を使用してロケールを選択してください",
    ...
    useUTC: {
        ...
        ja: "すべての解析とフォーマットを UTC で行うかローカルタイムゾーンで行うかを決定します",
...
<template>
    <div>
        ...
        <CodeParser language="javascript" :content="content" />
        <div class="flex flex-col gap-2 mt-4">
            <div
                dir="auto"
                v-for="key in Object.keys(translations).filter(
                    (k) => k !== 'description',
                )"
