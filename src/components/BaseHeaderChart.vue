    ...
    <div :class="headerClass">
        ...
        <div class="w-full pl-14 flex flex-col">
            <div class="flex flex-row gap-6 pr-24">
                <h1
                    class="flex flex-col sm:flex-row place-items-center w-full justify-start gap-5 font-inter-medium text-app-blue mb-2 text-2xl"
                >
                    <div class="flex flex-row place-items-center gap-2">
                        ...
                        <span
                            >VueUi<span
                                class="text-black dark:text-app-blue-light"
                                >{{ componentName }}</span
                            ></span
                        >
                    </div>
            ...
            <p
                class="max-w-[300px] sm:max-w-[600px] -ml-6 sm:ml-0 text-md text-black dark:text-gray-500 mb-2 text-left"
            >
                {{ description }}
            </p>
        </div>
