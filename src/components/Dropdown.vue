    ...
    <div>
        <VueDataUi component="VueUiAccordion" :config="config">
            ...
            <template #title="{ isOpen }">
                <div class="relative w-full py-2 pl-2 rounded rounded-tr-[24px] rounded-br-[24px] hover:bg-[#abc2f630] dark:hover:bg-[#abc2f610] transition-colors" :style="`background: ${isOpen ? isDarkMode ? '#abc2f630' : '#abc2f650' : ''}`">
                    <div>{{ title }}</div>
