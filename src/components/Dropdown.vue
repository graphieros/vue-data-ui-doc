            ...
            <VueDataUi component="VueUiAccordion" :config="{
                ...
                <template #title="{ isOpen }">
                    <div :class="`
                        ...
                        relative w-full py-2.5 pl-2 -mr-1 ${isOpen ? 'rounded-t-[24px] rounded-b-[6px]' : 'rounded-[24px]'} dark:hover:bg-[#2A2A2A] transition-colors ${isOpen ? 'bg-app-blue-light dark:bg-[#242424]' : 'bg-gray-200 dark:bg-[#242424]'}`">
