...
<template>
    <div class="flex flex-col gap-4">
        ...
        <CodeParser language="html" :content="code" @copy="store.copy()" />
        <button
        ...
        >
            ...
            <a
                href="https://github.com/graphieros/vue-data-ui-doc/blob/master/src/components/TreemapXy.vue"
                target="_blank"
            >
