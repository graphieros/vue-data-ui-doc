...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_sparkbar.model)),
);
...
onMounted(() => {
    ...
    if (localStorage.sparkbarDataset) {
        ...
        localStorage.setItem(
            "sparkbarDataset",
            JSON.stringify(defaultData.vue_ui_sparkbar.dataset),
        );
    }
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_sparkbar.model),
    );
    step.value += 1;
    ...
    <div>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-left text-xs">
                                        {{
                                            makerTranslations.labels.rounding[
                                                store.lang
                                            ]
                                        }}
                                    </th>
        ...
        <div class="overflow-x-auto text-xs max-w-[800px] mx-auto">
            <ComponentContent
                :dataset="
                    datasetItems.map(
                        ({ name, value, color, prefix, suffix, rounding }) => {
                            return {
                                name,
                                value,
                                color,
