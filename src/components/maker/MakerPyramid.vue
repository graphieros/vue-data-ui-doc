...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_age_pyramid.model)),
);
...
onMounted(() => {
    ...
    if (localStorage.pyramidDataset) {
        ...
        localStorage.setItem(
            "pyramidDataset",
            JSON.stringify(defaultData.vue_ui_age_pyramid.dataset),
        );
    }
    step.value += 1;
});
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_age_pyramid.model),
    );
    step.value += 1;
                            ...
                            <thead>
                                <tr>
                                    <th class="text-left text-xs h-[40px]">
                                        {{
                                            makerTranslations.labels.period[
                                                store.lang
                                            ]
                                        }}
                                    </th>
                                    ...
                                    <th class="text-left text-xs">
                                        {{
                                            makerTranslations.labels.right[
                                                store.lang
                                            ]
                                        }}
                                    </th>
