...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_nested_donuts.model)),
);
...
onMounted(() => {
    ...
    if (localStorage.nestedDonutsDataset) {
        ...
        localStorage.setItem(
            "nestedDonutsDataset",
            JSON.stringify(defaultData.vue_ui_nested_donuts.dataset),
        );
    }
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_nested_donuts.model),
    );
    step.value += 1;
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td v-for="(s, j) in ds.series">
                                        <div
                                            class="flex flex-col gap-2 p-4 mx-2 rounded-md shadow-md relative"
