...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_bump.model)),
);
...
onMounted(() => {
    ...
    if (localStorage.bumpDataset) {
        ...
        localStorage.setItem(
            "bumpDataset",
            JSON.stringify(defaultData.vue_ui_bump.dataset),
        );
    }
    step.value += 1;
});
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_bump.model),
    );
    step.value += 1;
                                                    ...
                                                    <AlertTriangleIcon
                                                        ...
                                                        v-if="
                                                            !CONFIG_MODEL.find(
                                                                (el) =>
                                                                    el.key ===
                                                                    'style.chart.layout.timeLabels.values',
                                                            ).def[j]
                                                        "
                                                /></label>
                                                <input
