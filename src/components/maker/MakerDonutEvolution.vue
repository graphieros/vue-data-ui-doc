...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_donut_evolution.model)),
);
...
onMounted(() => {
    ...
    if (localStorage.donutEvolutionDataset) {
        ...
        localStorage.setItem(
            ...
            JSON.stringify(defaultData.vue_ui_donut_evolution.dataset),
        );
    }
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_donut_evolution.model),
    );
    step.value += 1;
                                                ...
                                                <AlertTriangleIcon
                                                    ...
                                                    v-if="
                                                        !CONFIG_MODEL.find(
                                                            (el) =>
                                                                el.key ===
                                                                'style.chart.layout.grid.xAxis.dataLabels.values',
                                                        ).def[j]
                                                    "
                                            /></label>
                                            <input
