...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_sparkline.model)),
);
...
onMounted(() => {
    ...
    if (localStorage.sparklineDataset) {
        ...
        localStorage.setItem(
            "sparklineDataset",
            JSON.stringify(defaultData.vue_ui_sparkline.dataset),
        );
    }
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_sparkline.model),
    );
    step.value += 1;
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    >
                                        <div
                                            class="flex flex-col gap-2 px-1 relative"
                                        >
                                            <div
                            ...
                            <tbody>
                                <tr>
                                    <td
                                        ...
                                        v-for="ds in datasetItems"
                                    >
                                        <div
                                            class="flex flex-col gap-2 px-1 mt-2"
                                        >
                                            <label>{{
