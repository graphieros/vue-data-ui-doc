...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_gizmo.model)),
);
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_gizmo.model),
    );
    step.value += 1;
    ...
    <div>
        ...
        <div class="w-full mt-[64px]" style="height: calc(100% - 64px)">
            <Transition name="fade">
                ...
                >
                    <div
                        class="w-full max-w-[300px] mx-auto bg-white flex place-items-center justify-center py-12"
                    >
                        <VueUiGizmo
                            ref="chart"
