...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_thermometer.model)),
);
const dataset = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_thermometer.dataset)),
);
...
onMounted(() => {
    ...
    if (localStorage.thermometerDataset) {
        ...
        localStorage.setItem(
            "thermometerDataset",
            JSON.stringify(defaultData.vue_ui_thermometer.dataset),
        );
    }
    step.value += 1;
});
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_thermometer.model),
    );
    step.value += 1;
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-left text-xs h-[40px]">
                                        {{
                                            makerTranslations.labels.scale[
                                                store.lang
                                            ]
                                        }}
                                    </th>
