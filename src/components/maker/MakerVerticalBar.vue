                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div v-for="(child, j) in ds.children" :key="`${ds.id}_${j}`" class="relative p-2 bg-[#FFFFFF33] dark:bg-[#FFFFFF10] rounded shadow-md mb-2">

                                            <BaseButton
                                                color="error"
                                                :size="4"
                                                fab
                                                @click="nukeChild({ parentId: ds.id, index: j})"
