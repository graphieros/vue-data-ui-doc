...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_stackline.model)),
);
...
onMounted(() => {
    ...
    if (localStorage.stacklineDataset) {
        ...
        localStorage.setItem(
            "stacklineDataset",
            JSON.stringify(defaultData.vue_ui_stackline.dataset),
        );
    }
    step.value += 1;
});
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_stackline.model),
    );
    step.value += 1;
        ...
        <BaseCard>
            <details open>
                ...
                <div
                    ...
                    :class="`w-full overflow-x-auto overflow-y-visible relative shadow dark:shadow-md p-3 pl-6 rounded flex flex-row gap-3 mb-2`"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input
                                        type="checkbox"
                                        v-model="datasetItems[i].standalone"
                                    />
                                </td>
                                <td
                                    class="bg-[#FFFFFF10] p-2 rounded-md flex flex-row place-items-center"
                                >
                                    <div
                                    ...
                                    >
                                        <div
                                            class="flex flex-col p-2 bg-[#FFFFFF10]"
                                        >
                                            <BaseButton
                                                color="error"
                                                :size="4"
                                                    ...
                                                    <AlertTriangleIcon
                                                        ...
                                                        v-if="
                                                            !CONFIG_MODEL.find(
                                                                (el) =>
                                                                    el.key ===
                                                                    'style.chart.grid.x.timeLabels.values',
                                                            ).def[j]
                                                        "
                                                /></label>
                                                <input
