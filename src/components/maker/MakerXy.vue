...
const CONFIG_MODEL = ref(
    JSON.parse(JSON.stringify(defaultData.vue_ui_xy.model)),
);
...
onMounted(() => {
    ...
    if (localStorage.xyDataset) {
        ...
        localStorage.setItem(
            "xyDataset",
            JSON.stringify(defaultData.vue_ui_xy.dataset),
        );
    }
    step.value += 1;
});
...
function resetModel() {
    CONFIG_MODEL.value = JSON.parse(
        JSON.stringify(defaultData.vue_ui_xy.model),
    );
    step.value += 1;
...
<template>
    <div>
        ...
        <div
            class="w-full mt-[64px]"
            style="height: calc(100% - 64px); isolation: isolate"
        >
            ...
            <div class="relative z-0">
                <VueDataUi component="VueUiAccordion" :config="accordionConfig">
                    <template #title>
                                ...
                                >
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                <th
                                                    class="text-left text-xs h-[40px]"
                                                >
                                                    {{
                                                        xyTranslations.labels
                                                            .color[store.lang]
                                                    }}
                                                </th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        <option
                                                            v-for="t in selectedChart.types"
                                                        >
                                                            {{ t }}
                                                        </option>
                                                    </select>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <option
                                                            v-for="tag in selectedChart.showSerieName"
                                                        >
                                                            {{ tag }}
                                                        </option>
                                                    </select>
