...
const commonButtonStyle =
    "bg-gray-50 dark:bg-[#2A2A2A] hover:bg-white dark:hover:bg-[#1A1A1A] transition-colors";
</script>

<template>
    <div class="text-left mt-12 w-5/6 mx-auto mb-12 max-w-[1200px]">
        If you prefer not to use the charts' built-in user options menu, but
        need to create your own:

        <div class="mt-6 text-lg">1. Hide the built-in user options menu:</div>
            ...
            <div class="w-full">
                <BaseCard class="mb-2 w-fit mx-auto">
                    <div class="flex flex-row flex-wrap">
                            ...
                            <VueUiIcon
                                :name="
                                    isTooltipEnabled
                                        ...
                                        : 'tooltipDisabled'
                                "
                                :stroke="isDarkMode ? '#83a4f2' : '#3456a3'"
                            />
                        </BaseButton>
                        ...
                        >
                            <VueUiIcon
                                :name="isTableOpen ? 'tableOpen' : 'tableClose'"
                                :stroke="isDarkMode ? '#83a4f2' : '#3456a3'"
                            />
                        </BaseButton>
