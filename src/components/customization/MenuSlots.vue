...
<template>
    <div class="text-left mt-12 w-5/6 mx-auto mb-12 max-w-[1200px]">
        ...
        <span class="text-orange-500"
            >Check out the docs to know what options are available for a given
            chart.</span
        >
        <div
            class="w-full bg-[#2A2A2A] dark:bg-[#FFFFFF10] my-4 rounded-md p-4"
        >
            <CodeParser
                :content="code0"
                language="javascript"
        ...
        If you want to customize the contents of the options menu, you can
        leverage the slots provided with each chart. The click event is managed
        by the component.<br />
        ...
        The #optionFullscreen slot has a specific implementation, where you need
        to apply a click event with the exposed data:
        ...
        The menu icon is also customizable if you don't like the classical
        burger menu icon:
        <div
            class="w-full bg-[#2A2A2A] dark:bg-[#FFFFFF10] my-4 rounded-md p-4"
        >
                ...
                <thead>
                    <tr class="bg-[#FFFFFF05]">
                        <th class="border border-slate-600 p-2">
                            Config attribute (show | hide option)
                        </th>
                        <th class="border border-slate-600 p-2">
                            Slot name (customize content)
                        </th>
                    </tr>
                </thead>
                <tbody>
