...
const title = ref({
    ...
    jp: 'ウォーターマークは、ほとんどの大きなチャートに追加できます。このウォーターマークは、常に表示されるように設定することも、PDF および PNG のダウンロード時にのみ表示されるように設定することもできます。',
...
const comment2 = ref({
    ...
    jp: 'または、PDF および PNG のダウンロードでのみ表示されるようにします。',
...
<template>
    <Suspense>
        <template #default>
            <div class="w-full max-w-[800px] overflow-hidden mx-auto">
                <div class="my-6" dir="auto">
                    {{ title[store.lang] }}
                </div>
                <VueUiDonut :dataset="dataset" :config="isDarkMode ? darkModeConfig : config">
