...
<template>
    ...
    <BaseCustomizationBox
        :title="translations.customization.comment[store.lang]"
    >
        <template #code>
            <CodeParser
...
<CodeParser :content="contentArrow" language="html" @copy="store.copy()" />
        ...
        <template #after>
            <details>
                ...
                <div class="px-4 py-2 bg-gray-100 dark:bg-[#2A2A2A]">
                    ...
                    <ul class="pl-3">
                        <li>
                            <code>markerEnd?: boolean;</code> (default: true)
                        </li>
                        <li><code>markerSize?: number;</code> (default: 10)</li>
                        <li>
                            <code>markerStart?: boolean;</code> (default: false)
                        </li>
                        <li>
                            <code>stroke?: string;</code> (default: "#2D353C")
                        </li>
                        <li>
                            <code>strokeDahsarray?: number;</code> (default: 0)
                        </li>
                        <li>
                            <code
    ...
    <BaseCustomizationBox
        :title="translations.customization.injectImage[store.lang]"
    >
        <template #code>
            <CodeParser
