...
<div class="px-4 max-w-[1200px] mx-auto mt-4 mb-8" dir="auto">
    {{ translations.customization.source[store.lang] }}
</div>
...
<BaseCustomizationBox>
    ...
    <VueDataUi component="VueUiDonut" :dataset="dataset" :config="isDarkMode ? darkModeConfig : config">
        <template #source>
            <div class="text-xs text-left px-8 pb-6 text-gray-500">
                Source: Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, dolor animi earum at delectus, quae, optio exercitationem velit odio veritatis accusantium nobis. Tempore consequatur inventore a recusandae libero provident eius.
            </div>
        </template>
    </VueDataUi>
    </template>
