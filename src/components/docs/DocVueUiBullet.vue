...
<template>
    <div>
        <BaseDocTitle name="VueUiBullet" />

        <BaseDocDescription
            :text="translations.docs.tooltips.bullet[store.lang]"
        />
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiBulletConfig</code>
                </div>
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.animation.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.animation.animationFrames"
                                        type="number"
                                        defaultVal="60"
                                        :min="30"
                                        :max="255"
                                ...
                                <BaseDetails
                                    attr="segments"
                                    :level="3"
                                    title="style.chart.segments"
                                >
                                    <BaseAttr
                                        name="baseColor"
                                        attr="style.chart.segments.baseColor"
                                        type="color"
                                        defaultVal="#9A9A9A"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="dataLabels"
                                        :level="4"
                                        title="style.chart.segments.dataLabels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.segments.dataLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.segments.dataLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.segments.dataLabels.fontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.segments.dataLabels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.segments.dataLabels.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.segments.dataLabels.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.segments.dataLabels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.segments.dataLabels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="ticks"
                                        :level="4"
                                        title="style.chart.segments.ticks"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.segments.ticks.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="divisions"
                                            attr="style.chart.segments.ticks.divisions"
                                            type="select"
                                            defaultVal="10"
                                            :options="[2, 3, 5, 10, 20]"
                                            :light="mutableConfig"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.segments.ticks.stroke"
                                            type="color"
                                            defaultVal="#8A8A8A"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="target"
                                    :level="3"
                                    title="style.chart.target"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.target.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="rounded"
                                        attr="style.chart.target.rounded"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="heightRatio"
                                        attr="style.chart.target.heightRatio"
                                        type="range"
                                        defaultVal="0.8"
                                        :min="0.1"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.target.stroke"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.target.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="6"
                                ...
                                <BaseDetails
                                    attr="valueBar"
                                    :level="3"
                                    title="style.chart.valueBar"
                                >
                                    <BaseAttr
                                        name="color"
                                        attr="style.chart.valueBar.color"
                                        type="color"
                                        defaultVal="#3A3A3A"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="heightRatio"
                                        attr="style.chart.valueBar.heightRatio"
                                        type="range"
                                        defaultVal="0.33"
                                        :min="0.1"
                                        :max="0.9"
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.valueBar.stroke"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.valueBar.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseDetails
                                        attr="label"
                                        :level="4"
                                        title="style.chart.valueBar.label"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.valueBar.label.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.valueBar.label.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.valueBar.label.fontSize"
                                            defaultVal="14"
                                            type="number"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.valueBar.label.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.valueBar.label.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                ...
                                >
                                    ...
                                    >
                                        <BaseAttr
                                            name="text"
                                            attr="style.chart.title.subtitle.texxt"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
            ...
            <template #tab2>
                <ComponentEmits component="VueUiBullet" :names="['copyAlt']" />
                <ExposedMethods
                    component="VueUiBullet"
                    getImage
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-bullet.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
