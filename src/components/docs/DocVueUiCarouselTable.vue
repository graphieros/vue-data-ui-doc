...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.carouselTable[store.lang]"
        />
        ...
        <Box
            ...
            showSlots
            showCallbacks
            schema="vue_ui_carousel_table"
            hideSchemaDisclaimer
        >
            <template #tab0>
            ...
            <template #tab1>
                ...
                <div class="my-4">
                    TS type:
                    <code class="text-app-blue">VueUiCarouselTableConfig</code>
                </div>
                <div class="my-4">
                    Toggle tree view:
                ...
                <code ref="configCode">
                    ...
                    >
                        ...
                        <BaseDetails attr="scrollbar" :level="1">
                            <BaseAttr
                                name="showOnlyOnHover"
                                attr="scrollbar.showOnlyOnHover"
                                type="checkbox"
                                defaultVal="false"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="caption" :level="1">
                            ...
                            >
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="caption.style.backgroundColor"
                                    type="color"
                                    defaultVal="#FFFFFF"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="thead" :level="1">
                            ...
                            >
                                <BaseAttr
                                    name="verticalAlign"
                                    attr="thead.style.verticalAlign"
                                    type="select"
                                    defaultVal="middle"
                                    :options="[
                                        'baseline',
                            ...
                            <BaseDetails attr="tr" :level="2" title="thead.tr">
                                ...
                                <BaseDetails
                                    attr="border"
                                    :level="3"
                                    title="thead.tr.border"
                                >
                                    <BaseAttr
                                        name="size"
                                        attr="thead.tr.border.size"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="12"
                                ...
                                <BaseDetails
                                    attr="style"
                                    :level="3"
                                    title="thead.tr.style"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="thead.tr.style.backgroundColor"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="boxShadow"
                                        attr="thead.tr.style.boxShadow"
                                        type="text"
                                        defaultVal="0 6px 12px -6px #2D353C50"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    />
                                </BaseDetails>
                                ...
                                >
                                    <BaseDetails
                                        attr="border"
                                        :level="4"
                                        title="thead.tr.th.border"
                                    >
                                        <BaseAttr
                                            name="size"
                                            attr="thead.tr.th.border.size"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="12"
                                    ...
                                    <BaseDetails
                                        attr="padding"
                                        :level="4"
                                        title="thead.tr.th.padding"
                                    >
                                        <BaseAttr
                                            name="top"
                                            attr="thead.tr.th.padding.top"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="right"
                                            attr="thead.tr.th.padding.right"
                                            type="number"
                                            defaultVal="12"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="bottom"
                                            attr="thead.tr.th.padding.bottom"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                                    ...
                                    <BaseDetails
                                        attr="style"
                                        :level="4"
                                        title="thead.tr.th.style"
                                    >
                                        <BaseAttr
                                            name="borderSpacing"
                                            attr="thead.tr.th.style.borderSpacing"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="textAlign"
                                            attr="thead.tr.th.style.textAlign"
                                            type="select"
                                            defaultVal="right"
                                            :options="[
                                                'left',
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="thead.tr.th.style.fontVariantNumeric"
                                            type="select"
                                            defaultVal="tabular-nums"
                                            :options="[
                                                'normal',
                                                'tabular-nums',
                                                'slashed-zero',
                        ...
                        <BaseDetails attr="tbody" :level="1">
                            ...
                            <BaseDetails attr="tr" :level="2" title="tbody.tr">
                                ...
                                <BaseDetails
                                    attr="border"
                                    :level="3"
                                    title="tbody.tr.border"
                                >
                                    <BaseAttr
                                        name="size"
                                        attr="tbody.tr.border.size"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="12"
                                ...
                                <BaseDetails
                                    attr="style"
                                    :level="3"
                                    title="tbody.tr.style"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="tbody.tr.style.backgroundColor"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    <BaseAttr
                                        name="alternateColor"
                                        attr="tbody.tr.td.alternateColor"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    />
                                    <BaseAttr
                                        name="alternateOpacity"
                                        attr="tbody.tr.td.alternateOpacity"
                                        type="range"
                                        defaultVal="0.5"
                                        :min="0"
                                        :max="1"
                                    ...
                                    <BaseDetails
                                        attr="border"
                                        :level="4"
                                        title="tbody.tr.td.border"
                                    >
                                        <BaseAttr
                                            name="size"
                                            attr="tbody.tr.td.border.size"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="12"
                                    ...
                                    <BaseDetails
                                        attr="padding"
                                        :level="4"
                                        title="tbody.tr.td.padding"
                                    >
                                        <BaseAttr
                                            name="top"
                                            attr="tbody.tr.td.padding.top"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="right"
                                            attr="tbody.tr.td.padding.right"
                                            type="number"
                                            defaultVal="12"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="bottom"
                                            attr="tbody.tr.td.padding.bottom"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                                    ...
                                    <BaseDetails
                                        attr="style"
                                        :level="4"
                                        title="tbody.tr.td.style"
                                    >
                                        <BaseAttr
                                            name="textAlign"
                                            attr="tbody.tr.td.style.textAlign"
                                            type="select"
                                            defaultVal="right"
                                            :options="[
                                                'left',
                                        ...
                                        <BaseAttr
                                            name="fontVariantNumeric"
                                            attr="tbody.tr.td.style.fontVariantNumeric"
                                            type="select"
                                            defaultVal="tabular-nums"
                                            :options="[
                                                'normal',
                                        ...
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="tbody.tr.td.style.backgroundColor"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
            ...
            <template #tab3>
                ...
                <div class="text-gray-400 pl-5 mb-4">
                    {{ translations.slots.th[store.lang] }}
                </div>
                <div><code>#td</code></div>
                <div class="text-gray-400 pl-5 mb-4">
                    {{ translations.slots.td[store.lang] }}
                </div>
