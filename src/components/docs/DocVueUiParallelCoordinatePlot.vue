...
const codeDataset =
    ref(`const dataset: VueUiParallelCoordinatePlotDatasetItem[] = [
    {
        name: "Series 1",
        shape: "triangle",
        series: [
...
const customFormatCode =
    ref(`customFormat: ({ serie, seriesIndex, series, config, scales }) => {
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.pcp[store.lang]"
        />
        ...
        <Box
            ...
            showResponsive
            showCallbacks
            schema="vue_ui_parallel_coordinate_plot"
            signInfo="both"
        >
            <template #tab0>
                <div
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    ...
                    <code class="text-app-blue"
                        >VueUiParallelCoordinatePlotConfig</code
                    >
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiParallelCoordinatePlotConfig"
                        equal
                    >
                        <BaseAttr
                            inactive
                            ...
                            >
                                ...
                                >
                                    <BaseAttr
                                        ...
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Check out the slots tab for instructions on how to use comments"
                                    />
                                    <BaseAttr
                                        name="showInTooltip"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="opacity"
                                        attr="style.chart.lines.opacity"
                                        type="range"
                                        defaultVal="0.8"
                                        :min="0.1"
                                        :max="1"
                                ...
                                >
                                    <BaseAttr
                                        name="scaleTicks"
                                        attr="style.chart.yAxis.scaleTicks"
                                        type="number"
                                        defaultVal="10"
                                        :min="2"
                                        :max="20"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.yAxis.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="24"
                                    ...
                                    >
                                        <BaseAttr
                                            name="showAxisNames"
                                            attr="style.chart.yAxis.labels.showAxisNames"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        >
                                        <BaseAttr
                                            name="axisNamesRotation"
                                            attr="style.chart.yAxis.axisNamesRotation"
                                            type="number"
                                            defaultVal="0"
                                            :min="-90"
                                            :max="90"
                                        ...
                                        />
                                        <BaseDetails
                                            attr="axisNamesAutoRotate"
                                            :level="4"
                                            title="style.chart.yAxis.axisNamesAutoRotate"
                                        >
                                            <BaseAttr
                                                name="enable"
                                                attr="style.chart.yAxis.axisNamesAutoRotate.enable"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="angle"
                                                attr="style.chart.yAxis.axisNamesAutoRotate.angle"
                                                type="number"
                                                defaultVal="-30"
                                                :min="-90"
                                                :max="90"
                                        ...
                                        <BaseAttr
                                            name="axisNamesColor"
                                            attr="style.chart.yAxis.axisNamesColor"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="axisNamesFontSize"
                                            attr="style.chart.yAxis.axisNamesFontSize"
                                            type="number"
                                            defaultVal="16"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="axisNamesBold"
                                            attr="style.chart.yAxis.axisNamesBold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="datapoints"
                                            :level="5"
                                            title="style.chart.yAxis.labels.datapoints"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.yAxis.labels.datapoints.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.yAxis.labels.datapoints.fontSize"
                                                type="number"
                                                defaultVal="14"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="useSerieColor"
                                                attr="style.chart.yAxis.labels.datapoints.useSerieColor"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.yAxis.labels.datapoints.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.yAxis.labels.datapoints.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.chart.yAxis.labels.datapoints.offsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.yAxis.labels.datapoints.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="ticks"
                                            :level="5"
                                            title="style.chart.yAxis.labels.ticks"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.yAxis.labels.ticks.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.yAxis.labels.ticks.fontSize"
                                                type="number"
                                                defaultVal="14"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.yAxis.labels.ticks.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.yAxis.labels.ticks.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.yAxis.labels.ticks.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.chart.yAxis.labels.ticks.offsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
