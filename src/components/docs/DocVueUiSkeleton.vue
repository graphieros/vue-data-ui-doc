...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.comments.skeleton.p1[store.lang]"
        />
        ...
        <div class="flex flex-row justify-center w-full">
            <div>
                ...
                >
                    <BaseCard>
                        <div
                            class="flex flex-col gap-1 justify-center place-items-center mt-6 mb-6"
                        >
                            <label for="skeletons" class="text-xs text-left"
                                >Select skeleton type:</label
                            >
                            <BaseDropdown
                                :options="options"
                                option-target="value"
                        ...
                        <VueUiSkeleton
                            :config="
                                isDarkMode
                                    ? { ...mutableConfigDarkMode, type: type }
                                    : { ...mutableConfig, type: type }
                            "
                            :key="key"
                        />
                        <div
                            v-if="[type].includes('rating')"
                            class="mt-4 mx-auto flex flex-row place-items-center justify-center gap-2"
                        >
                            <input
                                id="useSmiley"
                                v-if="isDarkMode"
                                ...
                                v-model="
                                    mutableConfigDarkMode.style.rating.useSmiley
                                "
                            /><input
                                id="useSmiley"
                                v-else
                                type="checkbox"
                                class="accent-app-blue"
                                v-model="mutableConfig.style.rating.useSmiley"
                                @change="forceChartUpdate()"
                            />
                            <label for="useSmiley">
                                {{
                                    translations.docs.comments.skeleton.smiley[
                                        store.lang
                                    ]
                                }}
                            </label>
        ...
        <Box :activeTab="1">
            ...
            <template v-slot:tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiSkeletonConfig</code>
                </div>
                <pre>
<code>
