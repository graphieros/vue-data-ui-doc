...
<template>
    <div>
        ...
        <BaseDocDescription :text="translations.docs.tooltips.flow[store.lang]" />
        ...
        <Box ref="box" showSlots showThemes showEmits showTooltip showResponsive showCallbacks schema="vue_ui_flow" signInfo="positiveOnly">
            <template #tab0>
