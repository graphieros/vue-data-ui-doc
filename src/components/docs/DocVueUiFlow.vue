...
const customFormatCode = ref(`customFormat: ({ datapoint }) => {
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.flow[store.lang]"
        />
        ...
        >
            ...
            <template #tab1>
                ...
                <code ref="configCode">
                    <BaseDetails attr="const config: VueUiFlowConfig" equal>
                        ...
                        >
                        <span
                            >customPalette: [],<BaseComment
                                >string[]</BaseComment
                            ></span
                        >
                        <span
                            >nodeCategories: {},<BaseComment>{{
                                additionalTranslations.nodeCategories[
                                    store.lang
                                ]
                            }}</BaseComment></span
                        >
                        <span
                            >nodeCategoryColors: {},<BaseComment>{{
                                additionalTranslations.nodeCategoryColors[
                                    store.lang
                                ]
                            }}</BaseComment></span
                        >
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="links"
                                    :level="3"
                                    title="style.chart.links"
                                >
                                    <BaseAttr
                                        name="opacity"
                                        attr="style.chart.links.opacity"
                                        type="range"
                                        defaultVal="0.8"
                                        :min="0.1"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.links.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                ...
                                >
                                    ...
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.nodes.labels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="showValue"
                                            attr="style.chart.nodes.labels.showValue"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.node.labels.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.node.labels.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.nodes.labels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseDetails
                                            attr="abbreviation"
                                            :level="5"
                                            title="style.chart.nodes.labels.abbreviation"
                                        >
                                            <BaseAttr
                                                name="use"
                                                attr="style.chart.nodes.labels.abbreviation.use"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="length"
                                                attr="style.chart.nodes.labels.abbreviation.length"
                                                type="number"
                                                defaultVal="3"
                                                :min="1"
                                                :max="12"
                                ...
                                >
                                    ...
                                    <BaseDetails
                                        attr="translations"
                                        :level="4"
                                        title="style.chart.tooltip.translations"
                                    >
                                        <BaseAttr
                                            name="from"
                                            attr="style.chart.tooltip.translations.from"
                                            type="text"
                                            defaultVal="From:"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="to"
                                            attr="style.chart.tooltip.translations.to"
                                            type="text"
                                            defaultVal="To:"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="percentOfTotal"
                                            attr="style.chart.tooltip.translations.percentOfTotal"
                                            type="text"
                                            defaultVal="Percent of total:"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                    </BaseDetails>
            ...
            <template #tab2>
                <ComponentEmits component="VueUiFlow" :names="['copyAlt']" />
                <ExposedMethods
                    component="VueUiFlow"
                    getImage
                    :names="[
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-flow.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
