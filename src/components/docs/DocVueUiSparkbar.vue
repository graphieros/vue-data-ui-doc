...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.sparkbar[store.lang]"
        />
        ...
        >
            ...
            <template #tab1>
                <div class="w-full overflow-x-auto">
                    ...
                    <div class="mt-4">
                        TS type:
                        <code class="text-app-blue">VueUiSparkbarConfig</code>
                    </div>
                        ...
                        >
                            ...
                            <BaseDetails attr="style" :level="1">
                                ...
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.gutter.backgroundColor"
                                        type="color"
                                        defaultVal="#e1e5e8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <BaseDetails
                                        attr="name"
                                        :level="3"
                                        title="style.labels.name"
                                    >
                                        <BaseAttr
                                            name="position"
                                            attr="style.labels.name.position"
                                            type="select"
                                            defaultVal="top-left"
                                            :options="[
                                                'left',
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        ...
                                        name="target"
                                        defaultVal="0"
                                        comment="Common to all bars. Use target in dataset for individual targets."
                                    />
                                    <BaseAttr
                                        name="showTargetValue"
                                        attr="style.layout.showTargetValue"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.layout.targetValueText"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
            ...
            <template #tab3>
                <BaseSlotDocumenter
                    ...
                    :types="['title', 'data-label', 'source']"
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-sparkbar.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
