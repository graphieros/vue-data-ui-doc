...
const pageChangeCode =
    ref(`function onPageChange(pageData: VueUiTablePageChangeEvent) {
    const {
        currentPage,
        totalPages,
        itemsPerPage,
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.table[store.lang]"
        />
        ...
        <Box showEmits :showDatetimeFormatter="true">
            ...
            <template v-slot:tab0>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-green">VueUiTableDataset</code>
                </div>
                <div
                    class="w-full overflow-x-auto border-b mb-6 border-gray-700"
                >
                    <div
                        class="mt-3 flex flex-row flex-wrap place-items-center gap-2 text-gray-500"
                    >
                        <InfoCircleIcon />
                        <span>
                            {{
                ...
                <code ref="configCode">
                    <BaseDetails attr="const config: VueUiTableConfig" equal>
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    ...
                                    attr="style.title.backgroundColor"
                                    defaultVal="#FFFFFF"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                            ...
                            <BaseDetails attr="th" :level="2" title="style.th">
                                ...
                                <BaseAttr
                                    name="outline"
                                    attr="style.th.outline"
                                    type="text"
                                    defaultVal="'1px solid #FFFFFF'"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseDetails
                                    attr="selected"
                                    :level="3"
                                    title="style.th.selected"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.th.selected.backgroundColor"
                                        type="color"
                                        defaultVal="#1F77B4"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="buttons"
                                    :level="3"
                                    title="style.th.buttons"
                                >
                                    <BaseDetails
                                        attr="filter"
                                        :level="4"
                                        title="style.th.buttons.filter"
                                    >
                                        <BaseDetails
                                            attr="inactive"
                                            :level="5"
                                            title="style.th.buttons.filter.inactive"
                                        >
                                            <BaseAttr
                                                name="backgroundColor"
                                                attr="style.th.buttons.filter.inactive.backgroundColor"
                                                type="color"
                                                defaultVal="#E1E5E8"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.th.buttons.filter.inactive.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="active"
                                            :level="5"
                                            title="style.th.buttons.filter.active"
                                        >
                                            <BaseAttr
                                                name="backgroundColor"
                                                attr="style.th.buttons.filter.active.backgroundColor"
                                                type="color"
                                                defaultVal="#1f77b4"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.th.buttons.filter.active.color"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="cancel"
                                        :level="4"
                                        title="style.th.buttons.cancel"
                                    >
                                        <BaseDetails
                                            attr="inactive"
                                            :level="5"
                                            title="style.th.buttons.cancel.inactive"
                                        >
                                            <BaseAttr
                                                name="backgroundColor"
                                                attr="style.th.buttons.cancel.inactive.backgroundColor"
                                                type="color"
                                                defaultVal="#E1E5E8"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.th.buttons.cancel.inactive.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="active"
                                            :level="5"
                                            title="style.th.buttons.cancel.active"
                                        >
                                            <BaseAttr
                                                name="backgroundColor"
                                                attr="style.th.buttons.cancel.active.backgroundColor"
                                                type="color"
                                                defaultVal="#F17171"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.th.buttons.cancel.active.color"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="even"
                                    :level="3"
                                    title="style.rows.even"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.rows.even.backgroundColor"
                                        type="color"
                                        defaultVal="#F3F5F7"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="selectedCell"
                                        :level="4"
                                        title="style.rows.even.selectedCell"
                                    >
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.rows.even.selectedCell.backgroundColor"
                                            type="color"
                                            defaultVal="#1F77B45B"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.rows.even.selectedCell.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="selectedNeighbors"
                                        :level="4"
                                        title="style.rows.even.selectedNeighbors"
                                    >
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.rows.even.selectedNeighbors.backgroundColor"
                                            type="color"
                                            defaultVal="#63DD621E"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.rows.even.selectedNeighbors.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="odd"
                                    :level="3"
                                    title="style.rows.odd"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.rows.odd.backgroundColor"
                                        type="color"
                                        defaultVal="#F3F5F7"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="selectedCell"
                                        :level="4"
                                        title="style.rows.odd.selectedCell"
                                    >
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.rows.odd.selectedCell.backgroundColor"
                                            type="color"
                                            defaultVal="#1F77B45B"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.rows.odd.selectedCell.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="selectedNeighbors"
                                        :level="4"
                                        title="style.rows.odd.selectedNeighbors"
                                    >
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.rows.odd.selectedNeighbors.backgroundColor"
                                            type="color"
                                            defaultVal="#63DD621E"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.rows.odd.selectedNeighbors.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                            ...
                            >
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.inputs.backgroundColor"
                                    type="color"
                                    defaultVal="#FFFFFF"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="border"
                                    attr="style.inputs.border"
                                    type="text"
                                    defaultVal="'1px solid #CCCCCC'"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseAttr
                                    name="accentColor"
                                    attr="style.inputs.accentColor"
                                    type="color"
                                    defaultVal="#1F77B4"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                            ...
                            <BaseDetails
                                attr="dropdowns"
                                :level="2"
                                title="style.dropdowns"
                            >
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.dropdowns.backgroundColor"
                                    type="color"
                                    defaultVal="#E1E5E8"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="icons"
                                    :level="3"
                                    title="style.dropdowns.icons"
                                >
                                    <BaseDetails
                                        attr="selected"
                                        :level="4"
                                        title="style.dropdowns.icons.selected"
                                    >
                                        <BaseAttr
                                            name="color"
                                            attr="style.dropdowns.icons.selected.color"
                                            type="color"
                                            defaultVal="#2CA02C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="unicode"
                                            attr="style.dropdowns.icons.selected.unicode"
                                            type="text"
                                            defaultVal="'✔'"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="unselected"
                                        :level="4"
                                        title="style.dropdowns.icons.unselected"
                                    >
                                        <BaseAttr
                                            name="color"
                                            attr="style.dropdowns.icons.unselected.color"
                                            type="color"
                                            defaultVal="#D62728"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="unicode"
                                            attr="style.dropdowns.icons.unselected.unicode"
                                            type="text"
                                            defaultVal="'✖'"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                            ...
                            >
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.infoBar.backgroundColor"
                                    type="color"
                                    defaultVal="#E1E5E8"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                            ...
                            <BaseDetails
                                attr="pagination"
                                :level="2"
                                title="style.pagination"
                            >
                                <BaseDetails
                                    attr="buttons"
                                    :level="3"
                                    title="style.pagination.buttons"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.pagination.buttons.backgroundColor"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.pagination.buttons.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.pagination.buttons.opacityDisabled"
                                        type="range"
                                        defaultVal="0.5"
                                        :min="0.1"
                                        :max="1"
                                ...
                                <BaseDetails
                                    attr="navigationIndicator"
                                    :level="3"
                                    title="style.pagination.navigationIndicator"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.pagination.navigationIndicator.backgroundColor"
                                        type="color"
                                        defaultVal="#1F77B4"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                            ...
                            <BaseDetails
                                attr="exportMenu"
                                :level="2"
                                title="style.exportMenu"
                            >
                                <BaseAttr
                                    name="show"
                                    attr="style.exportMenu.show"
                                    type="checkbox"
                                    defaultVal="true"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.exportMenu.backgroundColor"
                                    type="color"
                                    defaultVal="#E1E5E8"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="filename"
                                    attr="style.exportMenu.filename"
                                    type="text"
                                    defaultVal="''"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="buttons"
                                    :level="3"
                                    title="style.exportMenu.buttons"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.exportMenu.buttons.backgroundColor"
                                        type="color"
                                        defaultVal="#FAFAFA"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.exportMenu.buttons.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                            ...
                            <BaseDetails
                                attr="closeButtons"
                                :level="2"
                                title="style.closeButtons"
                            >
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.closeButtons.backgroundColor"
                                    type="color"
                                ...
                                <BaseAttr
                                    name="borderRadius"
                                    attr="style.closeButtons.borderRadius"
                                    type="text"
                                    defaultVal="'50%'"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                            ...
                            >
                                <BaseDetails
                                    attr="modal"
                                    :level="3"
                                    title="style.chart.modal"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.chart.modal.backgroundColor"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="buttons"
                                        :level="4"
                                        title="style.chart.modal.buttons"
                                    >
                                        <BaseDetails
                                            attr="selected"
                                            :level="5"
                                            title="style.chart.modal.buttons.selected"
                                        >
                                            <BaseAttr
                                                name="backgroundColor"
                                                attr="style.chart.modal.buttons.selected.backgroundColor"
                                                type="color"
                                                defaultVal="#1F77B4"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.modal.buttons.selected.color"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="unselected"
                                            :level="5"
                                            title="style.chart.modal.buttons.unselected"
                                        >
                                            <BaseAttr
                                                name="backgroundColor"
                                                attr="style.chart.modal.buttons.unselected.backgroundColor"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.modal.buttons.unselected.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                ...
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.chart.layout.backgroundColor"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="axis"
                                        :level="4"
                                        title="style.chart.layout.axis"
                                    >
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.axis.stroke"
                                            type="color"
                                            defaultVal="#CCD1D4"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.axis.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="1"
                                            :max="6"
                                    ...
                                    <BaseDetails
                                        attr="bar"
                                        :level="4"
                                        title="style.chart.layout.bar"
                                    >
                                        <BaseAttr
                                            name="fill"
                                            attr="style.chart.layout.bar.fill"
                                            type="color"
                                            defaultVal="#1F77B4"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.bar.stroke"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="line"
                                        :level="4"
                                        title="style.chart.layout.line"
                                    >
                                        <BaseAttr
                                            name="smooth"
                                            attr="style.chart.layout.line.smooth"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="useArea"
                                            attr="style.chart.layout.line.useArea"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.line.stroke"
                                            type="color"
                                            defaultVal="#1F77B4"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.line.strokeWidth"
                                            type="number"
                                            defaultVal="4"
                                            :min="1"
                                            :max="12"
                                        ...
                                        <BaseDetails
                                            attr="plot"
                                            :level="5"
                                            title="style.chart.layout.line.plot"
                                        >
                                            <BaseAttr
                                                name="fill"
                                                attr="style.chart.layout.line.plot.fill"
                                                type="color"
                                                defaultVal="#1F77B4"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.layout.line.plot.strokeWidth"
                                                type="number"
                                                defaultVal="1"
                                                :min="0"
                                                :max="6"
                                            ...
                                            <BaseDetails
                                                attr="radius"
                                                :level="6"
                                                title="style.chart.layout.line.plot.radius"
                                            >
                                                <BaseAttr
                                                    name="selected"
                                                    attr="style.chart.layout.line.plot.radius.selected"
                                                    type="number"
                                                    defaultVal="6"
                                                    :min="0"
                                                    :max="24"
                                                ...
                                                <BaseAttr
                                                    name="unselected"
                                                    attr="style.chart.layout.line.plot.radius.unselected"
                                                    type="number"
                                                    defaultVal="4"
                                                    :min="0"
                                                    :max="24"
                                    ...
                                    >
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="progression"
                                        :level="4"
                                        title="style.chart.layout.progression"
                                    >
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.progression.stroke"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.progression.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="stokeDasharray"
                                            attr="style.chart.layout.progression.strokeDasharray"
                                            type="number"
                                            defaultVal="4"
                                            :min="0"
                                            :max="12"
                                    ...
                                    <BaseDetails
                                        attr="timeLabels"
                                        :level="4"
                                        title="style.chart.layout.timeLabels"
                                    >
                                        <BaseAttr
                                            name="showOnlyAtModulo"
                                            attr="style.chart.layout.timeLabels.showOnlyAtModulo"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="modulo"
                                            attr="style.chart.layout.timeLabels.modulo"
                                            type="number"
                                            defaultVal="12"
                                            :min="2"
                                            :max="24"
                                    ...
                                    <BaseDetails
                                        ...
                                        :level="4"
                                        title="style.chart.layout.datetimeFormatter"
                                    >
                                        <BaseAttr
                                            name="enable"
                                            attr="style.chart.layout.datetimeFormatter.enable"
                                            defaultVal="true"
                                            type="checkbox"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="locale"
                                            attr="style.chart.layout.datetimeFormatter.locale"
                                            type="text"
                                            defaultVal="en"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="useUTC"
                                            attr="style.chart.layout.datetimeFormatter.useUTC"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="januaryAsYear"
                                            attr="style.chart.layout.datetimeFormatter.januaryAsYear"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="options"
                                            :level="5"
                                            title="style.chart.layout.datetimeFormatter.options"
                                        >
                                            <BaseAttr
                                                name="year"
                                                attr="style.chart.layout.datetimeFormatter.options.year"
                                                type="text"
                                                defaultVal="yyyy"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="month"
                                                attr="style.chart.layout.datetimeFormatter.options.month"
                                                type="text"
                                                defaultVal="MMM 'yy"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="day"
                                                attr="style.chart.layout.datetimeFormatter.options.day"
                                                type="text"
                                                defaultVal="dd MMM"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="hour"
                                                attr="style.chart.layout.datetimeFormatter.options.hour"
                                                type="text"
                                                defaultVal="HH:mm"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="minute"
                                                attr="style.chart.layout.datetimeFormatter.options.minute"
                                                type="text"
                                                defaultVal="HH:mm:ss"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="second"
                                                attr="style.chart.layout.datetimeFormatter.options.second"
                                                type="text"
                                                defaultVal="HH:mm:ss"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="translations" :level="1">
                            ...
                            />
                            <BaseAttr
                                name="chooseCategoryColumn"
                                attr="translations.chooseCategoryColumn"
                                type="text"
                                defaultVal="'Choose category column'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="exportAllButton"
                                attr="translations.exportAllButton"
                                type="text"
                                defaultVal="'CSV all'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            ...
                            <BaseAttr
                                name="exportAllLabel"
                                attr="translations.exportAllLabel"
                                type="text"
                                defaultVal="'Export all rows of your current filtered dataset'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="exportPageButton"
                                attr="translations.exportPageButton"
                                type="text"
                                defaultVal="'CSV page'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="exportPageLabel"
                                attr="translations.exportPageLabel"
                                type="text"
                                defaultVal="'Export rows of the current page'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="from"
                                attr="translations.from"
                                type="text"
                                defaultVal="'From'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            ...
                            <BaseAttr
                                ...
                                attr="translations.inputPlaceholder"
                                type="text"
                                defaultVal="'Search...'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            ...
                            <BaseAttr
                                name="paginatorLabel"
                                attr="translations.paginatorLabel"
                                type="text"
                            ...
                            <BaseAttr
                                name="sizeWarning"
                                attr="translations.sizeWarning"
                                type="text"
                                defaultVal="'Displaying too many rows at a time can lead to slower performance'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="sum"
                                attr="translations.sum"
                                type="text"
                                defaultVal="'Sum'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            ...
                            <BaseAttr
                                name="totalRows"
                                attr="translations.totalRows"
                                type="text"
                                defaultVal="'Total rows'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="filename"
                                attr="translations.filename"
                                type="text"
                                defaultVal="'File name'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="xAxisLabels"
                                attr="translations.xAxisLabels"
                                type="text"
                                defaultVal="'X axis labels'"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                        </BaseDetails>
