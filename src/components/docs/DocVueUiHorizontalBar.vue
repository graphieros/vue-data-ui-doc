...
function randomizeData() {
    ...
    dataset.value[0].value = dataset.value[0].children
        .map((c) => c.value)
        .reduce((a, b) => a + b, 0);
    ...
    dataset.value[4].value = dataset.value[4].children
        .map((c) => c.value)
        .reduce((a, b) => a + b, 0);
}
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.verticalBar[store.lang]"
        />

        <div
            class="mx-auto max-w-[500px] rounded-xl text-md text-[#c2410c] dark:text-app-orange p-4 border border-app-orange flex bg-[#ff370010] gap-4"
        >
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-horizontal-bar"
            />
        </div>
        ...
        >
            ...
            <template v-slot:tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiHorizontalBarConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config:VueUiHorizontalBarConfig"
                        equal
                    >
                        <span
                            >theme: "", ("dark" | "celebration" |
                            "celebrationNight" | "zen" | "hack" | "concrete" |
                            "")</span
                        >
                        <span
                            >customPalette: [];
                            ...
                            >
                                ...
                                >
                                    <BaseDetails
                                        attr="bars"
                                        :level="4"
                                        title="style.chart.layout.bars"
                                    >
                                        <BaseAttr
                                            name="rowColor"
                                            attr="style.chart.layout.bars.rowColor"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rowRadius"
                                            attr="style.chart.layout.bars.rowRadius"
                                            type="number"
                                            defaultVal="4"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="sort"
                                            attr="style.chart.layout.bars.sort"
                                            type="select"
                                            defaultVal="desc"
                                            ...
                                            :dark="mutableConfigDarkMode"
                                            @change="forceChartUpdate()"
                                            comment="The 'none' option is supported since v2.4.69"
                                        />
                                        <BaseAttr
                                            name="useStroke"
                                            attr="style.chart.layout.bars.useStroke"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.bars.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="gap"
                                            attr="style.chart.layout.bars.gap"
                                            type="number"
                                            defaultVal="6"
                                            :min="0"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="borderRadius"
                                            attr="style.chart.layout.bars.borderRadius"
                                            type="number"
                                            defaultVal="4"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.layout.bars.offsetX"
                                            type="number"
                                            defaultVal="12"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="useGradient"
                                            attr="style.chart.layout.bars.useGradient"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.layout.bars.gradientIntensity"
                                            type="range"
                                            defaultVal="20"
                                            :min="0"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="fillOpacity"
                                            attr="style.chart.layout.bars.fillOpacity"
                                            type="range"
                                            defaultVal="90"
                                            :min="0"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.layout.bars.underlayerColor"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="dataLabels"
                                            :level="5"
                                            title="style.chart.layout.bars.dataLabels"
                                        >
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.bars.dataLabels.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.layout.bars.dataLabels.bold"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.layout.bars.dataLabels.fontSize"
                                                type="number"
                                                defaultVal="12"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.layout.bars.dataLabels.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseDetails
                                                attr="percentage"
                                                :level="6"
                                                title="style.chart.layout.bars.dataLabels.percentage"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.bars.dataLabels.percentage.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    ...
                                                    attr="style.chart.layout.bars.dataLabels.percentage.roundingPercentage"
                                                    type="number"
                                                    defaultVal="0"
                                                    :min="0"
                                                    :max="6"
                                            ...
                                            <BaseDetails
                                                attr="value"
                                                :level="6"
                                                title="style.chart.layout.bars.dataLabels.value"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.bars.dataLabels.value.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="roundingValue"
                                                    attr="style.chart.layout.bars.dataLabels.value.roundingValue"
                                                    type="number"
                                                    defaultVal="0"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="prefix"
                                                    attr="style.chart.layout.bars.dataLabels.value.prefix"
                                                    type="text"
                                                    defaultVal="''"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="suffix"
                                                    attr="style.chart.layout.bars.dataLabels.value.suffix"
                                                    type="text"
                                                    defaultVal="''"
                                                    :light="mutableConfig"
                                                    :dark="
                                        ...
                                        <BaseDetails
                                            attr="nameLabels"
                                            :level="5"
                                            title="style.chart.layout.bars.nameLabels"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.bars.nameLabels.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.bars.nameLabels.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.layout.bars.nameLabels.bold"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.layout.bars.nameLabels.fontSize"
                                                type="number"
                                                defaultVal="10"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.layout.bars.nameLabels.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                        ...
                                        <BaseDetails
                                            attr="parentLabels"
                                            :level="5"
                                            title="style.chart.layout.bars.parentLabels"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.bars.parentLabels.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.bars.parentLabels.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.layout.bars.parentLabels.bold"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.layout.bars.parentLabels.fontSize"
                                                type="number"
                                                defaultVal="10"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.layout.bars.parentLabels.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="paddingBottom"
                                                attr="style.chart.layout.bars.parentLabels.paddingBottom"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                    ...
                                    <BaseDetails
                                        attr="separators"
                                        :level="4"
                                        title="style.chart.layout.separators"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.separators.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.separators.color"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.separators.strokeWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="24"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="prefix"
                                        attr="style.chart.legend.prefix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="suffix"
                                        attr="style.chart.legend.suffix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="prefix"
                                        attr="style.chart.tooltip.prefix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="suffix"
                                        attr="style.chart.tooltip.suffix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="translations" :level="1">
                            ...
                            />
                            <BaseAttr
                                name="percentageToTotal"
                                attr="translations.percentageToTotal"
                                type="text"
                                defaultVal="%/total"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="percentageToSerie"
                                attr="translations.percentageToSerie"
                                type="text"
                                defaultVal="%/serie"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="userOptions" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="sort"
                                    attr="userOptions.buttonTitles.sort"
                                    type="text"
                                    defaultVal="Toggle sort"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                    @change="forceChartUpdate()"
                                />
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-horizontal-bar.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
