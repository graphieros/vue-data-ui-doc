      ...
      <BaseDetails attr="chart" :level="2" title="style.chart">
        ...
        <BaseDetails attr="layout" :level="3" title="style.chart.layout">
          ...
          <BaseDetails attr="rings" :level="4" title="style.chart.layout.rings">
            <span>strokeWidth: <input v-if="isDarkMode" type="number" min="6" max="42" v-model="mutableConfigDarkMode.style.chart.layout.rings.strokeWidth"><input v-else type="number" min="6" max="42" v-model="mutableConfig.style.chart.layout.rings.strokeWidth">, (default: 2)</span>
