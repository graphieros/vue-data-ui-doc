...
<template>
    <div>
        <BaseDocTitle name="VueUiRings" />

        <BaseDocDescription
            :text="translations.docs.tooltips.rings[store.lang]"
        />
        ...
        <div :class="`transition-all mx-auto max-w-[400px]`">
            <DocSnapper
                :isFixed="isFixed"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.layout.labels.dataLabels.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                attr="markers"
                                                :level="6"
                                                title="style.chart.layout.labels.dataLabels.markers"
                                            >
                                                <BaseComment
                                                    >Markers are visible when
                                                    dataLabels.show is
                                                    true</BaseComment
                                                >
                                                <BaseAttr
                                                    name="stroke"
                                                    attr="style.chart.layout.labels.dataLabels.markers.stroke"
                                                    type="color"
                                                    defaultVal="#8A8A8A"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="strokeWidth"
                                                    attr="style.chart.layout.labels.dataLabels.markers.strokeWidth"
                                                    type="number"
                                                    defaultVal="1"
                                                    :min="0"
                                                    :max="12"
                                                ...
                                                <BaseAttr
                                                    name="radius"
                                                    attr="style.chart.layout.labels.dataLabels.markers.radius"
                                                    type="number"
                                                    defaultVal="3"
                                                    :min="0"
                                                    :max="10"
                                                ...
                                                <BaseAttr
                                                    name="position"
                                                    attr="style.chart.layout.labels.dataLabels.markers.position"
                                                    type="select"
                                                    :options="['left', 'right']"
                                                    :light="mutableConfig"
                                                    :dark="
                                    ...
                                    <BaseDetails
                                        attr="rings"
                                        :level="4"
                                        title="style.chart.layout.rings"
                                    >
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.rings.stroke"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.rings.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="useShadow"
                                            attr="style.chart.layout.rings.useShadow"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="gradient"
                                            :level="5"
                                            title="style.chart.layout.rings.gradient"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.rings.gradient.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="intensity"
                                                attr="style.chart.layout.rings.gradient.intensity"
                                                type="range"
                                                defaultVal="40"
                                                :min="0"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                ...
                                                attr="style.chart.layout.rings.gradient.underlayerColor"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-rings.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
