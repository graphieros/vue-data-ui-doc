...
<template>
    <div>
      ...
      <BaseDocDescription :text="translations.docs.tooltips.rings[store.lang]" />
        ...
        <Box ref="box" showEmits showSlots showTooltip showCallbacks showThemes showResponsive showPatterns schema="vue_ui_rings" signInfo="positiveOnly">
