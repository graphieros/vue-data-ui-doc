...
<template>
    <div class="overflow-x-auto">
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.timer[store.lang]"
        />
        ...
        <Box showEmits showSlots :activeTab="1">
            ...
            <template #tab1>
                <div class="w-full overflow-x-auto">
                    ...
                    <div class="mt-4">
                        TS type:
                        <code class="text-app-blue">VueUiTimerConfig</code>
                    </div>
                        ...
                        >
                            ...
                            <BaseDetails attr="stopwatch" :level="1">
                                ...
                                >
                                    <BaseAttr
                                        name="radiusRatio"
                                        attr="stopwatch.track.radiusRatio"
                                        type="range"
                                        defaultVal="1"
                                        :min="0.4"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="stopwatch.track.strokeWidth"
                                        type="range"
                                        defaultVal="2"
                                        :min="0"
                                        :max="24"
                                ...
                                >
                                    <BaseAttr
                                        name="radiusRatio"
                                        attr="stopwatch.tracker.radiusRatio"
                                        type="range"
                                        defaultVal="1"
                                        :min="0.4"
                                        :max="2"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="stopwatch.tracker.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseDetails
                                        attr="gradient"
                                        :level="3"
                                        title="stopwatch.tracker.gradient"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="stopwatch.tracker.gradient.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="stopwatch.tracker.gradient.color"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="aura"
                                        :level="3"
                                        title="stopwatch.tracker.aura"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="stopwatch.tracker.aura.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="radiusRatio"
                                            attr="stopwatch.tracker.aura.radiusRatio"
                                            type="range"
                                            defaultVal="1"
                                            :min="0.4"
                                            :max="3"
                                        ...
                                        <BaseAttr
                                            name="fill"
                                            attr="stopwatch.tracker.aura.fill"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="stopwatch.tracker.aura.stroke"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="stopwatch.tracker.aura.strokeWidth"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="12"
                                ...
                                <BaseDetails
                                    attr="cycleTrack"
                                    :level="2"
                                    title="stopwatch.cycleTrack"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="stopwatch.cycleTrack.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="stopwatch.cycleTrack.stroke"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="stopwatch.cycleTrack.strokeWidth"
                                        type="number"
                                        defaultVal="3"
                                        :min="0"
                                        :max="24"
                                ...
                                <BaseDetails
                                    attr="legend"
                                    :level="2"
                                    title="stopwatch.legend"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="stopwatch.legend.backgroundColor"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="buttons"
                                        :level="3"
                                        title="stopwatch.legend.buttons"
                                    >
                                        <BaseAttr
                                            name="start"
                                            attr="stopwatch.legend.buttons.start"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="pause"
                                            attr="stopwatch.legend.buttons.pause"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="reset"
                                            attr="stopwatch.legend.buttons.reset"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="restart"
                                            attr="stopwatch.legend.buttons.restart"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="lap"
                                            attr="stopwatch.legend.buttons.lap"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="iconColor"
                                            attr="stopwatch.legend.buttons.iconColor"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="buttonTitles"
                                        :level="3"
                                        title="stopwatch.legend.buttonTitles"
                                    >
                                        <BaseAttr
                                            name="start"
                                            attr="stopwatch.legend.buttonTitles.start"
                                            type="text"
                                            defaultVal="Start"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="pause"
                                            attr="stopwatch.legend.buttonTitles.pause"
                                            type="text"
                                            defaultVal="Pause"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="resume"
                                            attr="stopwatch.legend.buttonTitles.resume"
                                            type="text"
                                            defaultVal="Resume"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="reset"
                                            attr="stopwatch.legend.buttonTitles.reset"
                                            type="text"
                                            defaultVal="Reset"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="restart"
                                            attr="stopwatch.legend.buttonTitles.restart"
                                            type="text"
                                            defaultVal="Restart"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="lap"
                                            attr="stopwatch.legend.buttonTitles.lap"
                                            type="text"
                                            defaultVal="Lap"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
            ...
            <template #tab2>
                <ComponentEmits
                    component="VueUiTimer"
                    :names="['start', 'pause', 'reset', 'restart', 'lap']"
                />
                <ExposedMethods
                    component="VueUiTimer"
                    :names="['start', 'pause', 'reset', 'restart', 'lap']"
...
&lt;/template&gt;
                ...
                <div class="text-xl border-t border-gray-500 pt-4">
                    #chart-background
                </div>
                <pre>
<code>
