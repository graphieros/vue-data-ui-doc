...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.chord[store.lang]"
        />
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="arcs"
                                    :level="3"
                                    title="style.chart.arcs"
                                >
                                    <BaseAttr
                                        name="innerRadiusRatio"
                                        attr="style.chart.arcs.innerRadiusRatio"
                                        type="number"
                                        :min="0"
                                        :max="1.5"
                                        :step="0.01"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.arcs.outerRadiusRatio"
                                        type="number"
                                        :min="0"
                                        :max="1.5"
                                        :step="0.01"
                                    ...
                                    <BaseAttr
                                        name="padAngle"
                                        attr="style.chart.arcs.padAngle"
                                        type="number"
                                        :min="0"
                                        :max="270"
                                        defaultVal="5"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.arcs.strokeWidth"
                                        type="number"
                                        :min="0"
                                        :max="12"
                                        defaultVal="1"
                                    ...
                                    <BaseDetails
                                        attr="labels"
                                        :level="4"
                                        title="style.chart.arcs.labels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.arcs.labels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.arcs.labels.fontSize"
                                            type="number"
                                            :min="8"
                                            :max="42"
                                            defaultVal="14"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.arcs.labels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="curved"
                                            attr="style.chart.arcs.labels.curved"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.arcs.labels.adaptColorToBackground"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.arcs.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offset"
                                            attr="style.chart.arcs.labels.offset"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="showPercentage"
                                            attr="style.chart.arcs.labels.showPercentage"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.arcs.labels.roundingPercentage"
                                            type="number"
                                            :min="0"
                                            :max="6"
                                            defaultVal="0"
                                ...
                                <BaseDetails
                                    attr="ribbons"
                                    :level="3"
                                    title="style.chart.ribbons"
                                >
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.ribbons.stroke"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.ribbons.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    />
                                    <BaseAttr
                                        name="underlayerOpacity"
                                        attr="style.chart.ribbons.underlayerOpacity"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="1"
                                    ...
                                    <BaseDetails
                                        attr="labels"
                                        :level="4"
                                        title="style.chart.ribbons.labels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.ribbons.labels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.ribbons.labels.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.ribbons.labels.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.ribbons.labels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.ribbons.labels.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.ribbons.labels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="useSerieColor"
                                            attr="style.chart.ribbons.labels.useSerieColor"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.ribbons.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offset"
                                            attr="style.chart.ribbons.labels.offset"
                                            type="number"
                                            :min="-100"
                                            :max="100"
                                            defaultVal="0"
                                        ...
                                        />
                                        <BaseAttr
                                            name="minSeparationDeg"
                                            attr="style.chart.ribbons.labels.minSeparationDeg"
                                            type="number"
                                            :min="0"
                                            :max="90"
                                            defaultVal="3"
                                        ...
                                        <BaseDetails
                                            attr="connector"
                                            :level="5"
                                            title="style.chart.ribbons.labels.connector"
                                        >
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.ribbons.labels.connector.stroke"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.ribbons.labels.connector.strokeWidth"
                                                type="number"
                                                defaultVal="1"
                                                :min="0"
                                                :max="12"
                                        ...
                                        <BaseDetails
                                            attr="marker"
                                            :level="5"
                                            title="style.chart.ribbons.labels.connector.marker"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.ribbons.labels.connector.marker.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="radius"
                                                attr="style.chart.ribbons.labels.connector.marker.radius"
                                                type="number"
                                                defaultVal="3"
                                                :min="0"
                                                :max="12"
                                            ...
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.ribbons.labels.connector.marker.stroke"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.ribbons.labels.connector.marker.strokeWidth"
                                                type="number"
                                                :min="0"
                                                :max="12"
                                                :light="mutableConfig"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-chord.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
