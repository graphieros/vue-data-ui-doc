    ...
    return [
        {
            ...
            top: 2,
            component: "VueUiXy",
            props: { config: xyConfig, dataset: xyDataset },
        },
        {
            id: 2,
            width: 35,
            ...
            props: { config: donutConfig, dataset: donutDataset },
        },
        {
            id: 5,
            width: 94,
            ...
            props: { config: chestnutConfig, dataset: chestnutDataset },
        },
        {
            id: 3,
            width: 25,
            ...
            left: 71,
            top: 50,
            component: markRaw(BaseButtonSparkline),
            props: {
                title: "Daily users",
                buttonClass:
                    "bg-gradient-to-bl from-app-blue-light to-app-blue hover:bg-gradient-to-l text-black transition-all",
                popoverClass:
                    "rounded-b-md py-1 bg-white dark:bg-[#2A2A2A] shadow-md",
        ...
        },
        {
            ...
            props: { config: radarConfig, dataset: radarDataset },
        },
    ];
});
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.comments.dashboard.p1[store.lang]"
        />
        ...
        <Box showEmits showSlots>
            <template #tab0>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-green">VueUiDashboardElement[]</code>
                </div>
                <div
    ...
    },
    {
        ...
        props: {
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiDashboardConfig</code>
                </div>
                    ...
                    >
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                <BaseAttr
                                    ...
                                    attr="style.board.backgroundColor"
                                    type="color"
                                    defaultVal="#FFFFFF"
                                    :light="mutableConfig"
                                    :dark="mutableConfig"
                            ...
                            >
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.item.backgroundColor"
                                    type="color"
                                    defaultVal="#FFFFFF"
                                    :light="mutableConfig"
                                    :dark="mutableConfig"
                            ...
                            <BaseDetails
                                attr="resizeHandles"
                                :level="2"
                                title="style.resizeHandles"
                            >
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.resizeHandles.backgroundColor"
                                    type="color"
                                    defaultVal="#2D353C"
                                    :light="mutableConfig"
                                    :dark="mutableConfig"
                        ...
                        <BaseDetails attr="userOptions" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="filename"
                                    attr="userOptions.print.filename"
                                    type="text"
                                    defaultVal="''"
                                    :light="mutableConfig"
                                    :dark="mutableConfig"
            ...
            <template #tab2>
                <div>
                    <code><b>@change</b></code>
                </div>
                <div class="text-gray-400 pl-5 mb-4">
                    {{ translations.docs.emits.dashboard.change[store.lang] }}
                </div>

                <div class="pt-4 border-t border-gray-700 overflow-x-auto">
                    <code><b>toggleLock</b></code>
                </div>
                <div class="text-gray-400 pl-5">
                    {{
                        translations.docs.emits.dashboard.toggleLock[store.lang]
                    }}
                </div>
                <pre>
...
<code>
    ...
    &lt;/template&gt;
                ...
                <br />
                Use #top and #bottom slots to add custom content aboveor below
                the components
                <pre>
<code>
    &lt;template&gt;
