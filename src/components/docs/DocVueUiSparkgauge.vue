...
watch(
    () => lang.value,
    (v) => {
        mutableConfig.value.style.colors.min =
            v === "zh" ? "#00FF00" : "#FF0000";
        mutableConfig.value.style.colors.max =
            v === "zh" ? "#FF0000" : "#00FF00";
        mutableConfigDarkMode.value.style.colors.min =
            v === "zh" ? "#00FF00" : "#FF0000";
        mutableConfigDarkMode.value.style.colors.max =
            v === "zh" ? "#FF0000" : "#00FF00";
    },
);
    ...
    <div>
        ...
        <Box ref="box" showThemes showSlots schema="vue_ui_sparkgauge">
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiSparkgaugeConfig</code>
                </div>
                    ...
                    >
                        ...
                        <BaseDetails attr="style" level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="showGradient"
                                    attr="style.colors.showGradient"
                                    type="checkbox"
                                    defaultVal="true"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="autoColor"
                                    attr="style.dataLabel.autoColor"
                                    type="checkbox"
                                    defaultVal="true"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="strokeLinecap"
                                    attr="style.gutter.strokeLinecap"
                                    type="select"
                                    defaultVal="round"
                ...
                <BaseAttr name="color" attr="style.track.color" type="color" defaultVal="#5F88EE" :light="mutableConfig" :dark="mutableConfigDarkMode" @change="forceChartUpdate()"/> -->
                                <BaseAttr
                                    name="strokeLinecap"
                                    attr="style.track.strokeLinecap"
                                    type="select"
                                    defaultVal="round"
                                    :options="['round', 'square', 'butt']"
                                    :light="mutableConfig"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-sparkgauge.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
