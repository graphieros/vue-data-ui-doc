...
function updateDataset() {
    mutableDataset.value = JSON.parse(
        JSON.stringify({
            ...dataset.value,
            series: dataset.value.series.slice(0, slicer.value),
        }),
    );
}
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.radar[store.lang]"
        />
        ...
        >
            ...
            <template v-slot:tab1>
                <div class="w-full overflow-x-auto">
                    ...
                    <div class="mt-6">
                        TS type:
                        <code class="text-app-blue">VueUiRadarConfig</code>
                    </div>
                    ...
                    <code ref="configCode">
                        <BaseDetails
                            attr="const config: VueUiRadarConfig"
                            equal
                        >
                            <span
                                >responsive: false,
                                ...
                                >
                                    ...
                                    >
                                        <BaseDetails
                                            attr="dataPolygon"
                                            :level="4"
                                            title="style.chart.layout.dataPolygon"
                                        >
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.layout.dataPolygon.strokeWidth"
                                                type="number"
                                                defaultVal="1"
                                                :min="0"
                                                :max="12"
                                            ...
                                            <BaseAttr
                                                name="transparent"
                                                attr="style.chart.layout.dataPolygon.transparent"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="opacity"
                                                attr="style.chart.layout.dataPolygon.opacity"
                                                type="range"
                                                defaultVal="20"
                                                :min="0"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="useGradient"
                                                attr="style.chart.layout.dataPolygon.useGradient"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        >
                                            ...
                                            <BaseAttr
                                                name="graduations"
                                                attr="style.chart.layout.grid.graduations"
                                                type="select"
                                                defaultVal="5"
                                                :options="[2, 5, 10]"
                                                :light="mutableConfig"
                                        ...
                                        <BaseDetails
                                            attr="outerPolygon"
                                            :level="4"
                                            title="style.chart.layout.outerPolygon"
                                        >
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.layout.outerPolygon.stroke"
                                                type="color"
                                                defaultVal="#CCCCCC"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.layout.outerPolygon.strokeWidth"
                                                type="number"
                                                defaultVal="1"
                                                :min="0"
                                                :max="12"
                                        ...
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.plots.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        ...
                                        <BaseDetails
                                            attr="animation"
                                            :level="4"
                                            title="style.chart.tooltip.animation"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.tooltip.animation.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                ...
                                                attr="style.chart.tooltip.animation.animationFrames"
                                                type="number"
                                                defaultVal="60"
                                                :min="0"
                                                :max="300"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-radar.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
