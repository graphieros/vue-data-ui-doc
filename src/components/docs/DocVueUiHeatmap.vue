...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.heatmap[store.lang]"
        />
        ...
        <BaseMigrationInfo autoRotate debug padding heatmapSize />
        ...
        >
            ...
            <template v-slot:tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiHeatmapConfig</code>
                </div>
                    ...
                    <BaseDetails attr="const config: VueUiHeatmapConfig" equal>
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="crosshairs"
                                    :level="3"
                                    title="style.layout.crosshairs"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.layout.crosshairs.show"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.layout.crosshairs.stroke"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.layout.crosshairs.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.layout.crosshairs.strokeDasharray"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="12"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="spacing"
                                        attr="style.layout.cells.spacing"
                                        type="number"
                                        defaultVal="2"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseDetails
                                        attr="colors"
                                        :level="4"
                                        title="style.layout.cells.colors"
                                    >
                                        <BaseAttr
                                            name="hot"
                                            attr="style.layout.cells.colors.hot"
                                            type="color"
                                            defaultVal="#DC3912"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="cold"
                                            attr="style.layout.cells.colors.cold"
                                            type="color"
                                            defaultVal="#5F8BEE"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="selected"
                                        :level="4"
                                        title="style.layout.cells.selected"
                                    >
                                        <BaseAttr
                                            name="border"
                                            attr="style.layout.cells.selected.border"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.layout.cells.selected.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="value"
                                        :level="4"
                                        title="style.layout.cells.value"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.cells.value.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.layout.cells.value.fontSize"
                                            type="number"
                                            defaultVal="18"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.layout.cells.value.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="roundingValue"
                                            attr="style.layout.cells.value.roundingValue"
                                            type="number"
                                            defaulVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.layout.cells.value.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="rowTotal"
                                        :level="4"
                                        title="style.layout.cells.rowTotal"
                                    >
                                        <BaseDetails
                                            attr="value"
                                            :level="5"
                                            title="style.layout.cells.rowTotal.value"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.layout.cells.rowTotal.value.show"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="color"
                                            :level="5"
                                            title="style.layout.cells.rowTotal.color"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.layout.cells.rowTotal.color.show"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="columnTotal"
                                        :level="4"
                                        title="style.layout.cells.columnTotal"
                                    >
                                        <BaseDetails
                                            attr="value"
                                            :level="5"
                                            title="style.layout.cells.columnTotal.value"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.layout.cells.columnTotal.value.show"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.layout.cells.columnTotal.value.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.layout.cells.columnTotal.value.offsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="rotation"
                                                attr="style.layout.cells.columnTotal.value.rotation"
                                                type="number"
                                                defaultVal="0"
                                                :min="-90"
                                                :max="90"
                                            ...
                                            <BaseDetails
                                                attr="autoRotate"
                                                :level="5"
                                                title="style.layout.cells.columnTotal.value.autoRotate"
                                            >
                                                <BaseAttr
                                                    name="enable"
                                                    attr="style.layout.cells.columnTotal.value.autoRotate.enable"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="angle"
                                                    attr="style.layout.cells.columnTotal.value.autoRotate.angle"
                                                    type="number"
                                                    defaultVal="-30"
                                                    :min="-90"
                                                    :max="90"
                                        ...
                                        <BaseDetails
                                            attr="color"
                                            :level="5"
                                            title="style.layout.cells.columnTotal.color"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.layout.cells.columnTotal.color.show"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                ...
                                >
                                    <BaseAttr
                                        name="prefix"
                                        attr="style.layout.dataLabels.prefix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="suffix"
                                        attr="style.layout.dataLabels.suffix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        ...
                                        <BaseDetails
                                            ...
                                            :level="5"
                                            title="style.layout.dataLabels.xAxis.datetimeFormatter"
                                        >
                                            <BaseAttr
                                                name="enable"
                                                attr="style.layout.dataLabels.xAxis.datetimeFormatter.enable"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="locale"
                                                attr="style.layout.dataLabels.xAxis.datetimeFormatter.locale"
                                                type="select"
                                                defaultVal="en"
                                            ...
                                            <BaseAttr
                                                name="useUTC"
                                                attr="style.layout.dataLabels.xAxis.datetimeFormatter.useUTC"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="januaryAsYear"
                                                attr="style.layout.dataLabels.xAxis.datetimeFormatter.januaryAsYear"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                attr="options"
                                                :level="6"
                                                title="style.layout.dataLabels.xAxis.datetimeFormatter.options"
                                            >
                                                <BaseAttr
                                                    name="year"
                                                    attr="style.layout.dataLabels.xAxis.datetimeFormatter.options.year"
                                                    type="text"
                                                    defaultVal="yyyy"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="month"
                                                    attr="style.layout.dataLabels.xAxis.datetimeFormatter.options.month"
                                                    type="text"
                                                    :defaultVal="`MMM 'yy`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="day"
                                                    attr="style.layout.dataLabels.xAxis.datetimeFormatter.options.day"
                                                    type="text"
                                                    :defaultVal="`dd MMM`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="minute"
                                                    attr="style.layout.dataLabels.xAxis.datetimeFormatter.options.minute"
                                                    type="text"
                                                    :defaultVal="`HH:mm:ss`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="second"
                                                    attr="style.layout.dataLabels.xAxis.datetimeFormatter.options.second"
                                                    type="text"
                                                    :defaultVal="`HH:mm:ss`"
                                                    :light="mutableConfig"
                                                    :dark="
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.layout.dataLabels.xAxis.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.layout.dataLabels.xAxis.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.layout.dataLabels.xAxis.showOnlyAtModulo"
                                            type="number"
                                            defaultVal="null"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="rotation"
                                            attr="style.layout.dataLabels.xAxis.rotation"
                                            type="range"
                                            defaultVal="0"
                                            :min="-90"
                                            :max="90"
                                        ...
                                        <BaseDetails
                                            attr="autoRotate"
                                            :level="5"
                                            title="style.layout.dataLabels.xAxis.autoRotate"
                                        >
                                            <BaseAttr
                                                name="enable"
                                                attr="style.layout.dataLabels.xAxis.autoRotate.enable"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="angle"
                                                attr="style.layout.dataLabels.xAxis.autoRotate.angle"
                                                type="number"
                                                defaultVal="-30"
                                                :min="-90"
                                                :max="90"
                                    ...
                                    >
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.layout.dataLabels.yAxis.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.layout.dataLabels.yAxis.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            <BaseDetails
                                attr="colNames"
                                :level="2"
                                title="table.colNames"
                            >
                                <BaseAttr
                                    name="xAxis"
                                    attr="table.colNames.xAxis"
                                    type="text"
                                    defaultVal="X"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-heatmap.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
