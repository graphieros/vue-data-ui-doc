...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.quadrant[store.lang]"
        />
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-quadrant"
            />
        </div>
        ...
        >
            ...
            <template v-slot:tab1>
                <div class="w-full overflow-x-auto">
                    ...
                    <div class="mt-4">
                        TS type:
                        <code class="text-app-blue">VueUiQuadrantConfig</code>
                    </div>
                    ...
                    <code ref="configCode">
                        <BaseDetails
                            attr="const config: VueUiQuadrantConfig"
                            equal
                        >
                            <span
                                >responsive: false,
                            ...
                            />
                            <BaseAttr
                                name="zoomAnimationFrames"
                                attr="zoomAnimationFrames"
                                type="range"
                                defaultVal="20"
                                :min="5"
                                :max="40"
                                ...
                                >
                                    ...
                                    >
                                        <BaseDetails
                                            attr="areas"
                                            :level="4"
                                            title="style.chart.layout.areas"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.areas.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="opacity"
                                                attr="style.chart.layout.areas.opacity"
                                                type="range"
                                                defaultVal="40"
                                                :min="0"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="useGradient"
                                                attr="style.chart.layout.areas.useGradient"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        >
                                            ...
                                            <BaseAttr
                                                name="showArrows"
                                                attr="style.chart.layout.grid.showArrows"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                attr="graduations"
                                                :level="5"
                                                title="style.chart.layout.grid.graduations"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.grid.graduations.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="stroke"
                                                    attr="style.chart.layout.grid.graduations.stroke"
                                                    type="color"
                                                    defaultVal="#E1E5E8"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="strokeWidth"
                                                    attr="style.chart.layout.grid.graduations.strokeWidth"
                                                    type="number"
                                                    defaultVal="0.5"
                                                    :min="0.1"
                                                    :max="12"
                                                ...
                                                <BaseAttr
                                                    name="steps"
                                                    attr="style.chart.layout.grid.graduations.steps"
                                                    type="select"
                                                    defaultVal="5"
                                                    :options="[1, 2, 3, 4, 5]"
                                                    :light="mutableConfig"
                                                ...
                                                <BaseAttr
                                                    name="fill"
                                                    attr="style.chart.layout.grid.graduations.fill"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.chart.layout.grid.graduations.color"
                                                    type="color"
                                                    defaultVal="#E1E5E8"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="roundingForce"
                                                    attr="style.chart.layout.grid.graduations.roundingForce"
                                                    type="range"
                                                    defaultVal="10"
                                                    :min="0"
                                                    :max="200"
                                            ...
                                            >
                                                <BaseAttr
                                                    name="min"
                                                    attr="style.chart.layout.grid.xAxis.min"
                                                    type="number"
                                                    :min="-10000"
                                                    :max="10000"
                                                    defaultVal="-100"
                                                ...
                                                <BaseAttr
                                                    name="max"
                                                    attr="style.chart.layout.grid.xAxis.max"
                                                    type="number"
                                                    :min="-10000"
                                                    :max="10000"
                                                    defaultVal="100"
                                                ...
                                                <BaseAttr
                                                    name="auto"
                                                    attr="style.chart.layout.grid.xAxis.auto"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="name"
                                                    attr="style.chart.layout.grid.xAxis.name"
                                                    type="text"
                                                    defaultVal="''"
                                                    :light="mutableConfig"
                                                    :dark="
                                            ...
                                            >
                                                <BaseAttr
                                                    name="min"
                                                    attr="style.chart.layout.grid.yAxis.min"
                                                    type="number"
                                                    :min="-10000"
                                                    :max="10000"
                                                    defaultVal="-100"
                                                ...
                                                <BaseAttr
                                                    name="max"
                                                    attr="style.chart.layout.grid.yAxis.max"
                                                    type="number"
                                                    :min="-10000"
                                                    :max="10000"
                                                    defaultVal="100"
                                                ...
                                                <BaseAttr
                                                    name="auto"
                                                    attr="style.chart.layout.grid.yAxis.auto"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="name"
                                                    attr="style.chart.layout.grid.yAxis.name"
                                                    type="text"
                                                    defaultVal="''"
                                                    :light="mutableConfig"
                                                    :dark="
                                        ...
                                        >
                                            <BaseDetails
                                                attr="axisLabels"
                                                :level="5"
                                                title="style.chart.layout.labels.axisLabels"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.labels.axisLabels.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="fontSize"
                                                    attr="style.chart.layout.labels.axisLabels.fontSize"
                                                    type="number"
                                                    defaultVal="14"
                                                    :min="8"
                                                    :max="42"
                                                ...
                                                <BaseDetails
                                                    attr="color"
                                                    :level="6"
                                                    title="style.chart.layout.labels.axisLabels.color"
                                                >
                                                    <BaseAttr
                                                        name="positive"
                                                        attr="style.chart.layout.labels.axisLabels.color.positive"
                                                        type="color"
                                                        defaultVal="#2D353C"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="negative"
                                                        attr="style.chart.layout.labels.axisLabels.color.negative"
                                                        type="color"
                                                        defaultVal="#2D353C"
                                                        :light="mutableConfig"
                                                        :dark="
                                            ...
                                            <BaseDetails
                                                attr="plotLabels"
                                                :level="5"
                                                title="style.chart.layout.labels.plotLabels"
                                            >
                                                <BaseAttr
                                                    name="showAsTag"
                                                    attr="style.chart.layout.labels.plotLabels.showAsTag"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.labels.plotLabels.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="fontSize"
                                                    attr="style.chart.layout.labels.plotLabels.fontSize"
                                                    type="number"
                                                    defaultVal="10"
                                                    :min="8"
                                                    :max="42"
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.chart.layout.labels.plotLabels.color"
                                                    type="color"
                                                    defaultVal="#2D353C"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="offsetY"
                                                    attr="style.chart.layout.labels.plotLabels.offsetY"
                                                    type="number"
                                                    defaultVal="8"
                                                    :min="-100"
                                                    :max="100"
                                                ...
                                                <BaseDetails
                                                    attr="x"
                                                    :level="6"
                                                    title="style.chart.layout.labels.plotLabels.x"
                                                >
                                                    <div
                                                ...
                                                <BaseDetails
                                                    attr="y"
                                                    :level="6"
                                                    title="style.chart.layout.labels.plotLabels.y"
                                                >
                                                    <div
                                                        class="flex flex-row gap-2 place-items-center"
                                                    >
                                            ...
                                            <BaseDetails
                                                attr="quadrantLabels"
                                                :level="5"
                                                title="style.chart.layout.labels.quadrantLabels"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.labels.quadrantLabels.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseDetails
                                                    attr="bl"
                                                    :level="6"
                                                    title="style.chart.layout.labels.quadrantLabels.bl"
                                                >
                                                    <BaseAttr
                                                        name="text"
                                                        attr="style.chart.layout.labels.quadrantLabels.bl.text"
                                                        type="text"
                                                        defaultVal="''"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="color"
                                                        attr="style.chart.layout.labels.quadrantLabels.bl.color"
                                                        type="color"
                                                        defaultVal="#2D353C"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="fontSize"
                                                        attr="style.chart.layout.labels.quadrantLabels.bl.fontSize"
                                                        type="number"
                                                        defaultVal="16"
                                                        :min="8"
                                                        :max="42"
                                                    ...
                                                    <BaseAttr
                                                        name="bold"
                                                        attr="style.chart.layout.labels.quadrantLabels.bl.bold"
                                                        type="checkbox"
                                                        defaultVal="true"
                                                        :light="mutableConfig"
                                                        :dark="
                                                ...
                                                <BaseDetails
                                                    attr="br"
                                                    :level="6"
                                                    title="style.chart.layout.labels.quadrantLabels.br"
                                                >
                                                    <BaseAttr
                                                        name="text"
                                                        attr="style.chart.layout.labels.quadrantLabels.br.text"
                                                        type="text"
                                                        defaultVal="''"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="color"
                                                        attr="style.chart.layout.labels.quadrantLabels.br.color"
                                                        type="color"
                                                        defaultVal="#2D353C"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="fontSize"
                                                        attr="style.chart.layout.labels.quadrantLabels.br.fontSize"
                                                        type="number"
                                                        defaultVal="16"
                                                        :min="8"
                                                        :max="42"
                                                    ...
                                                    <BaseAttr
                                                        name="bold"
                                                        attr="style.chart.layout.labels.quadrantLabels.br.bold"
                                                        type="checkbox"
                                                        defaultVal="true"
                                                        :light="mutableConfig"
                                                        :dark="
                                                ...
                                                <BaseDetails
                                                    attr="tl"
                                                    :level="6"
                                                    title="style.chart.layout.labels.quadrantLabels.tl"
                                                >
                                                    <BaseAttr
                                                        name="text"
                                                        attr="style.chart.layout.labels.quadrantLabels.tl.text"
                                                        type="text"
                                                        defaultVal="''"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="color"
                                                        attr="style.chart.layout.labels.quadrantLabels.tl.color"
                                                        type="color"
                                                        defaultVal="#2D353C"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="fontSize"
                                                        attr="style.chart.layout.labels.quadrantLabels.tl.fontSize"
                                                        type="number"
                                                        defaultVal="16"
                                                        :min="8"
                                                        :max="42"
                                                    ...
                                                    <BaseAttr
                                                        name="bold"
                                                        attr="style.chart.layout.labels.quadrantLabels.tl.bold"
                                                        type="checkbox"
                                                        defaultVal="true"
                                                        :light="mutableConfig"
                                                        :dark="
                                                ...
                                                <BaseDetails
                                                    attr="tr"
                                                    :level="6"
                                                    title="style.chart.layout.labels.quadrantLabels.tr"
                                                >
                                                    <BaseAttr
                                                        name="text"
                                                        attr="style.chart.layout.labels.quadrantLabels.tr.text"
                                                        type="text"
                                                        defaultVal="''"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="color"
                                                        attr="style.chart.layout.labels.quadrantLabels.tr.color"
                                                        type="color"
                                                        defaultVal="#2D353C"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="fontSize"
                                                        attr="style.chart.layout.labels.quadrantLabels.tr.fontSize"
                                                        type="number"
                                                        defaultVal="16"
                                                        :min="8"
                                                        :max="42"
                                                    ...
                                                    <BaseAttr
                                                        name="bold"
                                                        attr="style.chart.layout.labels.quadrantLabels.tr.bold"
                                                        type="checkbox"
                                                        defaultVal="true"
                                                        :light="mutableConfig"
                                                        :dark="
                                        ...
                                        >
                                            <BaseAttr
                                                ...
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                comment="Used when auto is false"
                                            />
                                            <BaseAttr
                                                name="outline"
                                                attr="style.chart.layout.plots.outline"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="outlineColor"
                                                attr="style.chart.layout.plots.outlineColor"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="outlineWidth"
                                                attr="style.chart.layout.plots.outlineWidth"
                                                type="range"
                                                defaultVal="1"
                                                :min="0"
                                                :max="12"
                                    ...
                                    >
                                        ...
                                        <BaseAttr
                                            name="showShape"
                                            attr="style.chart.tooltip.showShape"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-quadrant.vue"
                        />
                    </template>
                    <template #additional>
                        <div class="mb-4">
                            ...
                            >
                                {{ translations.slots.datapoint[store.lang] }}
                            </div>
                            <div
