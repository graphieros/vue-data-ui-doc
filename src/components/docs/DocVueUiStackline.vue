...
import ThemesVueUiStackline from "../themes/ThemesVueUiStackline.vue";
...
const innerTranslations = ref({
    distributed: {
        en: "This stacked line chart has a config option to show distributed series. In this mode, all bars take the full height of the chart, and show proportions of each datapoint.",
        fr: "Ce graphique en lignes empilées dispose d’une option de configuration pour afficher des séries distribuées. Dans ce mode, toutes les barres occupent la hauteur totale du graphique et affichent les proportions de chaque point de données.",
...
const dsTypeCode = computed(() => {
    return `type VueUiStacklineDatasetItem = {
    name: string
    series: number[]
    color?: string
    shape?: 'circle' | 'triangle' | 'square' | 'diamond' | 'pentagon' | 'hexagon' | 'star' // defaults to 'circle' if not provided
    standalone?: boolean // If true, shows the series separately from the stack (show a total target for example)
    [key: string]: any // Recoverable through the #svg slot
}`;
});

const codeDataset = ref(`const dataset: VueUiStacklineDatasetItem[] = [
    {
        name: "Serie 1",
        series: [19, 20.07, 30, 40, 50, 60, 25, 29, 32],
        shape: 'square',
...
const freestyleTemplate =
    ref(`<VueUiStackline :config="config" :dataset="dataset">
    <template #svg="{ svg }">
...
const customFormatCode =
    ref(`customFormat: ({ seriesIndex, datapoint, series, config }) => {
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.stackline[store.lang]"
        />

        <BaseDocHeaderActions
            targetLink="vue-ui-stackline"
            targetMaker="VueUiStackline"
            :configSource="mainConfig.vue_ui_stackline"
        />
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-stackline"
            />
        </div>

        <div
            class="w-full mt-6 pt-6 border-t border-gray-500 max-w-[600px] mx-auto"
        >
            <div dir="auto">
                {{ innerTranslations.distributed[store.lang] }}
            </div>
            <code class="mt-4 flex flex-row place-items-center gap-4">
                <BaseAttr
                    name="distributed"
                    attr="style.chart.lines.distributed"
                    type="checkbox"
                    defaultVal="false"
                    :light="mutableConfig"
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiStacklineConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiStacklineConfig"
                        equal
                    >
                        <span
                            >responsive: false;
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="padding"
                                    :level="3"
                                    title="style.chart.padding"
                                >
                                    <BaseAttr
                                        name="top"
                                        attr="style.chart.padding.top"
                                        type="number"
                                        defaultVal="24"
                                        :min="0"
                                        :max="64"
                                    ...
                                    <BaseAttr
                                        name="right"
                                        attr="style.chart.padding.right"
                                        type="number"
                                        defaultVal="24"
                                        :min="0"
                                        :max="64"
                                    ...
                                    <BaseAttr
                                        name="bottom"
                                        attr="style.chart.padding.bottom"
                                        type="number"
                                        defaultVal="36"
                                        :min="0"
                                        :max="64"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="position"
                                        attr="style.chart.legend.position"
                                        type="select"
                                        defaultVal="bottom"
                                        :options="['top', 'bottom']"
                                        :light="mutableConfig"
                                    ...
                                    <BaseDetails
                                        ...
                                        :level="4"
                                        title="style.chart.legend.selectAllToggle"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.legend.selectAllToggle.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.chart.legend.selectAllToggle.backgroundColor"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.legend.selectAllToggle.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <span
                                        >useResetSlot: false,
                                        <BaseComment
                                            >To use a custom slot for the reset
                                            feature (see slots tab)</BaseComment
                                        ></span
                                    >
                                    <span
                                        >startIndex: number | null,
                                        <BaseComment
                                            >Force zoom start index</BaseComment
                                        ></span
                                    >
                                    <span
                                        >endIndex: number | null,
                                        <BaseComment
                                            >Force zoom end index</BaseComment
                                        ></span
                                    >
                                    <BaseAttr
                                        name="enableRangeHandles"
                                        attr="style.chart.zoom.enableRangeHandles"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.zoom.enableSelectionDrag"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="focusOnDrag"
                                        attr="style.chart.zoom.focusOnDrag"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.zoom.focusRangeRatio"
                                        type="number"
                                        defaultVal="0.2"
                                        :min="0.1"
                                        :max="0.9"
                                    ...
                                    <BaseDetails
                                        attr="minimap"
                                        :level="4"
                                        title="style.chart.zoom.minimap"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.zoom.minimap.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="selectedColor"
                                            attr="style.chart.zoom.minimap.selectedColor"
                                            type="color"
                                            defaultVal="#1f77b4"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.zoom.minimap.selectedColorOpacity"
                                            type="range"
                                            defaultVal="0.2"
                                            :min="0"
                                            :max="0.8"
                                        ...
                                        <BaseAttr
                                            name="indicatorColor"
                                            attr="style.chart.zoom.minimap.indicatorColor"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="frameColor"
                                            attr="style.chart.zoom.minimap.frameColor"
                                            type="color"
                                            defaultVal="#A1A1A1"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.zoom.minimap.handleIconColor"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.zoom.minimap.handleBorderWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="3"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.zoom.minimap.handleBorderColor"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="handleFill"
                                            attr="style.chart.zoom.minimap.handleFill"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="handleWidth"
                                            attr="style.chart.zoom.minimap.handleWidth"
                                            type="number"
                                            defaultVal="20"
                                            :min="20"
                                            :max="40"
                                        ...
                                        <BaseAttr
                                            name="handleType"
                                            attr="style.chart.zoom.minimap.handleType"
                                            type="select"
                                            defaultVal="grab"
                                            :options="[
                                                'grab',
                                    ...
                                    <BaseDetails
                                        attr="preview"
                                        :level="4"
                                        title="style.chart.zoom.preview"
                                    >
                                        <BaseAttr
                                            name="enable"
                                            attr="style.chart.zoom.preview.enable"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fill"
                                            attr="style.chart.zoom.preview.fill"
                                            type="color"
                                            defaultVal="#CCCCCC50"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.zoom.preview.stroke"
                                            type="color"
                                            defaultVal="#6A6A6A"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.zoom.preview.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.zoom.preview.strokeDasharray"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.zoom.useDefaultFormat"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="timeFormat"
                                        attr="style.chart.zoom.timeFormat"
                                        type="text"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="showValue"
                                        attr="style.chart.tooltip.showValue"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="showPercentage"
                                        attr="style.chart.tooltip.showPercentage"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="roundingValue"
                                        attr="style.chart.tooltip.roundingValue"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.tooltip.roundingPercentage"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        name="showTimeLabel"
                                        attr="style.chart.tooltip.showTimeLabel"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="smooth"
                                        attr="style.chart.tooltip.smooth"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="smoothForce"
                                        attr="style.chart.tooltip.smoothForce"
                                        type="number"
                                        defaultVal="0.18"
                                        :min="0.1"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.tooltip.smoothSnapThreshold"
                                        type="number"
                                        defaultVal="0.25"
                                        :min="0.1"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.tooltip.useDefaultTimeFormat"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="timeFormat"
                                        attr="style.chart.tooltip.timeFormat"
                                        type="text"
                                        defaultVal="yyyy-MM-dd HH:mm:ss"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="showTotal"
                                        attr="style.chart.tooltip.showTotal"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.tooltip.totalTranslation"
                                        type="text"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    />
                                ...
                                <BaseDetails
                                    attr="highlighter"
                                    :level="3"
                                    title="style.chart.highlighter"
                                >
                                    <BaseAttr
                                        name="color"
                                        attr="style.chart.highlighter.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="opacity"
                                        attr="style.chart.highlighter.opacity"
                                        type="range"
                                        defaultVal="5"
                                        :min="0"
                                        :max="30"
                                    ...
                                    <BaseAttr
                                        name="useLine"
                                        attr="style.chart.highlighter.useLine"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="lineDasharray"
                                        attr="style.chart.highlighter.lineDasharray"
                                        type="number"
                                        defaultVal="2"
                                        :min="0"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        name="lineWidth"
                                        attr="style.chart.highlighter.lineWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="1"
                                        :max="12"
                                ...
                                <BaseDetails
                                    attr="lines"
                                    :level="3"
                                    title="style.chart.lines"
                                >
                                    <BaseAttr
                                        name="useArea"
                                        attr="style.chart.lines.useArea"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="areaOpacity"
                                        attr="style.chart.lines.areaOpacity"
                                        type="range"
                                        defaultVal="0.5"
                                        :min="0"
                                        :max="1"
                                    ...
                                    />
                                    <BaseAttr
                                        name="showDistributedPercentage"
                                        attr="style.chart.lines.showDistributedPercentage"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.lines.strokeWidth"
                                        type="range"
                                        defaultVal="1"
                                        :min="0"
                                        :max="6"
                                    ...
                                    >
                                        <BaseAttr
                                            ...
                                            attr="style.chart.lines.dot.hideAboveMaxSerieLength"
                                            type="number"
                                            defaultVal="62"
                                            :min="12"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="useSerieColor"
                                            attr="style.chart.lines.dot.useSerieColor"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.lines.dot.strokeWidth"
                                            type="number"
                                            defaultVal="0.5"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="radius"
                                            attr="style.chart.lines.dot.radius"
                                            type="number"
                                            defaultVal="4"
                                            :min="2"
                                            :max="24"
                                    ...
                                    <BaseDetails
                                        attr="gradient"
                                        :level="4"
                                        title="style.chart.lines.gradient"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.lines.gradient.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="intensity"
                                            attr="style.chart.lines.gradient.intensity"
                                            type="range"
                                            defaultVal="20"
                                            :min="0"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="totalValues"
                                        :level="4"
                                        title="style.chart.lines.totalValues"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.lines.totalValues.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.lines.totalValues.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.lines.totalValues.fontSize"
                                            type="number"
                                            defaultVal="16"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.lines.totalValues.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.lines.totalValues.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="dataLabels"
                                        :level="4"
                                        title="style.chart.lines.dataLabels"
                                    >
                                        <BaseAttr
                                            name="hideAboveMaxSerieLength"
                                            attr="style.chart.lines.dataLabels.hideAboveMaxSerieLength"
                                            type="number"
                                            defaultVal="62"
                                            :min="12"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.lines.dataLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.lines.dataLabels.hideEmptyValues"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="hideEmptyPercentages"
                                            attr="style.chart.lines.dataLabels.hideEmptyPercentages"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="hideUnderValue"
                                            attr="style.chart.lines.dataLabels.hideUnderValue"
                                            type="number"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="hideUnderPercentage"
                                            attr="style.chart.lines.dataLabels.hideUnderPercentage"
                                            type="number"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.lines.dataLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.lines.dataLabels.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.lines.dataLabels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.lines.dataLabels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.lines.dataLabels.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.lines.dataLabels.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.lines.dataLabels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-64"
                                            :max="64"
                                ...
                                <BaseDetails
                                    attr="grid"
                                    :level="3"
                                    title="style.chart.grid"
                                >
                                    <BaseDetails
                                        attr="frame"
                                        :level="4"
                                        title="style.chart.grid.frame"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.grid.frame.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.grid.frame.stroke"
                                            type="color"
                                            defaultVal="'#E1E5E8'"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.grid.frame.strokeWidth"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="strokeLinecap"
                                            attr="style.chart.grid.frame.strokeLinecap"
                                            type="text"
                                            defaultVal="round"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeLinejoin"
                                            attr="style.chart.grid.frame.strokeLinejoin"
                                            type="text"
                                            defaultVal="round"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeDasharray"
                                            attr="style.chart.grid.frame.strokeDasharray"
                                            type="number"
                                            :min="0"
                                            :max="24"
                                            :light="mutableConfig"
                                    ...
                                    <BaseDetails
                                        attr="scale"
                                        :level="4"
                                        title="style.chart.grid.scale"
                                    >
                                        <BaseAttr
                                            name="ticks"
                                            attr="style.chart.grid.scale.ticks"
                                            type="select"
                                            defaultVal="10"
                                            :options="[2, 5, 10, 20]"
                                            :light="mutableConfig"
                                        ...
                                        <BaseAttr
                                            name="scaleMin"
                                            attr="style.chart.grid.scale.scaleMin"
                                            type="number"
                                            defaultVal="null"
                                            :min="-10000"
                                            :max="10000"
                                        ...
                                        <BaseAttr
                                            name="scaleMax"
                                            attr="style.chart.grid.scale.scaleMax"
                                            type="number"
                                            defaultVal="null"
                                            :min="-10000"
                                            :max="10000"
                                    ...
                                    >
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.grid.x.showHorizontalLines"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="linesColor"
                                            attr="style.chart.grid.x.linesColor"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="linesThickness"
                                            attr="style.chart.grid.x.linesThickness"
                                            type="number"
                                            :min="0"
                                            :max="12"
                                            defaultVal="1"
                                        ...
                                        />
                                        <BaseAttr
                                            name="linesStrokeDasharray"
                                            attr="style.chart.grid.x.linesStrokeDasharray"
                                            type="number"
                                            :min="0"
                                            :max="12"
                                            defaultVal="0"
                                        ...
                                        <BaseDetails
                                            attr="axisName"
                                            :level="5"
                                            title="style.chart.grid.x.axisName"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.grid.x.axisName.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="text"
                                                attr="style.chart.grid.x.axisName.text"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.grid.x.axisName.fontSize"
                                                type="number"
                                                defaultVal="14"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.grid.x.axisName.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.grid.x.axisName.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.chart.grid.x.axisName.offsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                        ...
                                        >
                                            ...
                                            <BaseDetails
                                                ...
                                                :level="6"
                                                title="style.chart.grid.x.timeLabels.datetimeFormatter"
                                            >
                                                <BaseAttr
                                                    name="enable"
                                                    attr="style.chart.grid.x.timeLabels.datetimeFormatter.enable"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="locale"
                                                    attr="style.chart.grid.x.timeLabels.datetimeFormatter.locale"
                                                    type="select"
                                                    defaultVal="en"
                                                ...
                                                <BaseAttr
                                                    name="useUTC"
                                                    attr="style.chart.grid.x.timeLabels.datetimeFormatter.useUTC"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="januaryAsYear"
                                                    attr="style.chart.grid.x.timeLabels.datetimeFormatter.januaryAsYear"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseDetails
                                                    attr="options"
                                                    :level="7"
                                                    title="style.chart.grid.x.timeLabels.datetimeFormatter.options"
                                                >
                                                    <BaseAttr
                                                        name="year"
                                                        attr="style.chart.grid.x.timeLabels.datetimeFormatter.options.year"
                                                        type="text"
                                                        defaultVal="yyyy"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="month"
                                                        attr="style.chart.grid.x.timeLabels.datetimeFormatter.options.month"
                                                        type="text"
                                                        :defaultVal="`MMM 'yy`"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="day"
                                                        attr="style.chart.grid.x.timeLabels.datetimeFormatter.options.day"
                                                        type="text"
                                                        :defaultVal="`dd MMM`"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="minute"
                                                        attr="style.chart.grid.x.timeLabels.datetimeFormatter.options.minute"
                                                        type="text"
                                                        :defaultVal="`HH:mm:ss`"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="second"
                                                        attr="style.chart.grid.x.timeLabels.datetimeFormatter.options.second"
                                                        type="text"
                                                        :defaultVal="`HH:mm:ss`"
                                                        :light="mutableConfig"
                                                        :dark="
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.grid.x.timeLabels.fontSize"
                                                type="number"
                                                defaultVal="14"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseDetails
                                                attr="autoRotate"
                                                title="style.chart.grid.x.timeLabels.autoRotate"
                                            >
                                                <BaseAttr
                                                    name="enable"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    attr="style.chart.grid.x.timeLabels.autoRotate.enable"
                                                    :light="mutableConfig"
                                                    :dark="
                                                        mutableConfigDarkMode
                                                    "
                                                ...
                                                <BaseAttr
                                                    ...
                                                    :min="-90"
                                                    :max="90"
                                                    attr="style.chart.grid.x.timeLabels.autoRotate.angle"
                                                    :light="mutableConfig"
                                                    :dark="
                                                        mutableConfigDarkMode
                                                    "
                                    ...
                                    >
                                        <BaseAttr
                                            name="position"
                                            attr="style.chart.grid.y.position"
                                            type="select"
                                            :options="['left', 'right']"
                                            defaultVal="left"
                                            :light="mutableConfig"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.grid.y.showVerticalLines"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="linesColor"
                                            attr="style.chart.grid.y.linesColor"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="linesThickness"
                                            attr="style.chart.grid.y.linesThickness"
                                            type="number"
                                            :min="0"
                                            :max="12"
                                            defaultVal="1"
                                        ...
                                        <BaseAttr
                                            name="linesStrokeDasharray"
                                            attr="style.chart.grid.y.linesStrokeDasharray"
                                            type="number"
                                            :min="0"
                                            :max="12"
                                            defaultVal="0"
                                        ...
                                        <BaseDetails
                                            attr="axisName"
                                            :level="5"
                                            title="style.chart.grid.y.axisName"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.grid.y.axisName.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="text"
                                                attr="style.chart.grid.y.axisName.text"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.grid.y.axisName.fontSize"
                                                type="number"
                                                defaultVal="14"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.grid.y.axisName.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.grid.y.axisName.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.grid.y.axisName.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                        ...
                                        >
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.grid.y.axisLabels.fontSize"
                                                type="number"
                                                defaultVal="14"
                                                :min="8"
                                                :max="42"
    ...
    <code>
        <span class="text-gray-400">&lt;script setup&gt;</span>
            ...
            const stackbarDataset = ref([]);

            onMounted(async () => {
                stackbarDataset.value = await stacklineChart.value.getData();
            });
    ...
    <code>
        ...
        <span class="text-gray-400">&lt;script&gt;</span>
            export default {
                ...
                async mounted () {
                    this.stackbarDataset = await this.$refs.stacklineChart.getData();
                }
            }
        <span class="text-gray-400">&lt;/script&gt;</span>
    </code>
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-stackline.vue"
                        />
                    </template>
                    <!-- <template #after="item">
            ...
            <template #tab4>
                ...
                <code class="text-gray-500 dark:text-[#8A8A8A]"
                    >config.style.chart.tooltip.customFormat</code
                >
                <CodeParser
                    class="mt-4"
                    language="javascript"
