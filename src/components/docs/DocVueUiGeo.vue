...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.geo[store.lang]"
        />
                    ...
                    <BaseDetails attr="const config: VueUiGeoConfig" equal>
                        ...
                        <BaseDetails attr="map" :level="1">
                            <BaseAttr
                                ...
                                name="geoJson"
                                defaultVal="null"
                                comment="Use a valid geoJSON format"
                            />
                            <BaseAttr
                                inactive
                                name="center"
                                defaultVal="[0, 0]"
                                comment="Center map on specific coordinates"
                            />
                            <BaseAttr
                                name="fitPadding"
                                attr="map.fitPadding"
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="territory"
                                    :level="3"
                                    title="style.chart.territory"
                                >
                                    <BaseAttr
                                        name="fill"
                                        attr="style.chart.territory.fill"
                                        type="color"
                                        defaultVal="#F2F3F5"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.territory.stroke"
                                        type="color"
                                        defaultVal="#D0D4D8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.territory.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0.1"
                                        :max="6"
                                    ...
                                    <BaseDetails
                                        attr="hover"
                                        :level="4"
                                        title="style.chart.territory.hover"
                                    >
                                        <BaseAttr
                                            name="enabledWhenEmpty"
                                            attr="style.chart.territory.hover.enabledWhenEmpty"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fill"
                                            attr="style.chart.territory.hover.fill"
                                            type="color"
                                            defaultVal="#E7E1EE"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.territory.hover.stroke"
                                            type="color"
                                            defaultVal="#CCCCCC"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.territory.hover.strokeWidth"
                                            type="number"
                                            defaultVal="1.5"
                                            :min="0.1"
                                            :max="6"
                                ...
                                <BaseDetails
                                    attr="points"
                                    :level="3"
                                    title="style.chart.points"
                                >
                                    <BaseAttr
                                        name="radius"
                                        attr="style.chart.points.radius"
                                        type="number"
                                        defaultVal="1"
                                        :min="0.1"
                                        :max="6"
                                        ...
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Radius can be set on individual datapoints through the dataset"
                                    />
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.points.stroke"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="fill"
                                        attr="style.chart.points.fill"
                                        type="color"
                                        defaultVal="#4A4A4A"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Fill can be set on individual datapoints through the dataset"
                                    />
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.points.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0.1"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.points.hoverRadiusRatio"
                                        type="number"
                                        defaultVal="1.2"
                                        :min="1"
                                        :max="1.5"
                                    ...
                                    <BaseDetails
                                        attr="labels"
                                        :level="4"
                                        title="style.chart.points.labels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.points.labels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSizeRatio"
                                            attr="style.chart.points.labels.fontSizeRatio"
                                            type="number"
                                            defaultVal="1"
                                            :min="0.5"
                                            :max="2"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.points.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.points.labels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
