...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.world[store.lang]"
        />
        ...
        >
            <template v-slot:tab0>
                You can also use this component without a dataset, it will just
                show the naked map.
                    ...
                    <BaseDetails attr="const config: VueUiWorldConfig" equal>
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    <BaseAttr
                                        name="prefix"
                                        attr="style.chart.dataLabels.prefix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="suffix"
                                        attr="style.chart.dataLabels.suffix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="rounding"
                                        attr="style.chart.dataLabels.rounding"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                ...
                                <BaseDetails
                                    attr="dimensions"
                                    :level="3"
                                    title="style.chart.dimensions"
                                >
                                    <BaseAttr
                                        name="height"
                                        attr="style.chart.dimensions.height"
                                        type="number"
                                        defaultVal="null"
                                        :min="500"
                                        :max="2000"
                                    ...
                                    <BaseAttr
                                        name="width"
                                        attr="style.chart.dimensions.width"
                                        type="number"
                                        defaultVal="null"
                                        :min="500"
                                        :max="2000"
                                ...
                                <BaseDetails
                                    attr="globe"
                                    :level="3"
                                    title="style.chart.globe"
                                >
                                    <BaseDetails
                                        attr="center"
                                        :level="4"
                                        title="style.chart.globe.center"
                                    >
                                        <BaseAttr
                                            name="x"
                                            attr="style.chart.globe.center.x"
                                            type="number"
                                            defaultVal="0"
                                            :min="-500"
                                            :max="500"
                                        ...
                                        <BaseAttr
                                            name="y"
                                            attr="style.chart.globe.center.y"
                                            type="number"
                                            defaultVal="0"
                                            :min="-500"
                                            :max="500"
                                    ...
                                    <BaseAttr
                                        name="waterColor"
                                        attr="style.chart.globe.waterColor"
                                        type="color"
                                        defaultVal="#1f77b4"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="emptyColor"
                                        attr="style.chart.territory.emptyColor"
                                        type="color"
                                        defaultVal="#E0E0E0"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    />
                                    <BaseAttr
                                        name="strokeWidthSelected"
                                        attr="style.chart.territory.strokeWidthSelected"
                                        type="number"
                                        :min="0"
                                        :max="12"
                                        defaultVal="2"
                                    ...
                                    <BaseDetails
                                        attr="colors"
                                        :level="4"
                                        title="style.chart.territory.colors"
                                    >
                                        <BaseAttr
                                            name="min"
                                            attr="style.chart.territory.colors.min"
                                            type="color"
                                            defaultVal="#E0E0E0"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="max"
                                            attr="style.chart.territory.colors.max"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="showTaiwanAsPartOfChina"
                                        attr="style.chart.territory.showTaiwanAsPartOfChina"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="showMinimap"
                                        attr="style.chart.tooltip.showMinimap"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="category"
                                    attr="table.columnNames.category"
                                    type="text"
