...
const mutableDataset = ref(
    JSON.parse(JSON.stringify(dataset.value)).slice(0, slicer.value),
);
...
function updateDataset() {
    mutableDataset.value = JSON.parse(
        JSON.stringify(dataset.value.slice(0, slicer.value)),
    );
}
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.onion[store.lang]"
        />
        ...
        <div
            class="mt-6 flex flex-col gap-3 mx-auto justify-center place-items-center"
        >
            <label for="player"
                >{{ translations.docs.showMoreSeries[store.lang] }}
            </label>
            <input
                id="player"
                type="range"
        ...
        >
            ...
            <template v-slot:tab1>
                ...
                <DebugHint component="VueUiOnion" configType="VueUiOnionConfig"/>
                ...
                <code ref="configCode">
                    <BaseDetails attr="const config: VueUiOnionConfig" equal>
                        ...
                        />
                        <BaseAttr
                            name="useStartAnimation"
                            attr="useStartAnimation"
                            type="checkbox"
                            defaultVal="true"
                            :light="mutableConfig"
                            :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    <BaseAttr
                                        name="maxThickness"
                                        attr="style.chart.layout.maxThickness"
                                        type="range"
                                        defaultVal="64"
                                        :min="12"
                                        :max="64"
                                    ...
                                    <BaseDetails
                                        attr="gutter"
                                        :level="4"
                                        title="style.chart.layout.gutter"
                                    >
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.gutter.color"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="width"
                                            attr="style.chart.layout.gutter.width"
                                            type="range"
                                            defaultVal="0.62"
                                            :min="0"
                                            :max="1"
                                    ...
                                    >
                                        <BaseAttr
                                            name="showValueFirst"
                                            attr="style.chart.layout.labels.showValueFirst"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.layout.labels.usePercentageParens"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="useValueParens"
                                            attr="style.chart.layout.labels.useValueParens"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.labels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="roundingValue"
                                            attr="style.chart.layout.labels.roundingValue"
                                            type="number"
                                            :min="0"
                                            :max="6"
                                            :light="mutableConfig"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.layout.labels.roundingPercentage"
                                            type="number"
                                            :min="0"
                                            :max="6"
                                            :light="mutableConfig"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.layout.labels.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.layout.labels.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.layout.labels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="track"
                                        :level="4"
                                        title="style.chart.layout.track"
                                    >
                                        <BaseAttr
                                            name="width"
                                            attr="style.chart.layout.track.width"
                                            type="range"
                                            defaultVal="0.62"
                                            :min="0.1"
                                            :max="1"
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="percentage"
                                    attr="table.translations.percentage"
                                    type="text"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-onion.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
