...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.nestedDonuts[store.lang]"
        />
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-nested-donuts"
            />
        </div>
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiNestedDonutsConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiNestedDonutsConfig"
                        equal
                    >
                        <span
                            >responsive: false;
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <BaseAttr
                                            name="spacingRatio"
                                            attr="style.chart.layout.donut.spacingRatio"
                                            type="range"
                                            defaultVal="0.5"
                                            :min="0.1"
                                            :max="1"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.layout.labels.dataLabels.fontSize"
                                                type="number"
                                                defaultVal="14"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.layout.labels.dataLabels.offsetX"
                                                type="number"
                                                defaultVal="4"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.chart.layout.labels.dataLabels.offsetY"
                                                type="number"
                                                defaultVal="12"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="useSerieColor"
                                                attr="style.chart.layout.labels.dataLabels.useSerieColor"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="showValue"
                                                attr="style.chart.layout.labels.dataLabels.showValue"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="showPercentage"
                                                attr="style.chart.layout.labels.dataLabels.showPercentage"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="boldValue"
                                                attr="style.chart.layout.labels.dataLabels.boldValue"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="boldPercentage"
                                                attr="style.chart.layout.labels.dataLabels.boldPercentage"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="roundingValue"
                                                attr="style.chart.layout.labels.dataLabels.roundingValue"
                                                type="number"
                                                defaultVal="0"
                                                :min="0"
                                                :max="6"
                                            ...
                                            <BaseAttr
                                                ...
                                                attr="style.chart.layout.labels.dataLabels.roundingPercentage"
                                                type="number"
                                                defaultVal="0"
                                                :min="0"
                                                :max="6"
                                            ...
                                            <BaseAttr
                                                name="showDonutName"
                                                attr="style.chart.layout.labels.dataLabels.showDonutName"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            />
                                            <BaseAttr
                                                name="curvedDonutName"
                                                attr="style.chart.layout.labels.dataLabels.curvedDonutName"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="boldDonutName"
                                                attr="style.chart.layout.labels.dataLabels.boldDonutName"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            />
                                            <BaseAttr
                                                name="donutNameAbbreviation"
                                                attr="style.chart.layout.labels.dataLabels.donutNameAbbreviation"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            />
                                            <BaseAttr
                                                name="donutNameMaxAbbreviationSize"
                                                attr="style.chart.layout.labels.dataLabels.donutNameMaxAbbreviationSize"
                                                type="number"
                                                defaultVal="3"
                                                :min="1"
                                                :max="12"
                                            ...
                                            />
                                            <BaseAttr
                                                name="donutNameOffsetY"
                                                attr="style.chart.layout.labels.dataLabels.donutNameOffsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                ...
                                >
                                    ...
                                    />
                                    <BaseAttr
                                        name="showAllItemsAtIndex"
                                        attr="style.chart.tooltip.showAllItemsAtIndex"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-nested-donuts.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
