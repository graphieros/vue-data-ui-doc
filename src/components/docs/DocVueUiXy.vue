...
function toggleUseIndividualScale() {
    mutableConfig.value.chart.grid.labels.yAxis.useIndividualScale =
        !mutableConfig.value.chart.grid.labels.yAxis.useIndividualScale;
    mutableConfigDarkMode.value.chart.grid.labels.yAxis.useIndividualScale =
        !mutableConfigDarkMode.value.chart.grid.labels.yAxis.useIndividualScale;
    forceChartUpdate();
}

function toggleUseStacked() {
    mutableConfig.value.chart.grid.labels.yAxis.stacked =
        !mutableConfig.value.chart.grid.labels.yAxis.stacked;
    mutableConfigDarkMode.value.chart.grid.labels.yAxis.stacked =
        !mutableConfigDarkMode.value.chart.grid.labels.yAxis.stacked;
    forceChartUpdate();
}
...
function randomizeData(N = 11) {
    ...
    average.value =
        ...
        (mutableDataset.value[0].series.length +
...
const customFormatCode =
    ref(`customFormat: ({ seriesIndex, datapoint, series, config, bars, lines, plots }) => {
...
<template>
    <div>
        ...
        <div
            :class="`doc-whart-wrapper transition-all mx-auto w-full sm:w-2/3`"
        >
            <DocSnapper
                :isFixed="isFixed"
        ...
        >
            ...
            <template v-slot:tab1>
                <div class="w-full overflow-x-auto">
                    ...
                    <div>
                        TS type:
                        <code class="text-app-blue"
                            ><BaseTextCopy>VueUiXyConfig</BaseTextCopy></code
                        >
                    </div>
                    ...
                    <code ref="configCode">
                        <BaseDetails attr="const config: VueUiXyConfig" equal>
                            ...
                            <BaseAttr
                                inactive
                                name="responsiveProportionalSizing"
                                defaultVal="true"
                                :comment="
                                    translations.responsiveProportionalSizing[
                                        store.lang
                                    ]
                                "
                            />
                            <BaseAttr
                                ...
                                name="theme"
                                defaultVal="''"
                                comment="'' | 'dark' | 'celebration' | 'celebrationNight' | 'zen' | 'hack' | 'concrete'"
                            />
                            <BaseAttr
                                inactive
                                name="customPalette"
                            ...
                            />
                            <BaseAttr
                                name="useCssAnimation"
                                attr="useCssAnimation"
                                type="checkbox"
                                defaultVal="true"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            ...
                            <BaseDetails attr="a11y" :level="1">
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="tableAvailable"
                                        attr="a11y.translations.tableAvailable"
                                        type="text"
                                    ...
                                    <BaseAttr
                                        name="tableCaption"
                                        attr="a11y.translations.tableCaption"
                                        type="text"
                                        defaultVal="'Chart data table'"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    />
                                </BaseDetails>
                            ...
                            <BaseDetails attr="chart" :level="1">
                                ...
                                >
                                    ...
                                    <BaseDetails
                                        indent
                                        attr="yAxis"
                                        title="chart.annotations[i].yAxis"
                                        :level="3"
                                    >
                                        <BaseAttr
                                            inactive
                                        ...
                                        <BaseAttr
                                            ...
                                            defaultVal="null,"
                                            :comment="
                                                translations.annotationsYBottom[
                                                    store.lang
                                                ]
                                            "
                                        />
                                        <BaseDetails
                                            attr="label"
                                            :level="4"
                                            title="chart.annotations[i].yAxis.label"
                                        >
                                            <BaseAttr
                                                inactive
                                                name="text"
                                            ...
                                            <BaseDetails
                                                attr="padding"
                                                :level="5"
                                                title="chart.annotations[i].yAxis.label.padding"
                                            >
                                                <BaseAttr
                                                    inactive
                                                    name="top"
                                            ...
                                            <BaseDetails
                                                attr="border"
                                                :level="5"
                                                title="chart.annotations[i].yAxis.label.border"
                                            >
                                                <BaseAttr
                                                    inactive
                                                    name="stroke"
                                        ...
                                        <BaseDetails
                                            attr="line"
                                            :level="4"
                                            title="chart.annotations[i].yAxis.line"
                                        >
                                            <BaseAttr
                                                inactive
                                                name="stroke"
                                        ...
                                        <BaseDetails
                                            attr="area"
                                            :level="2"
                                            title="chart.annotations[i].yAxis.area"
                                        >
                                            <BaseAttr
                                                inactive
                                                name="fill"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="showInTooltip"
                                        attr="chart.comments.showInTooltip"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="chart.grid.showVerticalLines"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="chart.grid.showHorizontalLines"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="position"
                                        attr="chart.grid.position"
                                        type="select"
                                        defaultVal="middle"
                                        :options="['middle', 'start']"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Since v2.3.40"
                                        :tooltip="
                                            translations.docTooltips.xy
                                                .gridPosition[store.lang]
                                        "
                                    />
                                    <BaseDetails
                                        attr="frame"
                                        :level="3"
                                        title="chart.grid.frame"
                                    >
                                        <span
                                            ><BaseComment
                                                >Since v2.3.40</BaseComment
                                            ></span
                                        >
                                        <BaseAttr
                                            name="show"
                                            attr="chart.grid.frame.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="chart.grid.frame.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="strokeLinecap"
                                            attr="chart.grid.frame.strokeLinecap"
                                            type="select"
                                            defaultVal="round"
                                            :options="[
                                                'round',
                                        ...
                                        <BaseAttr
                                            name="strokeLinejoin"
                                            attr="chart.grid.frame.strokeLinejoin"
                                            type="select"
                                            defaultVal="round"
                                            :options="[
                                                'round',
                                        ...
                                        <BaseAttr
                                            name="strokeDasharray"
                                            attr="chart.grid.frame.strokeDasharray"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="labels"
                                        :level="3"
                                        title="chart.grid.labels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="chart.grid.labels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            :tooltip="
                                                translations.docTooltips.xy
                                                    .labelsShow[store.lang]
                                            "
                                        />
                                        <BaseAttr
                                            name="color"
                                            attr="chart.grid.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="chart.grid.labels.fontSize"
                                            type="number"
                                            defaultVal="12"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseDetails
                                            attr="axis"
                                            :level="4"
                                            title="chart.grid.labels.axis"
                                        >
                                            <BaseAttr
                                                name="yLabel"
                                                attr="chart.grid.labels.axis.yLabel"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                :tooltip="
                                                    translations.docTooltips.xy
                                                        .axisLabels[store.lang]
                                                "
                                            />
                                            <BaseAttr
                                                name="yLabelOffsetX"
                                                attr="chart.grid.labels.axis.yLabelOffsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-50"
                                                :max="50"
                                            ...
                                            <BaseAttr
                                                name="xLabel"
                                                attr="chart.grid.labels.axis.xLabel"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="xLabelOffsetY"
                                                attr="chart.grid.labels.axis.xLabelOffsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-50"
                                                :max="50"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="chart.grid.labels.axis.fontSize"
                                                type="number"
                                                defaultVal="12"
                                                :min="8"
                                                :max="42"
                                        ...
                                        >
                                            ...
                                            <BaseAttr
                                                name="showCrosshairs"
                                                attr="chart.grid.labels.xAxis.showCrosshairs"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="crosshairSize"
                                                attr="chart.grid.labels.xAxis.crosshairSize"
                                                type="number"
                                                defaultVal="6"
                                                :min="0"
                                                :max="20"
                                            ...
                                            />
                                            <BaseAttr
                                                name="crosshairsAlwaysAtZero"
                                                attr="chart.grid.labels.xAxis.crosshairsAlwaysAtZero"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="xAxisLabels"
                                            :level="4"
                                            title="chart.grid.labels.xAxisLabels"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="chart.grid.labels.xAxisLabels.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                ...
                                                attr="chart.grid.labels.xAxisLabels.showOnlyFirstAndLast"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                ...
                                                :level="5"
                                                title="chart.grid.labels.xAxisLabels.datetimeFormatter"
                                            >
                                                <BaseAttr
                                                    name="enable"
                                                    attr="chart.grid.labels.xAxisLabels.datetimeFormatter.enable"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="locale"
                                                    attr="chart.grid.labels.xAxisLabels.datetimeFormatter.locale"
                                                    type="select"
                                                    defaultVal="en"
                                                    :options="store.locales"
                                                    :light="mutableConfig"
                                                    :dark="
                                                        mutableConfigDarkMode
                                                    "
                                                ...
                                                <BaseAttr
                                                    name="useUTC"
                                                    attr="chart.grid.labels.xAxisLabels.datetimeFormatter.useUTC"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="januaryAsYear"
                                                    attr="chart.grid.labels.xAxisLabels.datetimeFormatter.januaryAsYear"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseDetails
                                                    attr="options"
                                                    :level="6"
                                                    title="chart.grid.labels.xAxisLabels.datetimeFormatter.options"
                                                >
                                                    <BaseAttr
                                                        name="year"
                                                        attr="chart.grid.labels.xAxisLabels.datetimeFormatter.options.year"
                                                        type="text"
                                                        defaultVal="yyyy"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="month"
                                                        attr="chart.grid.labels.xAxisLabels.datetimeFormatter.options.month"
                                                        type="text"
                                                        :defaultVal="`MMM 'yy`"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="day"
                                                        attr="chart.grid.labels.xAxisLabels.datetimeFormatter.options.day"
                                                        type="text"
                                                        :defaultVal="`dd MMM`"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="minute"
                                                        attr="chart.grid.labels.xAxisLabels.datetimeFormatter.options.minute"
                                                        type="text"
                                                        :defaultVal="`HH:mm:ss`"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="second"
                                                        attr="chart.grid.labels.xAxisLabels.datetimeFormatter.options.second"
                                                        type="text"
                                                        :defaultVal="`HH:mm:ss`"
                                                        :light="mutableConfig"
                                                        :dark="
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="chart.grid.labels.xAxisLabels.fontSize"
                                                type="number"
                                                defaultVal="12"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="yOffset"
                                                attr="chart.grid.labels.xAxisLabels.yOffset"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                ...
                                                attr="chart.grid.labels.xAxisLabels.showOnlyAtModulo"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="rotation"
                                                attr="chart.grid.labels.xAxisLabels.rotation"
                                                type="range"
                                                defaultVal="0"
                                                :min="-90"
                                                :max="90"
                                            ...
                                            <BaseDetails
                                                attr="autoRotate"
                                                title="chart.grid.labels.xAxisLabels.autoRotate"
                                            >
                                                <BaseAttr
                                                    name="enable"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    attr="chart.grid.labels.xAxisLabels.autoRotate.enable"
                                                    :light="mutableConfig"
                                                    :dark="
                                                        mutableConfigDarkMode
                                                    "
                                                ...
                                                <BaseAttr
                                                    ...
                                                    :min="-90"
                                                    :max="90"
                                                    attr="chart.grid.labels.xAxisLabels.autoRotate.angle"
                                                    :light="mutableConfig"
                                                    :dark="
                                                        mutableConfigDarkMode
                                                    "
                                        ...
                                        >
                                            ...
                                            <BaseAttr
                                                ...
                                                attr="chart.grid.labels.yAxis.useIndividualScale"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="useNiceScale"
                                                attr="chart.grid.labels.yAxis.useNiceScale"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="labelWidth"
                                                attr="chart.grid.labels.yAxis.labelWidth"
                                                type="number"
                                                defaultVal="40"
                                                :min="40"
                                                :max="64"
                                            ...
                                            <BaseAttr
                                                name="stacked"
                                                attr="chart.grid.labels.yAxis.stacked"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                comment="Always use in combination with useIndividualScale: true"
                                            />
                                            <BaseAttr
                                                name="gap"
                                                attr="chart.grid.labels.yAxis.gap"
                                                type="number"
                                                defaultVal="12"
                                                :min="12"
                                                :max="100"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                comment="To be used with useIndividualScale: true && stacked: true"
                                            />
                                            <BaseAttr
                                                name="showBaseline"
                                                attr="chart.grid.labels.yAxis.showBaseline"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="scaleMin"
                                                attr="chart.grid.labels.yAxis.scaleMin"
                                                type="number"
                                                defaultVal="null"
                                                :min="-1000"
                                                :max="0"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                comment="Force the min scale for the whole chart"
                                            />
                                            <BaseAttr
                                                name="scaleMax"
                                                attr="chart.grid.labels.yAxis.scaleMax"
                                                type="number"
                                                defaultVal="null"
                                                :min="0"
                                                :max="1000"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                comment="Force the max scale for the whole chart"
                                            />
                                            <BaseAttr
                                                name="groupColor"
                                                attr="chart.grid.labels.yAxis.groupColor"
                                                type="color"
                                                defaultVal="null"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                comment="Set color of scales when they are grouped by the same scaleLabel (requires useIndividualScale: true)"
                                            />
                                            <BaseAttr
                                                name="scaleLabelOffsetX"
                                                attr="chart.grid.labels.yAxis.scaleLabelOffsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                comment="Active when useIndividualScale is set to true"
                                            />
                                            <BaseAttr
                                                name="scaleValueOffsetX"
                                                attr="chart.grid.labels.yAxis.scaleValueOffsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="showCrosshairs"
                                                attr="chart.grid.labels.yAxis.showCrosshairs"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="crosshairSize"
                                                attr="chart.grid.labels.yAxis.crosshairSize"
                                                type="number"
                                                defaultVal="6"
                                                :min="0"
                                                :max="20"
                                        ...
                                        <BaseDetails
                                            attr="zeroLine"
                                            :level="4"
                                            title="chart.grid.labels.zeroLine"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="chart.grid.labels.zeroLine.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="highlightArea"
                                    :level="2"
                                    title="chart.highlightArea"
                                >
                                    <span
                                        ><BaseComment
                                            >Since v2.3.40, you can pass an
                                            array of highlighter objects in here
                                            for multiple highlight
                                            areas</BaseComment
                                        ></span
                                    >
                                    <BaseAttr
                                        name="show"
                                        attr="chart.highlightArea.show"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="chart.highlightArea.color"
                                        type="color"
                                        :rgba="false"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="opacity"
                                        attr="chart.highlightArea.opacity"
                                        type="range"
                                        defaultVal="20"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseDetails
                                        attr="caption"
                                        :level="3"
                                        title="chart.highlightArea.caption"
                                    >
                                        <BaseAttr
                                            name="text"
                                            attr="chart.highlightArea.caption.text"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="chart.highlightArea.caption.fontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="chart.highlightArea.caption.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="chart.highlightArea.caption.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="chart.highlightArea.caption.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            inactive
                                            name="width"
                                            defaultVal="'auto' | number"
                                        />
                                        <BaseAttr
                                            name="padding"
                                            attr="chart.highlightArea.caption.padding"
                                            type="number"
                                            defaultVal="3"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="textAlign"
                                            attr="chart.highlightArea.caption.textAlign"
                                            type="select"
                                            defaultVal="left"
                                            :options="[
                                                'left',
                                ...
                                <BaseDetails
                                    attr="highlighter"
                                    :level="2"
                                    title="chart.highlighter"
                                >
                                    <BaseAttr
                                        name="color"
                                        attr="chart.highlighter.color"
                                        type="color"
                                        :rgba="false"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="opacity"
                                        attr="chart.highlighter.opacity"
                                        type="range"
                                        defaultVal="5"
                                        :min="0"
                                        :max="30"
                                    ...
                                    <BaseAttr
                                        name="useLine"
                                        attr="chart.highlighter.useLine"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="lineDasharray"
                                        attr="chart.highlighter.lineDasharray"
                                        type="number"
                                        defaultVal="2"
                                        :min="0"
                                        :max="64"
                                    ...
                                    <BaseAttr
                                        name="lineWidth"
                                        attr="chart.highlighter.lineWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                ...
                                >
                                    ...
                                    />
                                    <BaseDetails
                                        attr="selectAllToggle"
                                        :level="3"
                                        title="chart.legend.selectAllToggle"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="chart.legend.selectAllToggle.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="chart.legend.selectAllToggle.backgroundColor"
                                            type="color"
                                            defaultVal="#e1e5e8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="chart.legend.selectAllToggle.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="chart.timeTag.backgroundColor"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="circleMarker"
                                        :level="3"
                                        title="chart.timeTag.circleMarker"
                                    >
                                        <BaseAttr
                                            name="radius"
                                            attr="chart.timeTag.circleMarker.radius"
                                            type="number"
                                            defaultVal="3"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="chart.timeTag.circleMarker.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="chart.timeTag.useDefaultFormat"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="timeFormat"
                                        attr="chart.timeTag.timeFormat"
                                        type="text"
                                        defaultVal="yyyy-MM-dd HH:mm:ss"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Use with datetimeFormatter.enable = true"
                                    />
                                    ...
                                    >
                                        <BaseAttr
                                            ...
                                            name="customFormat"
                                            defaultVal="null"
                                            comment="default behavior. To customize content, see 'custom tooltip' tab (works the same way as the tooltip)"
                                        />
                                        <div class="min-w-[200px]">
                                            <BaseTabLink
                                ...
                                >
                                    ...
                                    >
                                        <BaseAttr
                                            name="fontSize"
                                            attr="chart.title.subtitle.fontSize"
                                            type="number"
                                            defaultVal="16"
                                            :min="8"
                                            :max="48"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="chart.title.subtitle.color"
                                            type="color"
                                            defaultVal="#A1A1A1"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="text"
                                            attr="chart.title.subtitle.text"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                >
                                    <BaseAttr
                                        ...
                                        name="teleportTo"
                                        defaultVal="'body'"
                                        comment="Sets the 'to' attr of the Teleport Vue component"
                                    />
                                    <BaseAttr
                                        name="show"
                                        attr="chart.tooltip.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="chart.tooltip.backgroundColor"
                                        :rgba="false"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="showPercentage"
                                        attr="chart.tooltip.showPercentage"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="roundingValue"
                                        attr="chart.tooltip.roundingValue"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                    ...
                                    />
                                    <BaseAttr
                                        name="roundingPercentage"
                                        attr="chart.tooltip.roundingPercentage"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        name="borderRadius"
                                        attr="chart.tooltip.borderRadius"
                                        type="number"
                                        defaultVal="4"
                                        :min="0"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        name="borderColor"
                                        attr="chart.tooltip.borderColor"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="borderWidth"
                                        attr="chart.tooltip.borderWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="chart.tooltip.backgroundOpacity"
                                        type="range"
                                        defaultVal="100"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="showTimeLabel"
                                        attr="chart.tooltip.showTimeLabel"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    />
                                    <BaseAttr
                                        name="useDefaultTimeFormat"
                                        attr="chart.tooltip.useDefaultTimeFormat"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="smoothForce"
                                        attr="chart.tooltip.smoothForce"
                                        type="number"
                                        defaultVal="0.18"
                                        :min="0.1"
                                        :max="1"
                                    ...
                                    />
                                    <BaseAttr
                                        name="smoothSnapThreshold"
                                        attr="chart.tooltip.smoothSnapThreshold"
                                        type="number"
                                        defaultVal="0.25"
                                        :min="0.1"
                                        :max="24"
                                ...
                                <BaseDetails
                                    attr="userOptions"
                                    :level="2"
                                    title="chart.userOptions"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="chart.userOptions.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="chart.userOptions.showOnChartHover"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="chart.userOptions.keepStateOnChartLeave"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="position"
                                        attr="chart.userOptions.position"
                                        type="select"
                                        defaultVal="right"
                                        :options="['right', 'left']"
                                        :light="mutableConfig"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="chart.userOptions.useCursorPointer"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="buttons"
                                        :level="3"
                                        title="chart.userOptions.buttons"
                                    >
                                        <BaseAttr
                                            name="tooltip"
                                            attr="chart.userOptions.buttons.tooltip"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="pdf"
                                            attr="chart.userOptions.buttons.pdf"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="img"
                                            attr="chart.userOptions.buttons.img"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="csv"
                                            attr="chart.userOptions.buttons.csv"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="table"
                                            attr="chart.userOptions.buttons.table"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="labels"
                                            attr="chart.userOptions.buttons.labels"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stack"
                                            attr="chart.userOptions.buttons.stack"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fullscreen"
                                            attr="chart.userOptions.buttons.fullscreen"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="annotator"
                                            attr="chart.userOptions.buttons.annotator"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="buttonTitles"
                                        :level="3"
                                        title="chart.userOptions.buttonTitles"
                                    >
                                        <BaseAttr
                                            name="open"
                                            attr="chart.userOptions.buttonTitles.open"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="close"
                                            attr="chart.userOptions.buttonTitles.close"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="tooltip"
                                            attr="chart.userOptions.buttonTitles.tooltip"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="pdf"
                                            attr="chart.userOptions.buttonTitles.pdf"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="csv"
                                            attr="chart.userOptions.buttonTitles.csv"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="img"
                                            attr="chart.userOptions.buttonTitles.img"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="table"
                                            attr="chart.userOptions.buttonTitles.table"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="labels"
                                            attr="chart.userOptions.buttonTitles.labels"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="fullscreen"
                                            attr="chart.userOptions.buttonTitles.fullscreen"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="stack"
                                            attr="chart.userOptions.buttonTitles.stack"
                                            type="text"
                                        ...
                                        <BaseAttr
                                            name="annotator"
                                            attr="chart.userOptions.buttonTitles.annotator"
                                            type="text"
                                    ...
                                    <BaseDetails
                                        attr="callbacks"
                                        :level="3"
                                        title="chart.userOptions.callbacks"
                                    >
                                        <BaseTabLink
                                    ...
                                    <BaseDetails
                                        attr="print"
                                        :level="3"
                                        title="chart.userOptions.print"
                                    >
                                        <BaseAttr
                                            name="scale"
                                            attr="chart.userOptions.print.scale"
                                            type="number"
                                            :min="1"
                                            :max="5"
                                            defaultVal="2"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="highlightColor"
                                        attr="chart.zoom.highlightColor"
                                        type="color"
                                        defaultVal="#4A4A4A"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        <BaseAttr
                                            ...
                                            name="useResetSlot"
                                            defaultVal="false"
                                            comment="To use a custom slot for the reset feature (see slots tab)"
                                        />
                                        <div class="min-w-[200px]">
                                            <BaseTabLink
                                    ...
                                    <BaseAttr
                                        ...
                                        name="startIndex"
                                        defaultVal="null"
                                        comment="Force zoom start index (number)"
                                    />
                                    <BaseAttr
                                        inactive
                                        name="endIndex"
                                        defaultVal="null"
                                        comment="Force zoom end index (number)"
                                    />
                                    <BaseAttr
                                        name="enableRangeHandles"
                                        attr="chart.zoom.enableRangeHandles"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Since v2.4.63"
                                    />
                                    <BaseAttr
                                        name="enableSelectionDrag"
                                        attr="chart.zoom.enableSelectionDrag"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="useDefaultFormat"
                                        attr="chart.zoom.useDefaultFormat"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    />
                                    <BaseAttr
                                        name="focusRangeRatio"
                                        attr="chart.zoom.focusRangeRatio"
                                        type="number"
                                        defaultVal="0.2"
                                        :min="0.1"
                                        :max="0.9"
                                    ...
                                    <BaseDetails
                                        attr="minimap"
                                        :level="3"
                                        title="chart.zoom.minimap"
                                    >
                                        <span
                                            ><BaseComment
                                                >Since v2.3.49</BaseComment
                                            ></span
                                        >
                                        <BaseAttr
                                            name="show"
                                            attr="chart.zoom.minimap.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="smooth"
                                            attr="chart.zoom.minimap.smooth"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="lineColor"
                                            attr="chart.zoom.minimap.lineColor"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="selectedColor"
                                            attr="chart.zoom.minimap.selectedColor"
                                            type="color"
                                            defaultVal="#1F77B4"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="selectedColorOpacity"
                                            attr="chart.zoom.minimap.selectedColorOpacity"
                                            type="range"
                                            defaultVal="0.2"
                                            :min="0"
                                            :max="1"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="chart.zoom.minimap.selectionRadius"
                                            type="range"
                                            defaultVal="2"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="indicatorColor"
                                            attr="chart.zoom.minimap.indicatorColor"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="verticalHandles"
                                            attr="chart.zoom.minimap.verticalHandles"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="Since v2.4.72"
                                        />
                                        <BaseAttr
                                            name="compact"
                                            attr="chart.zoom.minimap.compact"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="Since v3.1.8"
                                        />
                                        <BaseAttr
                                            name="merged"
                                            attr="chart.zoom.minimap.merged"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="frameColor"
                                            attr="chart.zoom.minimap.frameColor"
                                            type="color"
                                            defaultVal="#A1A1A1"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="chart.zoom.minimap.additionalHeight"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="20"
                                        ...
                                        />
                                        <BaseAttr
                                            name="handleIconColor"
                                            attr="chart.zoom.minimap.handleIconColor"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="chart.zoom.minimap.handleBorderWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="3"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="chart.zoom.minimap.handleBorderColor"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="handleFill"
                                            attr="chart.zoom.minimap.handleFill"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="handleWidth"
                                            attr="chart.zoom.minimap.handleWidth"
                                            type="number"
                                            defaultVal="20"
                                            :min="20"
                                            :max="40"
                                        ...
                                        <BaseAttr
                                            name="handleType"
                                            attr="chart.zoom.minimap.handleType"
                                            type="select"
                                            defaultVal="grab"
                                            :options="[
                                                'grab',
                                    ...
                                    <BaseDetails
                                        attr="preview"
                                        :level="3"
                                        title="chart.zoom.preview"
                                    >
                                        <BaseAttr
                                            name="enable"
                                            attr="chart.zoom.preview.enable"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            inactive
                                            name="fill"
                                            attr="chart.zoom.preview.fill"
                                            type="color"
                                            defaultVal="#CCCCCC50"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="Important: use a transparent color"
                                        />
                                        <BaseAttr
                                            name="stroke"
                                            attr="chart.zoom.preview.stroke"
                                            type="color"
                                            defaultVal="#6A6A6A"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="chart.zoom.preview.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="strokeDasharray"
                                            attr="chart.zoom.preview.strokeDasharray"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                            ...
                            <BaseDetails attr="bar" :level="1">
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="useSerieColor"
                                        attr="bar.serieName.useSerieColor"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="bar.serieName.useAbbreviation"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="bar.serieName.abbreviationSize"
                                        type="number"
                                        defaultVal="3"
                                        :min="1"
                                        :max="8"
                            ...
                            <BaseDetails attr="line" :level="1">
                                ...
                                <BaseDetails
                                    attr="interLine"
                                    :level="2"
                                    title="line.interLine"
                                >
                                    <BaseAttr
                                        inactive
                                        name="pairs"
                                        attr="line.interLine.pairs"
                                        defaultVal="[]"
                                        :comment="
                                            translations.xyInterLinePairs[
                                                store.lang
                                            ]
                                        "
                                    />
                                    <BaseAttr
                                        inactive
                                        name="colors"
                                        attr="line.interLine.colors"
                                        defaultVal="[]"
                                        :comment="
                                            translations.xyInterLineColors[
                                                store.lang
                                            ]
                                        "
                                    />
                                    <BaseAttr
                                        inactive
                                        name="fillOpacity"
                                        attr="line.interLine.fillOpacity"
                                        defaultVal="0.25"
                                    />
                                </BaseDetails>
                                <BaseDetails
                            ...
                            <BaseDetails attr="table" :level="1">
                                <BaseAttr
                                    name="useDialog"
                                    attr="table.useDialog"
                                    type="checkbox"
                                    defaultVal="false"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                    comment="since v3.1.0"
                                />
                                <BaseAttr
    ...
    <code>
        ...
        <span class="text-gray-400">&lt;/script&gt;</span>
            ...
            <template #tab4>
                <h3 class="mb-4">
                    {{ translations.customFormat[store.lang] }}
                </h3>
                <code class="text-gray-500 dark:text-[#8A8A8A]"
                    >config.chart.tooltip.customFormat</code
                >
                <CodeParser
                    class="mt-4"
                    language="javascript"
                ...
                <h3 class="my-4">
                    {{ translations.customFormatCss[store.lang] }}
                </h3>
                <CodeParser
                    language="css"
            ...
            <template #tab9>
                <BaseCssOverride :content="cssContent" />
            </template>
