...
const freestyleTemplate =
    ref(`<VueUiScatter :dataset="dataset" :config="config">
  <template #svg="{ svg }">
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.scatter[store.lang]"
        />
        ...
        <BaseMigrationInfo cssAnimation debug padding />
        ...
        >
            ...
            <template v-slot:tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiScatterConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails attr="const config: VueUiScatterConfig" equal>
                        ...
                        <BaseAttr
                            ...
                            attr="usePerformanceMode"
                            type="checkbox"
                            defaultVal="false"
                            :light="mutableConfig"
                            :dark="mutableConfigDarkMode"
                            :comment="performanceModeComment[store.lang]"
                            @change="forceChartUpdate()"
                        />
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="axis"
                                    :level="3"
                                    title="style.layout.axis"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.layout.axis.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.layout.axis.strokeWidth"
                                        type="range"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                ...
                                <BaseDetails
                                    attr="correlation"
                                    :level="3"
                                    title="style.layout.correlation"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.layout.correlation.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.layout.correlation.strokeDasharray"
                                        type="range"
                                        defaultVal="2"
                                        :min="0"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.layout.correlation.strokeWidth"
                                        type="range"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseDetails
                                        attr="label"
                                        :level="4"
                                        title="style.layout.correlation.label"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.correlation.label.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.layout.corelation.label.fontSize"
                                            type="number"
                                            defaultVal="12"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="useSerieColor"
                                            attr="style.layout.correlation.label.useSerieColor"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.layout.correlation.label.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.layout.correlation.label.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="roundingValue"
                                            attr="style.layout.corelation.label.roundingValue"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="6"
                                ...
                                >
                                    <BaseAttr
                                        name="reverseAxisLabels"
                                        attr="style.layout.dataLabels.reverseAxisLabels"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="xAxis"
                                        :level="4"
                                        title="style.layout.dataLabels.xAxis"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.dataLabels.xAxis.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="name"
                                            attr="style.layout.dataLabels.xAxis.name"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.layout.dataLabels.xAxis.fontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.layout.dataLabels.xAxis.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.layout.dataLabels.xAxis.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="roundingValue"
                                            attr="style.layout.dataLabels.xAxis.roundingValue"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="showValue"
                                            attr="style.layout.dataLabels.xAxis.showValue"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="scales"
                                            :level="5"
                                            title="style.layout.dataLabels.xAxis.scales"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.layout.dataLabels.xAxis.scales.show"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="steps"
                                                attr="style.layout.dataLabels.xAxis.scales.steps"
                                                type="number"
                                                defaultVal="10"
                                                :min="0"
                                                :max="20"
                                            ...
                                            <BaseAttr
                                                name="useNiceScale"
                                                attr="style.layout.dataLabels.xAxis.scales.useNiceScale"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                attr="labels"
                                                :level="6"
                                                title="style.layout.dataLabels.xAxis.scales.labels"
                                            >
                                                <BaseAttr
                                                    inactive
                                                    name="formatter"
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.layout.dataLabels.xAxis.scales.color"
                                                    type="color"
                                                    :light="mutableConfig"
                                                    :dark="
                                                        mutableConfigDarkMode
                                                ...
                                                <BaseAttr
                                                    name="fontSize"
                                                    attr="style.layout.dataLabels.xAxis.scales.fontSize"
                                                    type="number"
                                                    :min="8"
                                                    :max="42"
                                                    :light="mutableConfig"
                                                ...
                                                <BaseAttr
                                                    name="offsetY"
                                                    attr="style.layout.dataLabels.xAxis.scales.offsetY"
                                                    type="number"
                                                    :min="-100"
                                                    :max="100"
                                                    :light="mutableConfig"
                                            ...
                                            <BaseDetails
                                                attr="verticalLines"
                                                :level="6"
                                                title="style.layout.dataLabels.xAxis.scales.verticalLines"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.layout.dataLabels.xAxis.scales.verticalLines.show"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="stroke"
                                                    attr="style.layout.dataLabels.xAxis.scales.verticalLines.stroke"
                                                    type="color"
                                                    defaultVal="#E1E5E8"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="strokeWidth"
                                                    attr="style.layout.dataLabels.xAxis.scales.verticalLines.strokeWidth"
                                                    type="number"
                                                    :min="0"
                                                    :max="4"
                                                    :step="0.1"
                                    ...
                                    <BaseDetails
                                        attr="yAxis"
                                        :level="4"
                                        title="style.layout.dataLabels.yAxis"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.dataLabels.yAxis.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="name"
                                            attr="style.layout.dataLabels.yAxis.name"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.layout.dataLabels.yAxis.fontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.layout.dataLabels.yAxis.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.layout.dataLabels.yAxis.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="roundingValue"
                                            attr="style.layout.dataLabels.yAxis.roundingValue"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="showValue"
                                            attr="style.layout.dataLabels.yAxis.showValue"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="scales"
                                            :level="5"
                                            title="style.layout.dataLabels.yAxis.scales"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.layout.dataLabels.yAxis.scales.show"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="steps"
                                                attr="style.layout.dataLabels.yAxis.scales.steps"
                                                type="number"
                                                defaultVal="10"
                                                :min="0"
                                                :max="20"
                                            ...
                                            <BaseAttr
                                                name="useNiceScale"
                                                attr="style.layout.dataLabels.yAxis.scales.useNiceScale"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                attr="labels"
                                                :level="6"
                                                title="style.layout.dataLabels.yAxis.scales.labels"
                                            >
                                                <BaseAttr
                                                    inactive
                                                    name="formatter"
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.layout.dataLabels.yAxis.scales.color"
                                                    type="color"
                                                    :light="mutableConfig"
                                                    :dark="
                                                        mutableConfigDarkMode
                                                ...
                                                <BaseAttr
                                                    name="fontSize"
                                                    attr="style.layout.dataLabels.yAxis.scales.fontSize"
                                                    type="number"
                                                    :min="8"
                                                    :max="42"
                                                    :light="mutableConfig"
                                                ...
                                                <BaseAttr
                                                    name="offsetY"
                                                    attr="style.layout.dataLabels.yAxis.scales.offsetY"
                                                    type="number"
                                                    :min="-100"
                                                    :max="100"
                                                    :light="mutableConfig"
                                            ...
                                            <BaseDetails
                                                ...
                                                :level="6"
                                                title="style.layout.dataLabels.yAxis.scales.horizontalLines"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.layout.dataLabels.yAxis.scales.horizontalLines.show"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="stroke"
                                                    attr="style.layout.dataLabels.yAxis.scales.horizontalLines.stroke"
                                                    type="color"
                                                    defaultVal="#E1E5E8"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="strokeWidth"
                                                    attr="style.layout.dataLabels.yAxis.scales.horizontalLines.strokeWidth"
                                                    type="number"
                                                    :min="0"
                                                    :max="4"
                                                    :step="0.1"
                                ...
                                <BaseDetails
                                    attr="marginalBars"
                                    :level="3"
                                    title="style.layout.marginalBars"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.layout.marginalBars.show"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="size"
                                        attr="style.layout.marginalBars.size"
                                        type="number"
                                        defaultVal="40"
                                        :min="20"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="tranches"
                                        attr="style.layout.marginalBars.tranches"
                                        type="number"
                                        defaultVal="20"
                                        :min="10"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="opacity"
                                        attr="style.layout.marginalBars.opacity"
                                        type="range"
                                        defaultVal="1"
                                        :min="0"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        name="fill"
                                        attr="style.layout.marginalBars.fill"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.layout.marginalBars.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0.1"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        name="offset"
                                        attr="style.layout.marginalBars.offset"
                                        type="number"
                                        defaultVal="20"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="borderRadius"
                                        attr="style.layout.marginalBars.borderRadius"
                                        type="number"
                                        defaultVal="2"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="useGradient"
                                        attr="style.layout.marginalBars.useGradient"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="showLines"
                                        attr="style.layout.marginalBars.showLines"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    />
                                    <BaseAttr
                                        name="linesStrokeWidth"
                                        attr="style.layout.marginalBars.linesStrokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0.1"
                                        :max="6"
                                    ...
                                    <BaseDetails
                                        attr="highlighter"
                                        :level="4"
                                        title="style.layout.marginalBars.highlighter"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.marginalBars.highlighter.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="opacity"
                                            attr="style.layout.marginalBars.highlighter.opacity"
                                            type="number"
                                            defaultVal="0.1"
                                            :min="0"
                                            :max="1"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.layout.marginalBars.highlighter.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.layout.marginalBars.highlighter.stroke"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.layout.marginalBars.highlighter.strokeWidth"
                                            type="number"
                                            defaultVal="0.5"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="strokeDasharray"
                                            attr="style.layout.marginalBars.highlighter.strokeDasharray"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="24"
                                        ...
                                        />
                                        <BaseAttr
                                            name="highlightBothAxes"
                                            attr="style.layout.marginalBars.highlighter.highlightBothAxes"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="padding"
                                    :level="3"
                                    title="style.layout.padding"
                                >
                                    <BaseAttr
                                        name="top"
                                        attr="style.layout.padding.top"
                                        type="number"
                                        defaultVal="36"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="right"
                                        attr="style.layout.padding.right"
                                        type="number"
                                        defaultVal="48"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="bottom"
                                        attr="style.layout.padding.bottom"
                                        type="number"
                                        defaultVal="36"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="left"
                                        attr="style.layout.padding.left"
                                        type="number"
                                        defaultVal="48"
                                        :min="0"
                                        :max="100"
                                ...
                                <BaseDetails
                                    attr="plots"
                                    :level="3"
                                    title="style.layout.plots"
                                >
                                    <BaseAttr
                                        name="radius"
                                        attr="style.layout.plots.radius"
                                        type="number"
                                        defaultVal="2"
                                        :min="1"
                                        :max="24"
                                    ...
                                    />
                                    <BaseAttr
                                        name="hoverRadiusRatio"
                                        attr="style.layout.plots.hoverRadiusRatio"
                                        defaultVal="2"
                                        type="number"
                                        :min="0"
                                        :max="5"
                                    ...
                                    />
                                    <BaseAttr
                                        name="opacityNotSelected"
                                        attr="style.layout.plots.opacityNotSelected"
                                        defaultVal="0.6"
                                        type="number"
                                        :min="0"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.layout.plots.strokeWidth"
                                        type="number"
                                        defaultVal="0.3"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        name="opacity"
                                        attr="style.layout.plots.opacity"
                                        type="range"
                                        defaultVal="0.6"
                                        :min="0.1"
                                        :max="1"
                                    ...
                                    <BaseDetails
                                        attr="name"
                                        :level="4"
                                        title="style.layout.plots.name"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.plots.name.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.layout.plots.name.fontSize"
                                            type="number"
                                            defaultVal="12"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.layout.plots.name.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaeAttr
                                            name="color"
                                            attr="style.layout.plots.name.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="deviation"
                                        :level="4"
                                        title="style.layout.plots.deviation"
                                    >
                                        <BaseAttr
                                            name="translation"
                                            attr="style.layout.plots.deviation.translation"
                                            type="text"
                                            defaultVal="deviation"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="roundingValue"
                                            attr="style.layout.plots.deviation.roundingValue"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="6"
                                    ...
                                    <BaseDetails
                                        attr="giftWrap"
                                        :level="4"
                                        title="style.layout.plots.giftWrap"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.plots.giftWrap.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.layout.plots.giftWrap.strokeWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="strokeDasharray"
                                            attr="style.layout.plots.giftWrap.strokeDasharray"
                                            type="range"
                                            defaultVal="0"
                                            :min="0"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="fillOpacity"
                                            attr="style.layout.plots.giftWrap.fillOpacity"
                                            type="range"
                                            defaultVal="0.2"
                                            :min="0"
                                            :max="1"
                                    ...
                                    <BaseDetails
                                        attr="selectors"
                                        :level="4"
                                        title="style.layout.plots.selectors"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.plots.selectors"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeDasharray"
                                            attr="style.layout.plots.strokeDasharray"
                                            type="range"
                                            defaultVal="0"
                                            :min="0"
                                            :max="100"
                                        ...
                                        <BaseDetails
                                            attr="labels"
                                            :level="5"
                                            title="style.layout.plots.selectors.labels"
                                        >
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.layout.plots.selectors.labels.fontSize"
                                                type="number"
                                                defaultval="12"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.layout.plots.selectors.labels.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="rounding"
                                                attr="style.layout.plots.selectors.labels.rounding"
                                                type="number"
                                                defaultVal="0"
                                                :min="0"
                                                :max="6"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.layout.plots.selectors.labels.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="showName"
                                                attr="style.layout.plots.selectors.labels.showName"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="prefix"
                                                attr="style.layout.plots.selectors.labels.prefix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="suffix"
                                                attr="style.layout.plots.selectors.labels.suffix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                attr="x"
                                                :level="6"
                                                title="style.layout.plots.selectors.labels.x"
                                            >
                                                <div
                                            ...
                                            <BaseDetails
                                                attr="y"
                                                :level="6"
                                                title="style.layout.plots.selectors.labels.y"
                                            >
                                                <div
                                                    class="flex flex-row gap-2 place-items-center"
                                                >
                                        ...
                                        <BaseDetails
                                            attr="markers"
                                            :level="5"
                                            title="style.layout.plots.selectors.markers"
                                        >
                                            <BaseAttr
                                                name="radius"
                                                attr="style.layout.plots.selectors.markers.radius"
                                                type="range"
                                                defaultVal="12"
                                                :min="0"
                                                :max="24"
                                            ...
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.layout.plots.selectors.markers.stroke"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.layout.plots.selectors.markers.strokeWidth"
                                                type="number"
                                                defaultVal="0.5"
                                                :min="0"
                                                :max="12"
                                            ...
                                            <BaseAttr
                                                name="fill"
                                                attr="style.layout.plots.selectors.markers.fill"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="significance"
                                        :level="4"
                                        title="style.layout.plots.significance"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.layout.plots.significance.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="useDistanceOpacity"
                                            attr="style.layout.plots.significance.useDistanceOpacity"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.layout.plots.significance.deviationThreshold"
                                            type="number"
                                            :min="0.1"
                                            :max="12"
                                            :step="0.1"
                                        ...
                                        <BaseAttr
                                            name="opacity"
                                            attr="style.layout.plots.significance.opacity"
                                            type="range"
                                            defaultVal="0.3"
                                            :min="0"
                                            :max="1"
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.legend.backgroundColor"
                                    type="color"
                                    defaultVal="#FFFFFF"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="roundingValue"
                                    attr="style.legend.roundingValue"
                                    type="number"
                                    defaultVal="0"
                                    :min="0"
                                    :max="6"
                                ...
                                <BaseDetails
                                    ...
                                    :level="3"
                                    title="style.legend.selectAllToggle"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.legend.selectAllToggle.show"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.legend.selectAllToggle.backgroundColor"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.legend.selectAllToggle.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="borderRadius"
                                    attr="style.tooltip.borderRadidus"
                                    type="number"
                                    defaultVal="4"
                                    :min="0"
                                    :max="24"
                                ...
                                <BaseAttr
                                    name="borderWidth"
                                    attr="style.tooltip.borderWidth"
                                    type="number"
                                    defaultVal="1"
                                    :min="0"
                                    :max="24"
                                ...
                                <BaseAttr
                                    ...
                                    attr="style.tooltip.backgroundOpacity"
                                    type="range"
                                    defaultVal="100"
                                    :min="0"
                                    :max="100"
                                ...
                                <BaseAttr
                                    name="smoothForce"
                                    attr="style.tooltip.smoothForce"
                                    type="number"
                                    defaultVal="0.18"
                                    :min="0.1"
                                    :max="1"
                                ...
                                <BaseAttr
                                    ...
                                    attr="style.tooltip.smoothSnapThreshold"
                                    type="number"
                                    defaultVal="0.25"
                                    :min="0.1"
                                    :max="24"
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            <BaseDetails attr="td" :level="2" title="table.td">
                                ...
                                <BaseAttr
                                    ...
                                    attr="table.td.roundingPercentage"
                                    type="number"
                                    defaultVal="0"
                                    :min="0"
                                    :max="6"
                            ...
                            <BaseDetails
                                attr="translations"
                                :level="2"
                                title="table.translations"
                            >
                                <BaseAttr
                                    name="correlationCoefficient"
                                    attr="table.translations.correlationCoefficient"
                                    type="text"
                                    defaultVal="Correlation Coef."
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseAttr
                                    name="nbrPlots"
                                    attr="table.translations.nbrPlots"
                                    type="text"
                                    defaultVal="Nbr plots"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseAttr
                                    name="average"
                                    attr="table.translations.average"
                                    type="text"
                                    defaultVal="Average"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="series"
                                    attr="table.translations.series"
                                    type="text"
                                    defaultVal="Series"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
        ...
        <span class="text-gray-400">&lt;/script&gt;</span>
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-scatter.vue"
                        />
                    </template>
                    <template #after="item">
            ...
            <template #tab4>
                ...
                <code class="text-gray-500 dark:text-[#8A8A8A]"
                    >config.style.tooltip.customFormat</code
                >
                <CodeParser
                    class="mt-4"
                    language="javascript"
