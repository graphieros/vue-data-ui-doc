...
const dataset = ref([
    ...
    },
    {
        name: "Series 3",
        values: [
            { x: 100, y: 3.5, label: "January" },
            { x: 200, y: 2, label: "February" },
            { x: 500, y: 2, label: "March" },
...
const additionalTranslations = ref({
    temperatureColors: {
        en: 'Show the line as a gradient by using an array of colors, for example ["#FF0000", "#00FF00"]',
        fr: 'Affiche la ligne sous forme de dégradé en utilisant un tableau de couleurs, par exemple ["#FF0000", "#00FF00"]',
        pt: 'Mostra a linha como um gradiente usando um array de cores, por exemplo ["#FF0000", "#00FF00"]',
        de: 'Zeigt die Linie als Farbverlauf an, indem ein Array von Farben verwendet wird, zum Beispiel ["#FF0000", "#00FF00"]',
        zh: '使用颜色数组将线条显示为渐变色，例如 ["#FF0000", "#00FF00"]',
...
const dsTypeCode = computed(() => {
    ...
    smooth?: boolean; // v3.22.4+ false if not set
    temperatureColors?: string[]; // v3.22.4+ ${additionalTranslations.value.temperatureColors[store.lang]}
    temperatureAngle?: number; // v3.22.4+ ${additionalTranslations.value.temperatureAngle[store.lang]}
    usePlotTemperatureColors?: boolean; // v3.22.4+ ${additionalTranslations.value.usePlotTemperatureColors[store.lang]}
}`;
});
...
const customFormatCode =
    ref(`customFormat: ({ seriesIndex, datapoint, datapointIndex series, config }) => {
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.historyPlot[store.lang]"
        />
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-history-plot"
            />
        </div>
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="my-4">
                    TS type:
                    <code class="text-app-blue">VueUiHistoryPlotConfig</code>
                </div>
                    ...
                    >
                            ...
                            >
                                ...
                                >
                                    <BaseDetails
                                        attr="xAxis"
                                        :level="4"
                                        title="style.chart.grid.xAxis"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.grid.xAxis.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.grid.xAxis.stroke"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.grid.xAxis.strokeWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="12"
                                    ...
                                    <BaseDetails
                                        ...
                                        :level="4"
                                        title="style.chart.grid.horizontalLines"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.grid.horizontalLines.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.grid.horizontalLines.stroke"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.grid.horizontalLines.strokeWidth"
                                            type="number"
                                            defaultVal="0.6"
                                            :min="0"
                                            :max="12"
                                    ...
                                    <BaseDetails
                                        attr="yAxis"
                                        :level="4"
                                        title="style.chart.grid.yAxis"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.grid.yAxis.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.grid.yAxis.stroke"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.grid.yAxis.strokeWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="12"
                                    ...
                                    <BaseDetails
                                        attr="verticalLines"
                                        :level="4"
                                        title="style.chart.grid.verticalLines"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.grid.verticalLines.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.grid.verticalLines.stroke"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.grid.verticalLines.strokeWidth"
                                            type="number"
                                            defaultVal="0.6"
                                            :min="0"
                                            :max="12"
                                ...
                                <BaseDetails
                                    attr="axes"
                                    :level="3"
                                    title="style.chart.axes"
                                >
                                    <BaseDetails
                                        attr="x"
                                        :level="4"
                                        title="style.chart.axes.x"
                                    >
                                        <span>scaleMin: null,</span>
                                        <span>scaleMax: null,</span>
                                        <BaseAttr
                                            name="ticks"
                                            attr="style.chart.axes.x.ticks"
                                            type="select"
                                            :options="[2, 3, 5, 10, 20]"
                                            defaultVal="10"
                                            :light="mutableConfig"
                                        ...
                                        <BaseDetails
                                            attr="labels"
                                            title="style.chart.axes.x.labels"
                                            :level="5"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.axes.x.labels.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.axes.x.labels.fontSize"
                                                type="number"
                                                defaultVal="16"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.axes.x.labels.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.axes.x.labels.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="rounding"
                                                attr="style.chart.axes.x.labels.rounding"
                                                type="number"
                                                defaultVal="1"
                                                :min="0"
                                                :max="6"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.chart.axes.x.labels.offsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="prefix"
                                                attr="style.chart.axes.x.labels.prefix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="suffix"
                                                attr="style.chart.axes.x.labels.suffix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="rotation"
                                                attr="style.chart.axes.x.labels.rotation"
                                                type="range"
                                                defaultVal="0"
                                                :min="-90"
                                                :max="90"
                                            ...
                                            <BaseDetails
                                                attr="autoRotate"
                                                :level="6"
                                                title="style.chart.axes.x.labels.autoRotate"
                                            >
                                                <BaseAttr
                                                    name="enable"
                                                    attr="style.chart.axes.x.labels.autoRotate.enable"
                                                    :light="mutableConfig"
                                                    :dark="
                                                        mutableConfigDarkMode
                                                    "
                                                ...
                                                <BaseAttr
                                                    name="angle"
                                                    attr="style.chart.axes.x.labels.autoRotate.angle"
                                                    type="number"
                                                    defaultVal="-30"
                                                    :min="-90"
                                                    :max="90"
                                        ...
                                        <BaseDetails
                                            attr="name"
                                            title="style.chart.axes.x.name"
                                            :level="5"
                                        >
                                            <BaseAttr
                                                name="text"
                                                attr="style.chart.axes.x.name.text"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.axes.x.name.fontSize"
                                                type="number"
                                                defaultVal="16"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.axes.x.name.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.axes.x.name.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.axes.x.name.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="y"
                                        :level="4"
                                        title="style.chart.axes.y"
                                    >
                                        <span>scaleMin: null,</span>
                                        <span>scaleMax: null,</span>
                                        <BaseAttr
                                            name="ticks"
                                            attr="style.chart.axes.y.ticks"
                                            type="select"
                                            :options="[2, 3, 5, 10, 20]"
                                            defaultVal="10"
                                            :light="mutableConfig"
                                        ...
                                        <BaseDetails
                                            attr="labels"
                                            title="style.chart.axes.y.labels"
                                            :level="5"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.axes.y.labels.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.axes.y.labels.fontSize"
                                                type="number"
                                                defaultVal="16"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.axes.y.labels.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.axes.y.labels.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="rounding"
                                                attr="style.chart.axes.y.labels.rounding"
                                                type="number"
                                                defaultVal="1"
                                                :min="0"
                                                :max="6"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.chart.axes.y.labels.offsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="prefix"
                                                attr="style.chart.axes.y.labels.prefix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="suffix"
                                                attr="style.chart.axes.y.labels.suffix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="name"
                                            title="style.chart.axes.y.name"
                                            :level="5"
                                        >
                                            <BaseAttr
                                                name="text"
                                                attr="style.chart.axes.y.name.text"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.axes.y.name.fontSize"
                                                type="number"
                                                defaultVal="16"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.axes.y.name.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.axes.y.name.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.axes.y.name.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="plots"
                                    :level="3"
                                    title="style.chart.plots"
                                >
                                    <BaseAttr
                                        name="radius"
                                        attr="style.chart.plots.radius"
                                        type="number"
                                        defaultVal="16"
                                        :min="8"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.plots.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.plots.unselectedOpacity"
                                        type="number"
                                        defaultVal="0.1"
                                        :min="0"
                                        :max="1"
                                    ...
                                    <BaseDetails
                                        attr="gradient"
                                        :level="4"
                                        title="style.chart.plots.gradient"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.plots.gradient.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="intensity"
                                            attr="style.chart.plots.gradient.intensity"
                                            type="range"
                                            defaultVal="40"
                                            :min="0"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="indexLabels"
                                        :level="4"
                                        title="style.chart.plots.indexLabels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.plots.indexLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="startAtZero"
                                            attr="style.chart.plots.indexLabels.startAtZero"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.plots.indexLabels.adaptColorToBackground"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.plots.indexLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.plots.indexLabels.fontSize"
                                            type="number"
                                            defaultVal="16"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.plots.indexLabels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.plots.indexLabels.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.plots.indexLabels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="labels"
                                        :level="4"
                                        title="style.chart.plots.labels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.plots.labels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.plots.labels.fontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.plots.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.plots.labels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.plots.labels.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.plots.labels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                ...
                                <BaseDetails
                                    attr="paths"
                                    :level="3"
                                    title="style.chart.paths"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.paths.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.paths.strokeWidth"
                                        type="number"
                                        defaultVal="1.6"
                                        :min="0.1"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        name="useSerieColor"
                                        attr="style.chart.paths.useSerieColor"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="datapoint"
                                    attr="table.columnNames.datapoint"
                                    type="text"
                                    defaultVal="Datapoint"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseAttr
                                    name="x"
                                    attr="table.columnNames.x"
                                    type="text"
                                    defaultVal="x"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-history-plot.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
