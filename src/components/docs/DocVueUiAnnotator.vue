...
onBeforeMount(() => {
    if (localStorage.getItem("vue-data-ui-annotator") === null) {
        ...
        shapes.value = JSON.parse(
            localStorage.getItem("vue-data-ui-annotator"),
        ).shapes;
        lastSelectedShape.value = JSON.parse(
            localStorage.getItem("vue-data-ui-annotator"),
        ).lastSelectedShape;
    }
});
...
<template>
    <div>
        ...
        <div
            class="text-app-orange flex flex-row gap-2 mx-auto text-center w-full place-items-center justify-center"
        >
            <InfoTriangleIcon />
            {{ translations.docs.comments.annotator.warning[store.lang] }}
        </div>
        <div :class="`transition-all mx-auto`">
            ...
            <BaseCard>
                <SuspenseWrapper :width="200" :height="200">
                    ...
                    >
                        <div
                            class="flex flex-row gap-2 p-2 bg-gray-100 dark:bg-[#2A2A2A]"
                        >
                            <div class="w-full">
                                <div
                                    class="w-full h-[500px] bg-gray-200 dark:bg-[#3A3A3A] text-black dark:text-[#CCCCCC] flex place-items-center justify-center"
                                >
                                    {{ comment[store.lang] }}
                                </div>
                            </div>
        ...
        <Box showEmits>
            <template #tab0>
                ...
                {{
                    translations.docs.comments.annotator.datastructure[
                        store.lang
                    ]
                }}
                <div class="mt-4">
                    TS type:
                    <code class="text-app-green">VueUiAnnotatorDataset</code>
                </div>
                <div
      ...
      lastSelectedShape: {}
                ...
                <div class="w-full overflow-x-auto">
                    <span class="text-app-orange">{{
                        translations.docs.comments.annotator.notByYourself[
                            store.lang
                        ]
                    }}</span>
                    <pre>
...
const <span class="text-black dark:text-app-green">dataset: VueUiAnnotatorDataset</span> = {
    ...
    lastSelectedShape: {
        ...
        "isDash": false
            ...
            <template #tab1>
                <BaseCopyConfig :config="mutableConfig" @reset="resetDefault" />

                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiAnnotatorConfig</code>
                </div>
                    ...
                    >
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                <BaseAttr
                                    name="borderRadius"
                                    attr="style.buttons.borderRadius"
                                    type="range"
                                    defaultVal="6"
                                    :min="0"
                                    :max="12"
                                ...
                                <BaseDetails
                                    attr="controls"
                                    :level="3"
                                    title="style.buttons.controls"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.buttons.controls.backgroundColor"
                                        defaultVal="#FFFFFF"
                                        type="color"
                                        :light="mutableConfig"
                                        :dark="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.buttons.controls.color"
                                        defaultVal="#2D353C"
                                        type="color"
                                        :light="mutableConfig"
                                        :dark="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="border"
                                        attr="style.buttons.controls.border"
                                        defaultVal="'1px solid #262626'"
                                        type="text"
                                        :light="mutableConfig"
                                        :dark="mutableConfig"
                                    />
                                    <BaseDetails
                                        attr="selected"
                                        :level="4"
                                        title="style.buttons.controls.selected"
                                    >
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.buttons.controls.selected.backgroundColor"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfig"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.buttons.controls.selected.color"
                                            type="color"
                                            defaultVal="#FAFAFA"
                                            :light="mutableConfig"
                                            :dark="mutableConfig"
                                        ...
                                        <BaseAttr
                                            name="border"
                                            attr="style.buttons.controls.selected.border"
                                ...
                                <BaseDetails
                                    attr="shapes"
                                    :level="3"
                                    title="style.buttons.shapes"
                                >
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.buttons.shapes.backgroundColor"
                                        defaultVal="#FFFFFF"
                                        type="color"
                                        :light="mutableConfig"
                                        :dark="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.buttons.shapes.color"
                                        defaultVal="#2D353C"
                                        type="color"
                                        :light="mutableConfig"
                                        :dark="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="border"
                                        attr="style.buttons.shapes.border"
                                        defaultVal="'1px solid #262626'"
                                        type="text"
                                        :light="mutableConfig"
                                        :dark="mutableConfig"
                                    ...
                                    <BaseDetails
                                        attr="selected"
                                        :level="4"
                                        title="style.buttons.shapes.selected"
                                    >
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.buttons.shapes.selected.backgroundColor"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfig"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.buttons.shapes.selected.color"
                                            type="color"
                                            defaultVal="#FAFAFA"
                                            :light="mutableConfig"
                                            :dark="mutableConfig"
                                        ...
                                        <BaseAttr
                                            name="border"
                                            attr="style.buttons.shapes.selected.border"
                                            defaultVal="'1px solid #CCCCCC'"
                                            type="text"
                                            :light="mutableConfig"
                                            :dark="mutableConfig"
                            ...
                            >
                                <BaseAttr
                                    name="backgroundColor"
                                    attr="style.tooltips.backgroundColor"
                                    type="color"
                                    defaultVal="#FAFAFA"
                                    :light="mutableConfig"
                                    :dark="mutableConfig"
                                ...
                                <BaseAttr
                                    name="borderRadius"
                                    attr="style.tooltips.borderRadius"
                                    type="range"
                                    :min="0"
                                    :max="12"
                                    defaultVal="6"
                                ...
                                <BaseAttr
                                    name="border"
                                    attr="style.tooltips.border"
                                    type="text"
                                    defaultVal="'1 px solid #CCCCCC'"
                                    :light="mutableConfig"
                                    :dark="mutableConfig"
                                />
                                <BaseAttr
                                    name="boxShadow"
                                    attr="style.tooltips.boxShadow"
                                    type="text"
                        ...
                        <BaseDetails attr="translations" :level="1">
                            <BaseAttr
                                name="colorAlpha"
                                attr="translations.colorAlpha"
                                type="text"
                                defaultVal="Color alpha"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="dashedLines"
                                attr="translations.dashedLines"
                                type="text"
                                defaultVal="Dashed lines"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="filled"
                                attr="translations.filled"
                                type="text"
                                defaultVal="Filled"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            ...
                            <BaseAttr
                                name="fontSize"
                                attr="translations.fontSize"
                                type="text"
                                defaultVal="Font size"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="thickness"
                                attr="translations.thickness"
                                type="text"
                                defaultVal="Thickness"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="title"
                                attr="translations.title"
                                type="text"
                                defaultVal="Annotations"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipGroup"
                                attr="translations.tooltipGroup"
                                type="text"
                            ...
                            <BaseAttr
                                name="tooltipDelete"
                                attr="translations.tooltipDelete"
                                type="text"
                                defaultVal="Delete"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            ...
                            <BaseAttr
                                name="tooltipResize"
                                attr="translations.tooltipResize"
                                type="text"
                                defaultVal="Resize"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipBringToFront"
                                attr="translations.tooltipBringToFront"
                                type="text"
                                defaultVal="Bring to front"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipBringToBack"
                                attr="translations.tooltipBringToBack"
                                type="text"
                                defaultVal="Bring to back"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipDuplicate"
                                attr="translations.tooltipDuplicate"
                                type="text"
                                defaultVal="Duplicate"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipUndo"
                                attr="translations.tooltipUndo"
                                type="text"
                                defaultVal="Undo last shape"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipRedo"
                                attr="translations.tooltipRedo"
                                type="text"
                                defaultVal="Redo last shape"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipPdf"
                                attr="translations.tooltipPdf"
                                type="text"
                                defaultVal="Save pdf"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            ...
                            <BaseAttr
                                name="tooltipSave"
                                attr="translations.tooltipSave"
                                type="text"
                                defaultVal="Save annotations"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeCircle"
                                attr="translations.tooltipShapeCircle"
                                type="text"
                                defaultVal="Draw circle"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeRect"
                                attr="translations.tooltipShapeRect"
                                type="text"
                                defaultVal="Draw rect"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeArrow"
                                attr="translations.tooltipShapeArrow"
                                type="text"
                                defaultVal="Draw arrow"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeFreehand"
                                attr="translations.tooltipShapeFreehand"
                                type="text"
                                defaultVal="Freehand line"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeText"
                                attr="translations.tooltipShapeText"
                                type="text"
                                defaultVal="Text mode"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeTextLeft"
                                attr="translations.tooltipShapeTextLeft"
                                type="text"
                                defaultVal="Align left"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeTextCenter"
                                attr="translations.tooltipShapeTextCenter"
                                type="text"
                                defaultVal="Align center"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeTextRight"
                                attr="translations.tooltipShapeTextRight"
                                type="text"
                                defaultVal="Align right"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeTextBullet"
                                attr="translations.tooltipShapeTextBullet"
                                type="text"
                                defaultVal="Bullet points"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeTextBold"
                                attr="translations.tooltipShapeTextBold"
                                type="text"
                                defaultVal="Bold"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeTextItalic"
                                attr="translations.tooltipShapeTextItalic"
                                type="text"
                                defaultVal="Italic"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeTextUnderline"
                                attr="translations.tooltipShapeTextUnderline"
                                type="text"
                                defaultVal="Underlined"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            />
                            <BaseAttr
                                name="tooltipShapeColor"
                                attr="translations.tooltipShapeColor"
                                type="text"
                                defaultVal="Color"
                                :light="mutableConfig"
                                :dark="mutableConfig"
                            ...
                            <BaseAttr
                                name="tooltipImage"
                                attr="translations.tooltipImage"
                                type="text"
            ...
            <template #tab2>
                <div>
                    <code><b>@toggleOpenState</b></code>
                </div>
                <div class="text-gray-400 pl-5 mb-4">
                    {{
                        translations.docs.comments.annotator.emits
                            .toggleOpenState[store.lang]
                    }}
                </div>
                <pre>
<code>
    {
        isOpen: boolean,
                ...
                <div class="border-t border-gray-500 pt-4">
                    <code><b>@saveAnnotations</b></code>
                </div>
                <div class="text-gray-400 pl-5 mb-4">
                    {{
                        translations.docs.comments.annotator.emits
                            .saveAnnotations[store.lang]
                    }}
                </div>
                <pre>
<code>
    {
        ...
        lastSelectedShape: {}
                ...
                <div class="text-gray-400 pl-5 mb-4">
                    {{
                        translations.docs.comments.annotator.emits.calledWhen[
                            store.lang
                        ]
                    }}
                </div>
