...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.thermometer[store.lang]"
        />
        ...
        <Box
            ...
            showSlots
            showThemes
            schema="vue_ui_thermometer"
        >
            <template #tab0>
                {{ translations.docs.datastructure[store.lang] }}
                <div class="mt-4">
                    TS type:
                    <code class="text-app-green">VueUiThermometerDataset</code>
                </div>
                <div
    ...
    colors: {
        ...
        to: "#3366cc",
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiThermometerConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiThermometerConfig"
                        equal
                    >
                        <span
                            >responsive: false;
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="speedMs"
                                        attr="style.chart.animation.speedMs"
                                        type="number"
                                        defaultVal="1000"
                                        :min="50"
                                        :max="1000"
                                ...
                                <BaseDetails
                                    attr="graduations"
                                    :level="3"
                                    title="style.chart.graduations"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.graduations.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="sides"
                                        attr="style.chart.graduations.sides"
                                        type="select"
                                        defaultVal="both"
                                        :options="[
                                            'both',
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.graduations.stroke"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.graduations.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="1"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.graduations.showIntermediate"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="gradient"
                                        :level="4"
                                        title="style.chart.graduations.gradient"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.graduations.gradient.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="intensity"
                                            attr="style.chart.graduations.gradient.intensity"
                                            type="range"
                                            defaultVal="20"
                                            :min="0"
                                            :max="100"
                                ...
                                <BaseDetails
                                    attr="label"
                                    :level="3"
                                    title="style.chart.label"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.label.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="fontSize"
                                        attr="style.chart.label.fontSize"
                                        type="number"
                                        defaultVal="20"
                                        :min="8"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="minFontSize"
                                        attr="style.chart.label.minFontSize"
                                        type="number"
                                        defaultVal="6"
                                        :min="6"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="rounding"
                                        attr="style.chart.label.rounding"
                                        type="number"
                                        defaultVal="0"
                                        :min="1"
                                        :max="6"
                                ...
                                <BaseDetails
                                    attr="thermometer"
                                    :level="3"
                                    title="style.chart.thermometer"
                                >
                                    <BaseAttr
                                        name="width"
                                        attr="style.chart.thermometer.width"
                                        type="number"
                                        defaultVal="48"
                                        :min="10"
                                        :max="100"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-thermometer.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
