...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.donutEvolution[store.lang]"
        />
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiDonutEvolutionConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiDonutEvolutionConfig"
                        equal
                    >
                        <span
                            >theme: "",
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="donuts"
                                    :level="3"
                                    title="style.chart.donuts"
                                >
                                    <BaseDetails
                                        attr="hover"
                                        :level="4"
                                        title="style.chart.donuts.hover"
                                    >
                                        <BaseAttr
                                            name="hideLabelsUnderValue"
                                            attr="style.chart.donuts.hover.hideLabelUnderValue"
                                            type="number"
                                            :min="0"
                                            :max="12"
                                            :light="mutableConfig"
                                ...
                                <BaseDetails
                                    attr="dialog"
                                    :level="3"
                                    title="style.chart.dialog"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.dialog.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.chart.dialog.backgroundColor"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="header"
                                        :level="4"
                                        title="style.chart.dialog.header"
                                    >
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.chart.dialog.header.backgroundColor"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.dialog.header.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="donutChart"
                                        :level="4"
                                        title="style.chart.dialog.donutChart"
                                    >
                                        <BaseComment class="hover:underline">
                                            <RouterLink
                                                to="/docs#vue-ui-donut"
                                                >{{
                                                    translations.checkVueUiXyConfig[
                                                        store.lang
                                                    ].replaceAll(
                                                        "VueUiXy",
                                                        "VueUiDonut",
                                ...
                                >
                                    <BaseAttr
                                        name="height"
                                        attr="style.chart.layout.height"
                                        type="number"
                                        defaultVal="316"
                                        :min="200"
                                        :max="1000"
                                    ...
                                    <BaseDetails
                                        attr="dataLabels"
                                        :level="4"
                                        title="style.chart.layout.dataLabels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.dataLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.layout.dataLabels.fontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.dataLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.layout.dataLabels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.layout.dataLabels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.layout.dataLabels.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.layout.dataLabels.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.layout.dataLabels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="grid"
                                        :level="4"
                                        title="style.chart.layout.grid"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.grid.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.grid.stroke"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.grid.strokeWidth"
                                            type="number"
                                            defaultVal="0.7"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.layout.grid.showVerticalLines"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="axis"
                                            :level="5"
                                            title="style.chart.layout.grid.axis"
                                        >
                                            <BaseAttr
                                                name="yLabel"
                                                attr="style.chart.layout.grid.axis.yLabel"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="yLabelOffsetX"
                                                attr="style.chart.layout.grid.axis.yLabelOffsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="xLabel"
                                                attr="style.chart.layout.grid.axis.xLabel"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="xLabelOffsetY"
                                                attr="style.chart.layout.grid.axis.xLabelOffsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.layout.grid.axis.fontSize"
                                                type="number"
                                                defautlVal="14"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.grid.axis.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="xAxis"
                                            :level="5"
                                            title="style.chart.layout.grid.xAxis"
                                        >
                                            <BaseDetails
                                                attr="dataLabels"
                                                :level="6"
                                                title="style.chart.layout.grid.xAxis.dataLabels"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.grid.xAxis.dataLabels.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseDetails
                                                    ...
                                                    :level="7"
                                                    title="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter"
                                                >
                                                    <BaseAttr
                                                        name="enable"
                                                        attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.enable"
                                                        type="checkbox"
                                                        defaultVal="false"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="locale"
                                                        attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.locale"
                                                        type="select"
                                                        defaultVal="en"
                                                    ...
                                                    <BaseAttr
                                                        name="useUTC"
                                                        attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.useUTC"
                                                        type="checkbox"
                                                        defaultVal="false"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="januaryAsYear"
                                                        attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.januaryAsYear"
                                                        type="checkbox"
                                                        defaultVal="false"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseDetails
                                                        attr="options"
                                                        :level="8"
                                                        title="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.options"
                                                    >
                                                        <BaseAttr
                                                            name="year"
                                                            attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.options.year"
                                                            type="text"
                                                            defaultVal="yyyy"
                                                            :light="
                                                                mutableConfig
                                                        ...
                                                        <BaseAttr
                                                            name="month"
                                                            attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.options.month"
                                                            type="text"
                                                            :defaultVal="`MMM 'yy`"
                                                            :light="
                                                                mutableConfig
                                                        ...
                                                        <BaseAttr
                                                            name="day"
                                                            attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.options.day"
                                                            type="text"
                                                            :defaultVal="`dd MMM`"
                                                            :light="
                                                                mutableConfig
                                                        ...
                                                        <BaseAttr
                                                            name="minute"
                                                            attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.options.minute"
                                                            type="text"
                                                            :defaultVal="`HH:mm:ss`"
                                                            :light="
                                                                mutableConfig
                                                        ...
                                                        <BaseAttr
                                                            name="second"
                                                            attr="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter.options.second"
                                                            type="text"
                                                            :defaultVal="`HH:mm:ss`"
                                                            :light="
                                                                mutableConfig
                                                ...
                                                <BaseAttr
                                                    name="fontSize"
                                                    attr="style.chart.layout.grid.xAxis.dataLabels.fontSize"
                                                    type="number"
                                                    defaultVal="8"
                                                    :min="8"
                                                    :max="42"
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.chart.layout.grid.xAxis.dataLabels.color"
                                                    type="color"
                                                    defaultVal="#2D353C"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="offsetY"
                                                    attr="style.chart.layout.grid.xAxis.dataLabels.offsetY"
                                                    type="number"
                                                    defaultVal="0"
                                                    :min="-100"
                                                    :max="100"
                                                ...
                                                <BaseAttr
                                                    ...
                                                    attr="style.chart.layout.grid.xAxis.dataLabels.showOnlyFirstAndLast"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="rotation"
                                                    attr="style.chart.layout.grid.xAxis.dataLabels.rotation"
                                                    type="range"
                                                    defaultVal="0"
                                                    :min="-90"
                                                    :max="90"
                                                ...
                                                <BaseDetails
                                                    attr="autoRotate"
                                                    title="style.chart.layout.grid.xAxis.dataLabels.autoRotate"
                                                >
                                                    <BaseAttr
                                                        name="enable"
                                                        type="checkbox"
                                                        defaultVal="true"
                                                        attr="style.chart.layout.grid.xAxis.dataLabels.autoRotate.enable"
                                                        :light="mutableConfig"
                                                        :dark="
                                                            mutableConfigDarkMode
                                                        "
                                                    ...
                                                    <BaseAttr
                                                        ...
                                                        :min="-90"
                                                        :max="90"
                                                        attr="style.chart.layout.grid.xAxis.dataLabels.autoRotate.angle"
                                                        :light="mutableConfig"
                                                        :dark="
                                                            mutableConfigDarkMode
                                                        "
                                        ...
                                        >
                                            ...
                                            <BaseDetails
                                                attr="dataLabels"
                                                :level="6"
                                                title="style.chart.layout.grid.yAxis.dataLabels"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.grid.yAxis.dataLabels.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="fontSize"
                                                    attr="style.chart.layout.grid.yAxis.dataLabels.fontSize"
                                                    type="number"
                                                    defaultVal="10"
                                                    :min="8"
                                                    :max="42"
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.chart.layout.grid.yAxis.dataLabels.color"
                                                    type="color"
                                                    defaultVal="#2D353C"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="offsetX"
                                                    attr="style.chart.layout.grid.yAxis.dataLabels.offsetX"
                                                    type="number"
                                                    defaultVal="0"
                                                    :min="-100"
                                                    :max="100"
                                                ...
                                                <BaseAttr
                                                    name="bold"
                                                    attr="style.chart.layout.grid.yAxis.dataLabels.bold"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="steps"
                                                    attr="style.chart.layout.grid.yAxis.dataLabels.steps"
                                                    type="number"
                                                    defaultVal="10"
                                                    :min="2"
                                                    :max="20"
                                    ...
                                    <BaseDetails
                                        attr="highlighter"
                                        :level="4"
                                        title="style.chart.layout.highlighter"
                                    >
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.highlighter.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="opacity"
                                            attr="style.chart.layout.highlighter.opacity"
                                            type="range"
                                            defaultVal="5"
                                            :min="0"
                                            :max="30"
                                    ...
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.line.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="padding"
                                        :level="4"
                                        title="style.chart.layout.padding"
                                    >
                                        <BaseAttr
                                            name="top"
                                            attr="style.chart.layout.padding.top"
                                            type="number"
                                            :min="0"
                                            :max="64"
                                            defaultVal="5"
                                        ...
                                        <BaseAttr
                                            name="right"
                                            attr="style.chart.layout.padding.right"
                                            type="number"
                                            :min="0"
                                            :max="64"
                                            defaultVal="10"
                                        ...
                                        <BaseAttr
                                            name="bottom"
                                            attr="style.chart.layout.padding.bottom"
                                            type="number"
                                            :min="0"
                                            :max="64"
                                            defaultVal="5"
                                        ...
                                        <BaseAttr
                                            name="left"
                                            attr="style.chart.layout.padding.left"
                                            type="number"
                                            :min="0"
                                            :max="64"
                                            defaultVal="10"
    ...
    <code>
        <span class="text-gray-400">&lt;script setup&gt;</span>
            ...
            onMounted(async () => {
                donutEvolutionDataset.value = await donutEvolutionChart.value.getData();
            });
    ...
    <code>
        ...
        <span class="text-gray-400">&lt;script&gt;</span>
            export default {
                ...
                async mounted () {
                    this.donutEvolutionDataset = await this.$refs.donutEvolutionChart.getData();
                }
            }
        <span class="text-gray-400">&lt;/script&gt;</span>
    </code>
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-donut-evolution.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
            ...
            <template #tab10>
                <DatetimeFormatterDoc
                    path="style.chart.layout.grid.xAxis.dataLabels.datetimeFormatter"
                />
            </template>
