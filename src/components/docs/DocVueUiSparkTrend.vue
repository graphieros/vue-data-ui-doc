...
<template>
    <div>
        <BaseDocTitle name="VueUiSparkTrend" />

        <BaseDocDescription
            :text="translations.docs.tooltips.trend[store.lang]"
        />
...
const <span class="text-black dark:text-app-green">dataset</span> = [1, 2, 3, 5, 8, -13, 21, 34];
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiSparkTrendConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiSparkTrendConfig"
                        equal
                    >
                        <span
                            >responsive: false;
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                <BaseDetails
                                    attr="colors"
                                    :level="3"
                                    title="style.arrow.colors"
                                >
                                    <BaseAttr
                                        name="positive"
                                        attr="style.arrow.colors.positive"
                                        type="color"
                                        defaultVal="#2CA02C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="neutral"
                                        attr="style.arrow.colors.neutral"
                                        type="color"
                                        defaultVal="#A1A1A1"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="negative"
                                        attr="style.arrow.colors.negative"
                                        type="color"
                                        defaultVal="#DC3912"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="useColorTrend"
                                    attr="style.dataLabel.useColorTrend"
                                    type="checkbox"
                                    defaultVal="true"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="strokeLinejoin"
                                    attr="style.line.strokeLinejoin"
                                    type="select"
                                    defaultVal="round"
                                    :options="[
                                        'round',
                            ...
                            <BaseDetails
                                attr="trendLabel"
                                :level="2"
                                title="style.trendLabel"
                            >
                                <BaseAttr
                                    name="trendType"
                                    attr="style.trendLabel.trendType"
                                    type="select"
                                    defaultVal="global"
                                    :options="['global', 'n-1', 'lastToFirst']"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseAttr
                                    name="useColorTrend"
                                    attr="style.trendLabel.useColorTrend"
                                    type="checkbox"
                                    defaultVal="true"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="fontSize"
                                    attr="style.trendLabel.fontSize"
                                    type="number"
                                    defaultVal="14"
                                    :min="8"
                                    :max="42"
                                ...
                                <BaseAttr
                                    name="rounding"
                                    attr="style.trendLabel.rounding"
                                    type="number"
                                    defaultVal="0"
                                    :min="0"
                                    :max="6"
