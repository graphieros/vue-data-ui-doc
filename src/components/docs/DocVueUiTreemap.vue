...
function randomizeData() {
    ...
    dataset.value[1].value = dataset.value[1].children
        .map((c) => c.value)
        .reduce((a, b) => a + b, 0);
    ...
    dataset.value[2].value = dataset.value[2].children
        .map((c) => c.value)
        .reduce((a, b) => a + b, 0);
}
...
<template>
    <div>
        <BaseDocTitle name="VueUiTreemap" />

        <BaseDocDescription
            :text="translations.docs.tooltips.treemap[store.lang]"
        />
        ...
        <BaseMigrationInfo debug padding />
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiTreemapConfig</code>
                </div>
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    <BaseAttr
                                        name="sorted"
                                        attr="style.chart.layout.sorted"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        <BaseAttr
                                            name="showDefaultLabels"
                                            attr="style.chart.layout.labels.showDefaultLabels"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.layout.labels.fontSize"
                                            type="number"
                                            defaultVal="24"
                                            :min="8"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="minFontSize"
                                            attr="style.chart.layout.labels.minFontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="100"
                                        ...
                                        />
                                        <BaseAttr
                                            name="hideUnderProportion"
                                            attr="style.chart.layout.labels.hideUnderProportion"
                                            type="number"
                                            defaultVal="0.03"
                                            :min="0.01"
                                            :max="0.2"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.layout.labels.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.layout.labels.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.layout.labels.rounding"
                                            type="number"
                                            :min="0"
                                            :max="6"
                                            :light="mutableConfig"
                                    ...
                                    <BaseDetails
                                        attr="rects"
                                        :level="4"
                                        title="style.chart.layout.rects"
                                    >
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.rects.stroke"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.rects.strokeWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="borderRadius"
                                            attr="style.chart.layout.rects.borderRadius"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="colorRatio"
                                            attr="style.chart.layout.rects.colorRatio"
                                            type="range"
                                            defaultVal="0.3"
                                            :min="0"
                                            :max="1"
                                        ...
                                        <BaseDetails
                                            attr="gradient"
                                            :level="5"
                                            title="style.chart.layout.rects.gradient"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.rects.gradient.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="intensity"
                                                attr="style.chart.layout.rects.gradient.intensity"
                                                type="range"
                                                defaultVal="30"
                                                :min="0"
                                                :max="100"
                                        ...
                                        <BaseDetails
                                            attr="selected"
                                            :level="5"
                                            title="style.chart.layout.rects.selected"
                                        >
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.layout.rects.selected.stroke"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.layout.rects.selected.strokeWidth"
                                                type="number"
                                                defaultVal="1"
                                                :min="0"
                                                :max="24"
                                            ...
                                            <BaseAttr
                                                ...
                                                attr="style.chart.layout.rects.selected.unselectedOpacity"
                                                type="range"
                                                defaultVal="0.6"
                                                :min="0"
                                                :max="1"
                                        ...
                                        <BaseDetails
                                            attr="group"
                                            :level="5"
                                            title="style.chart.layout.rects.group"
                                        >
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.layout.rects.group.stroke"
                                                type="color"
                                                defaultVal="#A1A1A1"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.layout.rects.group.strokeWidth"
                                                type="number"
                                                defaultVal="1"
                                                :min="0"
                                                :max="6"
                                            ...
                                            />
                                            <BaseAttr
                                                name="useSeriesBackgroundColor"
                                                attr="style.chart.layout.rects.group.useSeriesBackgroundColor"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            />
                                            <BaseAttr
                                                name="backgroundLighterRatio"
                                                attr="style.chart.layout.rects.group.backgroundLighterRatio"
                                                type="range"
                                                defaultVal="0.4"
                                                :min="0"
                                                :max="1"
                                            ...
                                            <BaseDetails
                                                attr="label"
                                                :level="6"
                                                title="styme.chart.layout.rects.group.label"
                                            >
                                                <BaseAttr
                                                    name="adaptColorToBackground"
                                                    attr="style.chart.layout.rects.group.label.adaptColorToBackground"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.chart.layout.rects.group.label.color"
                                                    type="color"
                                                    defaultVal="#2D353C"
                                                    :light="mutableConfig"
                                                    :dark="
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-treemap.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
