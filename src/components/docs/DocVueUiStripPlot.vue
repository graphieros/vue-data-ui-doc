...
<template>
    <div>
        ...
        <BaseDocDescription :text="translations.docs.tooltips.stripPlot[store.lang]" />
        ...
        <BaseDetails attr="style" :level="1">
            ...
            <BaseDetails attr="chart" :level="2" title="style.chart">
                ...
                <BaseDetails attr="tooltip" :level="3" title="style.chart.tooltip">
                    ...
                    <BaseAttr name="smoothSnapThreshold" attr="style.chart.tooltip.smoothSnapThreshold" type="number" defaultVal="0.25" :min="0.1" :max="0.24" :step="0.01" :light="mutableConfig" :dark="mutableConfigDarkMode"/>
                </BaseDetails> 
            </BaseDetails>
        </BaseDetails>
