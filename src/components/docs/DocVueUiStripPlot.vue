...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.stripPlot[store.lang]"
        />
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-strip-plot"
            />
        </div>
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiStripPlotConfig</code>
                </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <BaseDetails
                                        attr="bestPlotLabel"
                                        :level="4"
                                        title="style.chart.labels.bestPlotLabel"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.labels.bestPlotLabel.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="showValue"
                                            attr="style.chart.labels.bestPlotLabel.showValue"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.labels.bestPlotLabel.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.labels.bestPlotLabel.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.labels.bestPlotLabel.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.labels.bestPlotLabel.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                ...
                                >
                                    <BaseAttr
                                        name="opacity"
                                        attr="style.chart.plots.opacity"
                                        type="range"
                                        defaultVal="0.5"
                                        :min="0"
                                        :max="1"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-strip-plot.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
