...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.molecule[store.lang]"
        />
        ...
        <Box ref="box" showEmits showSlots showTooltip showCallbacks>
            <template #tab0>
                <div
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiMoleculeConfig</code>
                </div>
                    ...
                    <BaseDetails attr="const config: VueUiMoleculeConfig">
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="useChildColor"
                                        attr="style.chart.links.useChildColor"
                                        type="checkbox"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    />
                                ...
                                >
                                    <span
                                        ...
                                        /><input
                                            ...
                                            type="color"
                                            v-model="
                                                mutableConfig.style.chart.nodes
                                                    .stroke
                                            "
                                        />, (default: "#FFFFFF")</span
                                    >
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            >
                                <BaseAttr
                                    name="nodeName"
                                    attr="table.translations.nodeName"
                                    type="text"
                                    defaultVal="Node name"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseAttr
                                    name="details"
                                    attr="table.translations.details"
                                    type="text"
                                    defaultVal="Details"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="ancestor"
                                    attr="table.translations.ancestor"
                                    type="text"
                                    defaultVal="Parent node"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                            </BaseDetails>
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-molecule.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
