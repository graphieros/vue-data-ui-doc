...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.stackbar[store.lang]"
        />
  ...
  color?: string
    ...
    `"
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiSparkStackbarConfig</code>
                </div>
                    ...
                    >
                        ...
                        <BaseDetails attr="a11y" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="percentage"
                                    attr="a11y.translations.percentage"
                                    type="text"
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                <BaseDetails
                                    attr="gradient"
                                    :level="3"
                                    title="style.bar.gradient"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.bar.gradient.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="intensity"
                                        attr="style.bar.gradient.intensity"
                                        type="number"
                                        defaultVal="40"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.bar.gradient.underlayerColor"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="margin"
                                    attr="style.legend.margin"
                                    type="text"
                                    defaultVal="6px 0 0 0"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseDetails
                                    attr="name"
                                    :level="3"
                                    title="style.legend.name"
                                >
                                    <BaseAttr
                                        name="color"
                                        attr="style.legend.name.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="percentage"
                                    :level="3"
                                    title="style.legend.percentage"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.legend.percentage.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="bold"
                                        attr="style.legend.percentage.bold"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.legend.percentage.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="rounding"
                                        attr="style.legend.percentage.rounding"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                ...
                                <BaseDetails
                                    attr="value"
                                    :level="3"
                                    title="style.legend.value"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.legend.value.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="rounding"
                                        attr="style.legend.value.rounding"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        name="prefix"
                                        attr="style.legend.value.prefix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="suffix"
                                        attr="style.legend.value.suffix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                            ...
                            >
                                ...
                                <BaseAttr
                                    ...
                                    name="customFormat"
                                    defaultVal="null"
                                    comment="default behavior. To customize content, see 'custom tooltip' tab"
                                />
                                <BaseAttr
                                    name="borderRadius"
