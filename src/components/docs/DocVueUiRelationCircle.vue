...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.relationCircle[store.lang]"
        />
        ...
        >
            ...
            <template v-slot:tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiRelationCircleConfig</code>
                </div>
                    ...
                    >
                        ...
                        <BaseDetails attr="style">
                            ...
                            <BaseAttr
                                ...
                                @change="forceChartUpdate()"
                                :comment="
                                    translations.docs.comments.relationCircle
                                        .limit[store.lang]
                                "
                            />
                            <BaseDetails
                            ...
                            >
                                <BaseAttr
                                    ...
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                    comment="Animation visible when clicking a word"
                                />
                                <BaseAttr
                                    name="speedMs"
                            ...
                            >
                                <BaseAttr
                                    ...
                                    attr="style.circle.radiusProportion"
                                    type="range"
                                    defaultVal="0.2"
                                    :min="0.05"
                                    :max="0.4"
                            ...
                            <BaseDetails
                                attr="weightLabels"
                                :level="2"
                                title="style.weightLabels"
                            >
                                <BaseAttr
                                    name="show"
                                    attr="style.weightLabels.show"
                                    type="checkbox"
                                    defaultVal="true"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="prefix"
                                    attr="style.weightLabels.prefix"
                                    type="text"
                                    defaultVal="''"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="suffix"
                                    attr="style.weightLabels.suffix"
                                    type="text"
                                    defaultVal="''"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="rounding"
                                    attr="style.weightLabels.rounding"
                                    type="number"
                                    defaultVal="0"
                                    :min="0"
                                    :max="6"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-relation-circle.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
