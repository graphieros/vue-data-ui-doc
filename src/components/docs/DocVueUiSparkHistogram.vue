...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.histogram[store.lang]"
        />
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-sparkhistogram"
            />
        </div>
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiSparkHistogramConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiSparkHistogramConfig"
                        equal
                    >
                        <span
                            >responsive: false;
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="colors"
                                    :level="3"
                                    title="style.bars.colors"
                                >
                                    <BaseAttr
                                        name="positive"
                                        attr="style.bars.colors.positive"
                                        type="color"
                                        defaultVal="#5F8BEE"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="negative"
                                        attr="style.bars.colors.negative"
                                        type="color"
                                        defaultVal="#DC3912"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="gradient"
                                        :level="4"
                                        title="style.bars.colors.gradient"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.bars.colors.gradient.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                            ...
                            >
                                <BaseDetails
                                    attr="timeLabel"
                                    :level="3"
                                    title="style.labels.timeLabel"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.labels.timeLabel.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="fontSize"
                                        attr="style.labels.timeLabel.fontSize"
                                        type="number"
                                        defaultVal="12"
                                        :min="8"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="minFontSize"
                                        attr="style.labels.timeLabel.minFontSize"
                                        type="number"
                                        defaultVal="6"
                                        :min="6"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.labels.timeLabel.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="bold"
                                        attr="style.labels.timeLabel.bold"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="value"
                                    :level="3"
                                    title="style.labels.value"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.labels.value.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="fontSize"
                                        attr="style.labels.value.fontSize"
                                        type="number"
                                        defaultVal="14"
                                        :min="8"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="minFontSize"
                                        attr="style.labels.value.minFontSize"
                                        type="number"
                                        defaultVal="6"
                                        :min="6"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="rounding"
                                        attr="style.labels.value.rounding"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        name="prefix"
                                        attr="style.labels.value.prefix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="suffix"
                                        attr="style.labels.value.suffix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="offsetY"
                                        attr="style.labels.value.offsetY"
                                        type="number"
                                        defaultVal="0"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="valueLabel"
                                    :level="3"
                                    title="style.labels.valueLabel"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.labels.valueLabel.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="fontSize"
                                        attr="style.labels.valueLabel.fontSize"
                                        type="number"
                                        defaultVal="14"
                                        :min="8"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="minFontSize"
                                        attr="style.labels.valueLabel.minFontSize"
                                        type="number"
                                        defaultVal="6"
                                        :min="6"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.labels.valueLabel.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="bold"
                                        attr="style.labels.valueLabel.bold"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="rounding"
                                        attr="style.labels.valueLabel.rounding"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="strokeWidth"
                                    attr="style.selector.strokeWidth"
                                    type="number"
                                    defaultVal="2"
                                    :min="0"
                                    :max="12"
                                ...
                                <BaseAttr
                                    ...
                                    attr="style.selector.strokeDasharray"
                                    type="range"
                                    defaultVal="0"
                                    :min="0"
                                    :max="24"
                                ...
                                <BaseAttr
                                    name="borderRadius"
                                    attr="style.selector.borderRadius"
                                    type="range"
                                    defaultVal="0"
                                    :min="0"
                                    :max="24"
                                ...
                                <BaseAttr
                                    name="fill"
                                    attr="style.selector.fill"
                                    rgba
                                    type="color"
                                    defaultVal="#2D353C10"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                    comment="Recommended: use a transparent color"
                                />
                            </BaseDetails>
                            <BaseDetails
                                attr="title"
            ...
            <template #tab3>
                <BaseSlotDocumenter
                    ...
                    :types="['hint', 'source', 'chart-background']"
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-sparkhistogram.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
