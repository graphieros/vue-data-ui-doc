...
watch(
    ...
    (v) => {
        if (v) {
            Array.from(
                configCode.value.getElementsByTagName("details"),
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.dumbbell[store.lang]"
        />
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiDumbbellConfig</code>
                </div>
                    ...
                    <BaseDetails attr="const config: VueUiDumbbellConfig">
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.grid.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="1"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="scaleSteps"
                                        attr="style.chart.grid.scaleSteps"
                                        type="select"
                                        defaultVal="10"
                                        :options="[2, 5, 10, 20]"
                                        :light="mutableConfig"
                                    ...
                                    <BaseDetails
                                        attr="horizontalGrid"
                                        :level="4"
                                        title="style.chart.grid.horizontalGrid"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.grid.horizontalGrid.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.grid.horizontalGrid.stroke"
                                            type="color"
                                            defaultVal="#CCCCCC"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.grid.horizontalGrid.strokeWidth"
                                            type="range"
                                            defaultVal="0.5"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.grid.horizontalGrid.strokeDasharray"
                                            type="range"
                                            defaultVal="4"
                                            :min="0"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="verticalGrid"
                                        :level="4"
                                        title="style.chart.grid.verticalGrid"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.grid.verticalGrid.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.grid.verticalGrid.stroke"
                                            type="color"
                                            defaultVal="#CCCCCC"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.grid.verticalGrid.strokeWidth"
                                            type="range"
                                            defaultVal="0.5"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="strokeDasharray"
                                            attr="style.chart.grid.verticalGrid.strokeDasharray"
                                            type="range"
                                            defaultVal="4"
                                            :min="0"
                                            :max="100"
                                ...
                                <BaseDetails
                                    attr="comparisonLines"
                                    :level="3"
                                    title="style.chart.comparisonLines"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.comparisonLines.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.comparisonLines.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="strokeDasharray"
                                        attr="style.chart.comparisonLines.strokeDasharray"
                                        type="number"
                                        defaultVal="4"
                                        :min="0"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        name="showRect"
                                        attr="style.chart.comparisonLines.showRect"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="rectColor"
                                        attr="style.chart.comparisonLines.rectColor"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="rectOpacity"
                                        attr="style.chart.comparisonLines.rectOpacity"
                                        type="range"
                                        defaultVal="5"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="showLabel"
                                        attr="style.chart.comparisonLines.showLabel"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="labelColor"
                                        attr="style.chart.comparisonLines.labelColor"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="labelFontSize"
                                        attr="style.chart.comparisonLines.labelFontSize"
                                        type="number"
                                        defaultVal="12"
                                        :min="8"
                                        :max="42"
                                ...
                                <BaseDetails
                                    attr="labels"
                                    :level="3"
                                    title="style.chart.labels"
                                >
                                    <BaseAttr
                                        name="prefix"
                                        attr="style.chart.labels.prefix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="suffix"
                                        attr="style.chart.labels.suffix"
                                        type="text"
                                        defaultVal="''"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="axis"
                                        :level="4"
                                        title="style.chart.labels.axis"
                                    >
                                        <BaseAttr
                                            name="yLabel"
                                            attr="style.chart.labels.axis.yLabel"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="yLabelOffsetX"
                                            attr="style.chart.labels.axis.yLabelOffsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="xLabel"
                                            attr="style.chart.labels.axis.xLabel"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="xLabelOffsetY"
                                            attr="style.chart.labels.axis.xLabelOffsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.labels.axis.fontSize"
                                            type="number"
                                            defaultVal="12"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.labels.axis.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="endLabels"
                                        :level="4"
                                        title="style.chart.labels.endLabels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.labels.endLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.labels.endLabels.fontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.labels.endLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.labels.endLabels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.labels.endLabels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="useEndColor"
                                            attr="style.chart.labels.endLabels.useEndColor"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="useEvaluationColor"
                                            attr="style.chart.labels.endLabels.useEvaluationColor"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="startLabels"
                                        :level="4"
                                        title="style.chart.labels.startLabels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.labels.startLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.labels.startLabels.fontSize"
                                            type="number"
                                            defaultVal="10"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.labels.startLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.labels.startLabels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.labels.startLabels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="useStartColor"
                                            attr="style.chart.labels.startLabels.useStartColor"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="useEvaluationColor"
                                            attr="style.chart.labels.startLabels.useEvaluationColor"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="xAxisLabels"
                                        :level="4"
                                        title="style.chart.labels.xAxisLabels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.labels.xAxisLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.labels.xAxisLabels.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.labels.xAxisLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.labels.xAxisLabels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.labels.xAxisLabels.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.labels.xAxisLabels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="rotation"
                                            attr="style.chart.labels.xAxisLabels.rotation"
                                            type="number"
                                            defaultVal="0"
                                            :min="-90"
                                            :max="90"
                                        ...
                                        <BaseDetails
                                            attr="autoRotate"
                                            :level="5"
                                            title="style.chart.labels.xAxisLabels.autoRotate"
                                        >
                                            <BaseAttr
                                                name="enable"
                                                attr="style.chart.labels.xAxisLabels.autoRotate.enable"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="angle"
                                                attr="style.chart.labels.xAxisLabels.autoRotate.angle"
                                                type="number"
                                                defaultVal="-30"
                                                :min="-90"
                                                :max="90"
                                    ...
                                    <BaseDetails
                                        attr="yAxisLabels"
                                        :level="4"
                                        title="style.chart.labels.yAxisLabels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.labels.yAxisLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.labels.yAxisLabels.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.labels.yAxisLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.labels.yAxisLabels.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.labels.yAxisLabels.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.labels.yAxisLabels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.labels.yAxisLabels.showProgression"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="labelStart"
                                        attr="style.chart.legend.labelStart"
                                        type="text"
                                        defaultVal="start"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="labelEnd"
                                        attr="style.chart.legend.labelEnd"
                                        type="text"
                                        defaultVal="end"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="labelPositive"
                                        attr="style.chart.legend.labelPositive"
                                        type="text"
                                        defaultVal="positive"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="labelNegative"
                                        attr="style.chart.legend.labelNegative"
                                        type="text"
                                        defaultVal="negative"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="labelNeutral"
                                        attr="style.chart.legend.labelNeutral"
                                        type="text"
                                        defaultVal="neutral"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    <BaseAttr
                                        name="startColor"
                                        attr="style.chart.plots.startColor"
                                        type="color"
                                        defaultVal="#DC3912"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="endColor"
                                        attr="style.chart.plots.endColor"
                                        type="color"
                                        defaultVal="#5F8BEE"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="link"
                                        :level="4"
                                        title="style.chart.plots.link"
                                    >
                                        <BaseAttr
                                            name="type"
                                            attr="style.chart.plots.link.type"
                                            type="select"
                                            defaultVal="curved"
                                            :options="['curved', 'line']"
                                            :light="mutableConfig"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.plots.link.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="1"
                                            :max="12"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="For type line"
                                        />
                                    </BaseDetails>
                                    <BaseDetails
                                        attr="evaluationColors"
                                        :level="4"
                                        title="style.chart.plots.evaluationColors"
                                    >
                                        <BaseAttr
                                            name="enable"
                                            attr="style.chart.plots.evaluationColors.enable"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="positive"
                                            attr="style.chart.plots.evaluationColors.positive"
                                            type="color"
                                            defaultVal="#2ca02c"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="negative"
                                            attr="style.chart.plots.evaluationColors.negative"
                                            type="color"
                                            defaultVal="#d62728"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="neutral"
                                            attr="style.chart.plots.evaluationColors.neutral"
                                            type="color"
                                            defaultVal="#c7c7c7"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="start"
                                    attr="table.columnNames.start"
                                    type="text"
                                    defaultVal="Start value"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                    @change="forceChartUpdate()"
                                />
                                <BaseAttr
                                    name="end"
                                    attr="table.columnNames.end"
                                    type="text"
                                    defaultVal="End value"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                    @change="forceChartUpdate()"
                                />
                                <BaseAttr
                                    name="progression"
                                    attr="table.columnNames.progression"
                                    type="text"
                                    defaultVal="Progression"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                    @change="forceChartUpdate()"
                                />
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-dumbbell.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
