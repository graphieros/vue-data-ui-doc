...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.galaxy[store.lang]"
        />
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiGalaxyConfig</code>
                </div>
                            ...
                            >
                                ...
                                >
                                    <BaseDetails
                                        attr="arcs"
                                        :level="4"
                                        title="style.chart.layout.arcs"
                                    >
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.arcs.strokeWidth"
                                            type="number"
                                            defaultVal="24"
                                            :min="1"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="borderWidth"
                                            attr="style.chart.layout.arcs.borderWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="0"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.layout.arcs.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.layout.arcs.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseDetails
                                            attr="gradient"
                                            :level="5"
                                            title="style.chart.layout.arcs.gradient"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.arcs.gradient.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="intensity"
                                                attr="style.chart.layout.arcs.gradient.intensity"
                                                type="range"
                                                defaultVal="30"
                                                :min="20"
                                                :max="50"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.arcs.gradient.color"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="hoverEffect"
                                            :level="5"
                                            title="style.chart.layout.arcs.hoverEffect"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.arcs.hoverEffect.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="multiplicator"
                                                attr="style.chart.layout.arcs.hoverEffect.multiplicator"
                                                type="number"
                                                defaultVal="1.1"
                                                :min="0.5"
                                                :max="1.4"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-galaxy.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
