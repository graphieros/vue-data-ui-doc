...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.wheel[store.lang]"
        />
        ...
        >
            <template #tab0>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-green">VueUiWheelDataset</code>
                </div>
                <div
...
const <span class="text-black dark:text-app-green">dataset: VueUiWheelDataset</span> = {
    percentage: 66.5
                            ...
                            >
                                ...
                                >
                                    <BaseDetails
                                        attr="innerCircle"
                                        :level="4"
                                        title="style.chart.layout.innerCircle"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.innerCircle.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.innerCircle.stroke"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.innerCircle.strokeWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="radiusRatio"
                                            attr="style.chart.layout.innerCircle.radiusRatio"
                                            type="number"
                                            :min="0.2"
                                            :max="2"
                                            :step="0.1"
                                    ...
                                    <BaseDetails
                                        attr="percentage"
                                        :level="4"
                                        title="style.chart.layout.percentage"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.percentage.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.layout.percentage.fontSize"
                                            type="number"
                                            defaultVal="48"
                                            :min="8"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.layout.percentage.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.layout.percentage.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.layout.percentage.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.layout.percentage.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.percentage.stroke"
                                            type="color"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.percentage.strokeWidth"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="24"
                                    ...
                                    <BaseDetails
                                        attr="wheel"
                                        :level="4"
                                        title="style.chart.layout.wheel"
                                    >
                                        <BaseAttr
                                            name="radiusRatio"
                                            attr="style.chart.layout.wheel.radiusRatio"
                                            type="number"
                                            :min="0.3"
                                            :max="1"
                                            :step="0.01"
                                        ...
                                        <BaseAttr
                                            name="tiltAngle3d"
                                            attr="style.chart.layout.wheel.tiltAngle3d"
                                            type="range"
                                            :min="10"
                                            :max="80"
                                            comment="since v3.2.1"
                                        ...
                                        <BaseDetails
                                            attr="ticks"
                                            :level="5"
                                            title="style.chart.layout.wheel.ticks"
                                        >
                                            <BaseAttr
                                                name="type"
                                                attr="style.chart.layout.wheel.ticks.type"
                                                type="select"
                                                defaultVal="classic"
                                                :options="['classic', 'arc']"
                                                :light="mutableConfig"
                                            ...
                                            <BaseAttr
                                                name="rounded"
                                                attr="style.chart.layout.wheel.ticks.rounded"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="inactiveColor"
                                                attr="style.chart.layout.wheel.ticks.inactiveColor"
                                                type="color"
                                                defaultVal="#E1E5E8"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="activeColor"
                                                attr="style.chart.layout.wheel.ticks.activeColor"
                                                type="color"
                                                defaultVal="#5F8BEE"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="sizeRatio"
                                                attr="style.chart.layout.wheel.ticks.sizeRatio"
                                                type="range"
                                                defaultVal="0.9"
                                                :min="0"
                                                :max="1"
                                            ...
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.layout.wheel.ticks.stroke"
                                                type="color"
                                                defaultVal="transparent"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.layout.wheel.ticks.strokeWidth"
                                                type="number"
                                                defaultVal="5"
                                                :min="0"
                                                :max="12"
                                            ...
                                            <BaseAttr
                                                name="depth3d"
                                                attr="style.chart.layout.wheel.ticks.depth3d"
                                                type="number"
                                                defaultVal="0"
                                                :min="0"
                                                :max="40"
                                            ...
                                            <BaseAttr
                                                name="spacingRatio3d"
                                                attr="style.chart.layout.wheel.ticks.spacingRatio3d"
                                                type="range"
                                                :min="0"
                                                :max="1"
                                                :step="0.01"
                                            ...
                                            />
                                            <BaseAttr
                                                name="shadeColorRatio3d"
                                                attr="style.chart.layout.wheel.ticks.shadeColorRatio3d"
                                                type="range"
                                                :min="0"
                                                :max="1"
                                                :step="0.01"
                                            ...
                                            <BaseDetails
                                                attr="gradient"
                                                :level="6"
                                                title="style.chart.layout.wheel.ticks.gradient"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.wheel.ticks.gradient.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    ...
                                                    attr="style.chart.layout.wheel.ticks.gradient.shiftHueIntensity"
                                                    type="range"
                                                    defaultVal="100"
                                                    :min="0"
                                                    :max="100"
            ...
            <template #tab2>
                <ComponentEmits component="VueUiWheel" :names="['copyAlt']" />
                <ExposedMethods
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-wheel.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
