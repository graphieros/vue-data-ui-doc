...
const slotOptions = ref(["justLabels", "chart", "icon"]);
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.donut[store.lang]"
        />
        ...
        <BaseMigrationInfo cssAnimation debug />
                ...
                <code ref="configCode">
                    <BaseDetails attr="const config: VueUiDonutConfig" equal>
                        ...
                        <BaseDetails attr="serieToggleAnimation" :level="1">
                            <BaseAttr
                                name="show"
                                attr="serieToggleAnimation.show"
                                type="checkbox"
                                defaultVal="true"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            ...
                            <BaseAttr
                                name="durationMs"
                                attr="serieToggleAnimation.durationMs"
                                type="number"
                                defaultVal="500"
                                :min="0"
                                :max="2000"
                        ...
                        <BaseDetails attr="startAnimation" :level="1">
                            ...
                            <BaseAttr
                                name="durationMs"
                                attr="startAnimation.durationMs"
                                type="number"
                                defaultVal="1000"
                                :min="0"
                                :max="5000"
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                <BaseAttr
                                    ...
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                    comment="Ignored when responsive is true"
                                />
                                <BaseAttr
                                    name="height"
                                ...
                                <BaseAttr
                                    ...
                                    :min="0"
                                    :max="100"
                                    attr="style.chart.gradientIntensity"
                                    defaultVal="40"
                                />
                                <BaseAttr
                                ...
                                >
                                    <BaseAttr
                                        ...
                                        :dark="mutableConfigDarkMode"
                                        type="checkbox"
                                        attr="style.chart.comments.show"
                                        defaultVal="true"
                                    />
                                    <BaseAttr
                                        name="showInTooltip"
                                        ...
                                        :dark="mutableConfigDarkMode"
                                        type="checkbox"
                                        attr="style.chart.comments.showInTooltip"
                                        defaultVal="true"
                                    />
                                    <BaseAttr
                                        name="width"
                                        ...
                                        :dark="mutableConfigDarkMode"
                                        type="number"
                                        attr="style.chart.comments.width"
                                        :min="50"
                                        :max="400"
                                        :step="10"
                                        defaultVal="100"
                                    ...
                                    <BaseAttr
                                        ...
                                        :dark="mutableConfigDarkMode"
                                        type="number"
                                        attr="style.chart.comments.offsetX"
                                        :min="-50"
                                        :max="50"
                                        defaultVal="0"
                                    />
                                    <BaseAttr
                                        ...
                                        :dark="mutableConfigDarkMode"
                                        type="number"
                                        attr="style.chart.comments.offsetY"
                                        :min="-50"
                                        :max="50"
                                        defaultVal="0"
                                    />
                                ...
                                >
                                    <BaseAttr
                                        name="curvedMarkers"
                                        attr="style.chart.layout.curvedMarkers"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="donut"
                                        :level="4"
                                        title="style.chart.layout.donut"
                                    >
                                        <BaseAttr
                                            name="radiusRatio"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            type="number"
                                            attr="style.chart.layout.donut.radiusRatio"
                                            :min="0.1"
                                            :max="0.5"
                                            :step="0.01"
                                            defaultVal="0.3"
                                        ...
                                        <BaseAttr
                                            ...
                                            :dark="mutableConfigDarkMode"
                                            type="number"
                                            attr="style.chart.layout.donut.strokeWidth"
                                            :min="6"
                                            :max="100"
                                            defaultVal="55"
                                        />
                                        <BaseAttr
                                            ...
                                            :dark="mutableConfigDarkMode"
                                            type="number"
                                            attr="style.chart.layout.donut.borderWidth"
                                            :min="0"
                                            :max="12"
                                            defaultVal="2"
                                        />
                                        <BaseAttr
                                            ...
                                            :dark="mutableConfigDarkMode"
                                            type="checkbox"
                                            attr="style.chart.layout.donut.useShadow"
                                            defaultVal="false"
                                        />
                                        <BaseAttr
                                            name="shadowColor"
                                            ...
                                            :dark="mutableConfigDarkMode"
                                            type="color"
                                            attr="style.chart.layout.donut.shadowColor"
                                            defaultVal="#2D353C"
                                        />
                                        <BaseAttr
                                            name="emptyFill"
                                            ...
                                            :dark="mutableConfigDarkMode"
                                            type="color"
                                            attr="style.chart.layout.donut.emptyFill"
                                            defaultVal="#E1E5E8"
                                        />
                                        <BaseAttr
                                            name="selectedColor"
                                            ...
                                            :dark="mutableConfigDarkMode"
                                            type="color"
                                            attr="style.chart.layout.donut.selectedColor"
                                            defaultVal="#0000001A"
                                            comment="It is recommended to keep it very transparent"
                                        />
                                        <BaseAttr
                                            name="borderColorAuto"
                                            attr="style.chart.layout.donut.borderColorAuto"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            type="checkbox"
                                            defaultVal="true"
                                        ...
                                        <BaseAttr
                                            name="borderColor"
                                            attr="style.chart.layout.donut.borderColor"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            defaultVal="#CCCCCC"
                                            type="color"
                                    ...
                                    >
                                        <BaseDetails
                                            attr="dataLabels"
                                            :level="5"
                                            title="style.chart.layout.labels.dataLabels"
                                        >
                                            <BaseAttr
                                                name="show"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="checkbox"
                                                attr="style.chart.layout.labels.dataLabels.show"
                                                defaultVal="true"
                                                @change="forceChartUpdate()"
                                            />
                                            <BaseAttr
                                                ...
                                                name="useLabelSlots"
                                                defaultVal="false"
                                                comment="Check out the slots tab for information on how to use custom data labels"
                                            />
                                            <BaseAttr
                                                name="hideUnderValue"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="number"
                                                attr="style.chart.layout.labels.dataLabels.hideUnderValue"
                                                :min="0"
                                                :max="10"
                                                defaultVal="3"
                                                :comment="
                                                    translations.docs.comments
                                                        .donut.hideUnderValue[
                                                        store.lang
                                                    ]
                                                "
                                            />
                                            <BaseAttr
                                                ...
                                                :dark="mutableConfigDarkMode"
                                                type="text"
                                                attr="style.chart.layout.labels.dataLabels.prefix"
                                                defaultVal="''"
                                            />
                                            <BaseAttr
                                                name="suffix"
                                                ...
                                                :dark="mutableConfigDarkMode"
                                                type="text"
                                                attr="style.chart.layout.labels.dataLabels.suffix"
                                                defaultVal="''"
                                            />
                                            <BaseAttr
                                                name="smallArcClusterThreshold"
                                                attr="style.chart.layout.labels.dataLabels.smallArcClusterThreshold"
                                                type="number"
                                                :min="0"
                                                :max="100"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                defaultVal="8"
                                                comment="Show labels on the side for arcs under this percentage"
                                            />
                                            <BaseAttr
                                                name="smallArcClusterFontSize"
                                                attr="style.chart.layout.labels.dataLabels.smallArcClusterFontSize"
                                                type="number"
                                                defaultVal="12"
                                                :min="6"
                                                :max="20"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                comment="Font size for labels of small arcs"
                                            />
                                            <BaseAttr
                                                name="oneLine"
                                                attr="style.chart.layout.labels.dataLabels.oneLine"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="showValueFirst"
                                                attr="style.chart.layout.labels.dataLabels.showValueFirst"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            />
                                            <BaseAttr
                                                name="usePercentageParens"
                                                attr="style.chart.layout.labels.dataLabels.usePercentageParens"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="useValueParens"
                                                attr="style.chart.layout.labels.dataLabels.useValueParens"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="value"
                                            :level="5"
                                            title="style.chart.layout.labels.value"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.labels.value.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="rounding"
                                                attr="style.chart.layout.labels.value.rounding"
                                                type="number"
                                                :min="0"
                                                :max="6"
                                                :light="mutableConfig"
                                        ...
                                        <BaseDetails
                                            attr="percentage"
                                            :level="5"
                                            title="style.chart.layout.labels.percentage"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.labels.percentage.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.labels.percentage.color"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="color"
                                                defaultVal="#2D353C"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.layout.labels.percentage.bold"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="checkbox"
                                                defaultVal="true"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.layout.labels.percentage.fontSize"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="number"
                                                :min="8"
                                            ...
                                            <BaseAttr
                                                name="minFontSize"
                                                attr="style.chart.layout.labels.percentage.minFontSize"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="number"
                                                :min="4"
                                            ...
                                            <BaseAttr
                                                name="rounding"
                                                attr="style.chart.layout.labels.percentage.rounding"
                                                type="number"
                                                :min="0"
                                                :max="6"
                                                :light="mutableConfig"
                                        ...
                                        <BaseDetails
                                            attr="name"
                                            :level="5"
                                            title="style.chart.layout.labels.name"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.labels.name.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.labels.name.color"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="color"
                                                defaultVal="#2D353C"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.layout.labels.name.bold"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="checkbox"
                                                defaultVal="false"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.layout.labels.name.fontSize"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="number"
                                                :min="8"
                                            ...
                                            <BaseAttr
                                                name="minFontSize"
                                                attr="style.chart.layout.labels.name.minFontSize"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="number"
                                                :min="4"
                                        ...
                                        <BaseDetails
                                            attr="hollow"
                                            :level="5"
                                            title="style.chart.layout.labels.hollow"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.labels.hollow.show"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                                type="checkbox"
                                                defaultVal="true"
                                            ...
                                            <BaseDetails
                                                attr="average"
                                                :level="6"
                                                title="style.chart.layout.labels.hollow.average"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.labels.hollow.average.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="bold"
                                                    attr="style.chart.layout.labels.hollow.average.bold"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="fontSize"
                                                    attr="style.chart.layout.labels.hollow.average.fontSize"
                                                    type="number"
                                                    defaultVal="18"
                                                    :min="8"
                                                    :max="42"
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.chart.layout.labels.hollow.average.color"
                                                    type="color"
                                                    defaultVal="#AAAAAA"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="text"
                                                    attr="style.chart.layout.labels.hollow.average.text"
                                                    type="text"
                                                    defaultVal="Average"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="offsetY"
                                                    attr="style.chart.layout.labels.hollow.average.offsetY"
                                                    type="number"
                                                    defaultVal="0"
                                                    :min="-50"
                                                    :max="50"
                                                ...
                                                <BaseDetails
                                                    attr="value"
                                                    :level="7"
                                                    title="style.chart.layout.labels.hollow.average.value"
                                                >
                                                    <BaseAttr
                                                        name="bold"
                                                        attr="style.chart.layout.labels.hollow.average.value.bold"
                                                        type="checkbox"
                                                        defaultVal="true"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="fontSize"
                                                        attr="style.chart.layout.labels.hollow.average.value.fontSize"
                                                        type="number"
                                                        defaultVal="18"
                                                        :min="8"
                                                        :max="42"
                                                    ...
                                                    <BaseAttr
                                                        name="color"
                                                        attr="style.chart.layout.labels.hollow.average.value.color"
                                                        type="color"
                                                        defaultVal="#AAAAAA"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="offsetY"
                                                        attr="style.chart.layout.labels.hollow.average.value.offsetY"
                                                        type="number"
                                                        defaultVal="0"
                                                        :min="-50"
                                                        :max="50"
                                                    ...
                                                    <BaseAttr
                                                        name="rounding"
                                                        attr="style.chart.layout.labels.hollow.average.value.rounding"
                                                        type="number"
                                                        defaultVal="0"
                                                        :min="0"
                                                        :max="6"
                                                    ...
                                                    <BaseAttr
                                                        name="prefix"
                                                        attr="style.chart.layout.labels.hollow.average.value.prefix"
                                                        type="text"
                                                        defaultVal="''"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="suffix"
                                                        attr="style.chart.layout.labels.hollow.average.value.suffix"
                                                        type="text"
                                                        defaultVal="''"
                                                        :light="mutableConfig"
                                                        :dark="
                                            ...
                                            <BaseDetails
                                                attr="total"
                                                :level="6"
                                                title="style.chart.layout.labels.hollow.total"
                                            >
                                                <BaseAttr
                                                    name="show"
                                                    attr="style.chart.layout.labels.hollow.total.show"
                                                    type="checkbox"
                                                    defaultVal="true"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="bold"
                                                    attr="style.chart.layout.labels.hollow.total.bold"
                                                    type="checkbox"
                                                    defaultVal="false"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="fontSize"
                                                    attr="style.chart.layout.labels.hollow.total.fontSize"
                                                    type="number"
                                                    defaultVal="18"
                                                    :min="8"
                                                    :max="42"
                                                ...
                                                <BaseAttr
                                                    name="color"
                                                    attr="style.chart.layout.labels.hollow.total.color"
                                                    type="color"
                                                    defaultVal="#AAAAAA"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="text"
                                                    attr="style.chart.layout.labels.hollow.total.text"
                                                    type="text"
                                                    defaultVal="Total"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="offsetY"
                                                    attr="style.chart.layout.labels.hollow.total.offsetY"
                                                    type="number"
                                                    defaultVal="0"
                                                    :min="-50"
                                                    :max="50"
                                                ...
                                                <BaseDetails
                                                    attr="value"
                                                    :level="7"
                                                    title="style.chart.layout.labels.hollow.total.value"
                                                >
                                                    <BaseAttr
                                                        name="bold"
                                                        attr="style.chart.layout.labels.hollow.total.value.bold"
                                                        type="checkbox"
                                                        defaultVal="true"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="fontSize"
                                                        attr="style.chart.layout.labels.hollow.total.value.fontSize"
                                                        type="number"
                                                        defaultVal="18"
                                                        :min="8"
                                                        :max="42"
                                                    ...
                                                    <BaseAttr
                                                        name="color"
                                                        attr="style.chart.layout.labels.hollow.total.value.color"
                                                        type="color"
                                                        defaultVal="#AAAAAA"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="offsetY"
                                                        attr="style.chart.layout.labels.hollow.total.value.offsetY"
                                                        type="number"
                                                        defaultVal="0"
                                                        :min="-50"
                                                        :max="50"
                                                    ...
                                                    <BaseAttr
                                                        name="rounding"
                                                        attr="style.chart.layout.labels.hollow.total.value.rounding"
                                                        type="number"
                                                        defaultVal="0"
                                                        :min="0"
                                                        :max="6"
                                                    ...
                                                    <BaseAttr
                                                        name="prefix"
                                                        attr="style.chart.layout.labels.hollow.total.value.prefix"
                                                        type="text"
                                                        defaultVal="''"
                                                        :light="mutableConfig"
                                                        :dark="
                                                    ...
                                                    <BaseAttr
                                                        name="suffix"
                                                        attr="style.chart.layout.labels.hollow.total.value.suffix"
                                                        type="text"
                                                        defaultVal="''"
                                                        :light="mutableConfig"
                                                        :dark="
                                ...
                                >
                                    <BaseAttr
                                        name="showValueFirst"
                                        attr="style.chart.legend.showValueFirst"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="usePercentageParens"
                                        attr="style.chart.legend.usePercentageParens"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="useValueParens"
                                        attr="style.chart.legend.useValueParens"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="roundingValue"
                                        attr="style.chart.legend.roundingValue"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.legend.roundingPercentage"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseAttr
                                        name="showPercentage"
                                        attr="style.chart.legend.showPercentage"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="showValueFirst"
                                        attr="style.chart.tooltip.showValueFirst"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="usePercentageParens"
                                        attr="style.chart.tooltip.usePercentageParens"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="useValueParens"
                                        attr="style.chart.tooltip.useValueParens"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="percentage"
                                    attr="table.columnNames.percentage"
                                    type="text"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-donut.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
