...
const freestyleTemplate =
    ref(`<VueUiStackbar :config="config" :dataset="dataset">
    <template #svg="{ svg }">
...
<template>
    <div>
        <BaseDocTitle name="VueUiStackbar" />

        <BaseDocDescription
            :text="translations.docs.tooltips.stackbarBig[store.lang]"
        />
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-stackbar"
            />
        </div>
        ...
        >
            ...
            <code class="mt-4 flex flex-row place-items-center gap-4">
                <BaseAttr
                    name="distributed"
                    attr="style.chart.bars.distributed"
                    type="checkbox"
                    defaultVal="false"
                    :light="mutableConfig"
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiStackbarConfig</code>
                </div>
                        ...
                        <BaseDetails attr="a11y" :level="1">
                            ...
                            >
                                <BaseAttr
                                    ...
                                    type="text"
                                    defaultVal="'Use the left and right, or up and down arrow keys to move between datapoints'"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                                <BaseAttr
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="bars"
                                    :level="3"
                                    title="style.chart.bars"
                                >
                                    <BaseAttr
                                        name="gapRatio"
                                        attr="style.chart.bars.gapRatio"
                                        type="range"
                                        defaultVal="0.5"
                                        :min="0"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.bars.showDistributedPercentage"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="borderRadius"
                                        attr="style.chart.bars.borderRadius"
                                        type="range"
                                        defaultVal="0"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.bars.strokeWidth"
                                        type="range"
                                        defaultVal="1"
                                        :min="0"
                                        :max="6"
                                    ...
                                    <BaseDetails
                                        attr="gradient"
                                        :level="4"
                                        title="style.chart.bars.gradient"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.bars.gradient.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="intensity"
                                            attr="style.chart.bars.gradient.intensity"
                                            type="range"
                                            defaultVal="20"
                                            :min="0"
                                            :max="100"
                                    ...
                                    <BaseDetails
                                        attr="totalValues"
                                        :level="4"
                                        title="style.chart.bars.totalValues"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.bars.totalValues.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.bars.totalValues.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.bars.totalValues.fontSize"
                                            type="number"
                                            defaultVal="16"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.bars.totalValues.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.bars.totalValues.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="dataLabels"
                                        :level="4"
                                        title="style.chart.bars.dataLabels"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.bars.dataLabels.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.bars.dataLabels.hideEmptyValues"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.bars.dataLabels.hideEmptyPercentages"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        />
                                        <BaseAttr
                                            name="adaptColorToBackground"
                                            attr="style.chart.bars.dataLabels.adaptColorToBackground"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.bars.dataLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.bars.dataLabels.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.bars.dataLabels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.bars.dataLabels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.bars.dataLabels.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.bars.dataLabels.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
