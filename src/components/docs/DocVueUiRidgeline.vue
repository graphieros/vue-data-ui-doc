            ...
            datapoints: c.datapoints.map((d) => {
                return {
                    ...
                    color: shiftHue({
                        ...
                        force: (isDarkMode.value ? -0.01 : -0.005) * i,
                    }),
                };
            }),
        };
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.ridgeline[store.lang]"
        />
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-ridgeline"
            />
        </div>

        <Rater itemId="vue_ui_ridgeline" class="mt-12" />

        <BaseMigrationInfo autoRotate cssAnimation debug />
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="my-4">
                    TS type:
                    <code class="text-app-blue">VueUiRidgelineConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiRidgelineConfig"
                        equal
                    >
                        <span
                            >responsive: false,
                            <span
                                class="text-gray-600 dark:text-app-blue text-xs"
                                >//
                        ...
                        />
                        theme: "", ("dark" | "celebration" | "celebrationNight"
                        | "zen" | "hack" | "concrete" | "")<br />
                        <span
                            >customPalette: [],
                            <span class="text-xs text-app-blue"
                                >// string[]</span
                            ></span
                        >
                        <BaseAttr
                            ...
                            >
                                ...
                                >
                                    ...
                                    <BaseDetails
                                        attr="xyChart"
                                        :level="4"
                                        title="style.chart.dialog.xyChart"
                                    >
                                        <BaseComment class="hover:underline">
                                            <RouterLink to="/docs#vue-ui-xy">{{
                                ...
                                <BaseDetails
                                    attr="areas"
                                    :level="3"
                                    title="style.chart.areas"
                                >
                                    <BaseAttr
                                        name="height"
                                        attr="style.chart.areas.height"
                                        type="number"
                                        defaultVal="60"
                                        :min="30"
                                        :max="150"
                                    ...
                                    <BaseAttr
                                        name="rowHeight"
                                        attr="style.chart.areas.rowHeight"
                                        type="number"
                                        defaultVal="30"
                                        :min="10"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.areas.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseDetails
                                        attr="stroke"
                                        :level="4"
                                        title="style.chart.areas.stroke"
                                    >
                                        <BaseAttr
                                            name="useSerieColor"
                                            attr="style.chart.areas.stroke.useSerieColor"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.areas.stroke.color"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="opacity"
                                        attr="style.chart.areas.opacity"
                                        type="range"
                                        defaultVal="0.9"
                                        :min="0"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        name="useCommonColor"
                                        attr="style.chart.areas.useCommonColor"
                                        type="checkbox"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    />
                                    <BaseAttr
                                        name="useGradient"
                                        attr="style.chart.areas.useGradient"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="maxPoint"
                                        :level="4"
                                        title="style.chart.areas.maxPoint"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.areas.maxPoint.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="adaptStrokeToBackground"
                                            attr="style.chart.areas.maxPoint.adaptStrokeToBackground"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.areas.maxPoint.stroke"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.areas.maxPoint.strokeWidth"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.areas.maxPoint.strokeDasharray"
                                            type="number"
                                            defaultVal="4"
                                            :min="0"
                                            :max="12"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.selector.stroke"
                                        type="color"
                                        defaultVal="#CCCCCC"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.selector.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="strokeDasharray"
                                        attr="style.chart.selector.strokeDasharray"
                                        type="number"
                                        defaultVal="2"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseDetails
                                        attr="labels"
                                        :level="4"
                                        title="style.chart.selector.labels"
                                    >
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.selector.labels.fontSize"
                                            type="number"
                                            defaultVal="12"
                                            :min="8"
                                            :max="48"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.selector.labels.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.selector.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="dot"
                                        :level="4"
                                        title="style.chart.selector.dot"
                                    >
                                        <BaseAttr
                                            name="radius"
                                            attr="style.chart.selector.dot.radius"
                                            type="number"
                                            defaultVal="4"
                                            :min="0"
                                            :max="12"
                                        ...
                                        />
                                        <BaseAttr
                                            name="useDatapointColor"
                                            attr="style.chart.selector.dot.useDatapointColor"
                                            type="checkbox"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseAttr
                                            name="fill"
                                            attr="style.chart.selector.dot.fill"
                                            type="color"
                                            defaultVal="#CCCCCC"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.selector.dot.stroke"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.selector.dot.strokeWidth"
                                            type="number"
                                            defaultVal="0.5"
                                            :min="0"
                                            :max="12"
                                ...
                                <BaseDetails
                                    attr="zeroLine"
                                    :level="3"
                                    title="style.chart.zeroLine"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.zeroLine.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.zeroLine.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="strokeDasharray"
                                        attr="style.chart.zeroLine.strokeDasharray"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="useSerieColor"
                                        attr="style.chart.zeroLine.useSerieColor"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.zeroLine.stroke"
                                        type="color"
                                        defaultVal="#CCCCCC"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="xAxis"
                                    :level="3"
                                    title="style.chart.xAxis"
                                >
                                    <BaseDetails
                                        attr="labels"
                                        :level="4"
                                        title="style.chart.xAxis.labels"
                                    >
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.xAxis.labels.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.xAxis.labels.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rotation"
                                            attr="style.chart.xAxis.labels.rotation"
                                            type="range"
                                            defaultVal="0"
                                            :min="-90"
                                            :max="90"
                                        ...
                                        <BaseDetails
                                            attr="autoRotate"
                                            :level="5"
                                            title="style.chart.xAxis.labels.autoRotate"
                                        >
                                            <BaseAttr
                                                name="enable"
                                                attr="style.chart.xAxis.labels.autoRotate.enable"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="angle"
                                                attr="style.chart.xAxis.labels.autoRotate.angle"
                                                type="number"
                                                defaultVal="-30"
                                                :min="-90"
                                                :max="90"
                                        ...
                                        <BaseDetails
                                            ...
                                            :level="5"
                                            title="style.chart.xAxis.labels.datetimeFormatter"
                                        >
                                            <BaseAttr
                                                name="enable"
                                                attr="style.chart.xAxis.labels.datetimeFormatter.enable"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="locale"
                                                attr="style.chart.xAxis.labels.datetimeFormatter.locale"
                                                type="select"
                                                defaultVal="en"
                                            ...
                                            <BaseAttr
                                                name="useUTC"
                                                attr="style.chart.xAxis.labels.datetimeFormatter.useUTC"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="januaryAsYear"
                                                attr="style.chart.xAxis.labels.datetimeFormatter.januaryAsYear"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                attr="options"
                                                :level="6"
                                                title="style.chart.xAxis.labels.datetimeFormatter.options"
                                            >
                                                <BaseAttr
                                                    name="year"
                                                    attr="style.chart.xAxis.labels.datetimeFormatter.options.year"
                                                    type="text"
                                                    defaultVal="yyyy"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="month"
                                                    attr="style.chart.xAxis.labels.datetimeFormatter.options.month"
                                                    type="text"
                                                    :defaultVal="`MMM 'yy`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="day"
                                                    attr="style.chart.xAxis.labels.datetimeFormatter.options.day"
                                                    type="text"
                                                    :defaultVal="`dd MMM`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="minute"
                                                    attr="style.chart.xAxis.labels.datetimeFormatter.options.minute"
                                                    type="text"
                                                    :defaultVal="`HH:mm:ss`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="second"
                                                    attr="style.chart.xAxis.labels.datetimeFormatter.options.second"
                                                    type="text"
                                                    :defaultVal="`HH:mm:ss`"
                                                    :light="mutableConfig"
                                                    :dark="
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.xAxis.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.xAxis.labels.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="48"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.xAxis.labels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.xAxis.labels.showOnlyAtModulo"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="modulo"
                                            attr="style.chart.xAxis.labels.modulo"
                                            type="number"
                                            defaultVal="12"
                                            :min="2"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.xAxis.labels.showOnlyFirstAndLast"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.xAxis.labels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                ...
                                <BaseDetails
                                    attr="yAxis"
                                    :level="3"
                                    title="style.chart.yAxis"
                                >
                                    <BaseDetails
                                        attr="labels"
                                        :level="4"
                                        title="style.chart.yAxis.labels"
                                    >
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.yAxis.labels.fontSize"
                                            type="number"
                                            defaultVal="16"
                                            :min="8"
                                            :max="48"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.yAxis.labels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.yAxis.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.yAxis.labels.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
