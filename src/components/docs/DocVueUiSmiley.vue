...
<template>
    <div>
        <h1 class="text-center font-satoshi-bold text-app-blue mb-12 text-2xl">VueUiSmiley</h1>
...
const <span class="text-black dark:text-app-blue">config</span> = {
    ...
    style: {
        ...
        icons: {
            filled: <input v-if="isDarkMode" type="checkbox" class="accent-app-blue" v-model="mutableConfigDarkMode.style.icons.filled"><input v-else type="checkbox" class="accent-app-blue" v-model="mutableConfig.style.icons.filled">, (default: false)
            useGradient: <input v-if="isDarkMode" type="checkbox" class="accent-app-blue" v-model="mutableConfigDarkMode.style.icons.useGradient"><input v-else type="checkbox" class="accent-app-blue" v-model="mutableConfig.style.icons.useGradient">, (default: true)
        },
        title: {
