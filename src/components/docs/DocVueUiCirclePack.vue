...
<template>
    ...
    <BaseDocDescription
        :text="translations.docs.tooltips.circlePack[store.lang]"
    />
    ...
    >
        ...
        <template #tab1>
            ...
            <div class="my-4">
                TS type:
                <code class="text-app-blue">VueUiCirclePackConfig</code>
            </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="gradient"
                                    :level="4"
                                    title="style.chart.circles.gradient"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.circles.gradient.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="intensity"
                                        attr="style.chart.circles.gradient.intensity"
                                        type="range"
                                        defaultVal="40"
                                        :min="0"
                                        :max="100"
                                ...
                                >
                                    ...
                                    <BaseDetails
                                        attr="name"
                                        :level="5"
                                        title="style.chart.circles.labels.name"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.circles.labels.name.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSizeRatio"
                                            attr="style.chart.circles.labels.name.fontSizeRatio"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="2"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.circles.labels.name.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.circles.labels.name.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.circles.labels.name.color"
                                            type="color"
                                            defaultVal="auto"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="'auto' adapts text color to background"
                                        />
                                    </BaseDetails>
                                    <BaseDetails
                                        attr="value"
                                        :level="5"
                                        title="style.chart.circles.labels.value"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.circles.labels.value.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSizeRatio"
                                            attr="style.chart.circles.labels.value.fontSizeRatio"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="2"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.circles.labels.value.color"
                                            type="color"
                                            defaultVal="auto"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.circles.labels.value.rounding"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.circles.labels.value.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.circles.labels.value.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.circles.labels.value.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.circles.labels.value.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
            ...
            >
                <template #top>
                    <BaseSlotsImplementationLink
                        link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-circle-pack.vue"
                    />
                </template>
            </BaseSlotDocumenter>
        </template>
