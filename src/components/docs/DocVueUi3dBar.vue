...
const shapeOptions = ref(["bar", "tube"]);
...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.bar3d[store.lang]"
        />
        ...
        <div :class="`mx-auto max-w-[400px]`">
            ...
            <div
                class="w-full mx-auto flex flex-row place-items-center justify-center mt-10 gap-3"
            >
        ...
        <div
            class="w-full mx-auto max-w-[600px] text-gray-500 mb-10 mt-5 text-center"
        >
                ...
                <code ref="configCode">
                    <BaseDetails attr="const config: VueUi3dBarConfig">
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    <span
                                        ><BaseComment
                                            >Animation only with percentage
                                            mode</BaseComment
                                        ></span
                                    >
                                    <BaseAttr
                                ...
                                >
                                    <BaseAttr
                                        name="color"
                                        attr="style.chart.bar.color"
                                        type="color"
                                        defaultVal="#5F8BEE"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Percentage mode only"
                                    />
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.bar.stroke"
                                        type="color"
                                        defaultVal="#5F8BEE"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.bar.strokeWidth"
                                        type="number"
                                        defaultVal="0.7"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="shadeColor"
                                        attr="style.chart.bar.shadeColor"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Stack mode only"
                                    />
                                </BaseDetails>
                                <BaseDetails
                                    attr="box"
                                    :level="3"
                                    title="style.chart.box"
                                >
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.box.stroke"
                                        type="color"
                                        defaultVal="#CCCCCC"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.box.strokeWidth"
                                        type="number"
                                        defaultVal="0.7"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.box.strokeDasharray"
                                        type="range"
                                        defaultVal="2"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseDetails
                                        attr="dimensions"
                                        :level="4"
                                        title="style.chart.box.dimensions"
                                    >
                                        <BaseAttr
                                            name="width"
                                            attr="style.chart.box.dimensions.width"
                                            type="number"
                                            defaultVal="128"
                                            :min="60"
                                            :max="360"
                                        ...
                                        <BaseAttr
                                            name="height"
                                            attr="style.chart.box.dimensions.height"
                                            type="number"
                                            defaultVal="256"
                                            :min="60"
                                            :max="1024"
                                        ...
                                        <BaseAttr
                                            name="top"
                                            attr="style.chart.box.dimensions.top"
                                            type="number"
                                            defaultVal="27"
                                            :min="0"
                                            :max="200"
                                        ...
                                        <BaseAttr
                                            name="right"
                                            attr="style.chart.box.dimensions.right"
                                            type="number"
                                            defaultVal="24"
                                            :min="0"
                                            :max="200"
                                        ...
                                        <BaseAttr
                                            name="bottom"
                                            attr="style.chart.box.dimensions.bottom"
                                            type="number"
                                            defaultVal="9"
                                            :min="0"
                                            :max="200"
                                        ...
                                        <BaseAttr
                                            name="left"
                                            attr="style.chart.box.dimensions.left"
                                            type="number"
                                            defaultVal="24"
                                            :min="0"
                                            :max="200"
                                        ...
                                        <BaseAttr
                                            name="perspective"
                                            attr="style.chart.box.dimensions.perspective"
                                            type="range"
                                            defaultVal="18"
                                            :min="0"
                                            :max="60"
                                ...
                                <BaseDetails
                                    attr="dataLabel"
                                    :level="3"
                                    title="style.chart.dataLabel"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.dataLabel.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="bold"
                                        attr="style.chart.dataLabel.bold"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.chart.dataLabel.color"
                                        type="color"
                                        defaultVal="#5F8BEE"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="fontSize"
                                        attr="style.chart.dataLabel.fontSize"
                                        type="number"
                                        defaultVal="12"
                                        :min="8"
                                        :max="42"
                                    ...
                                    <BaseAttr
                                        name="rounding"
                                        attr="style.chart.dataLabel.rounding"
                                        type="number"
                                        defaultVal="0"
                                        :min="0"
                                        :max="6"
                                ...
                                >
                                    <span
                                        ><BaseComment
                                            >Legend is for stack mode
                                            only</BaseComment
                                        ></span
                                    >
                                    <BaseAttr
                                        name="showDefault"
                                        attr="style.chart.legend.showDefault"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        ...
                                        attr="style.chart.legend.hideUnderPercentage"
                                        type="number"
                                        defaultVal="3"
                                        :min="1"
                                        :max="10"
                        ...
                        <BaseDetails attr="table" :level="1">
                            <span
                                ><BaseComment
                                    >Table is for stack mode only</BaseComment
                                ></span
                            >
                            <BaseAttr
                                name="show"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-3d-bar.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
