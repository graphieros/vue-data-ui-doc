...
<template>
    <div>
        ...
        <BaseDocDescription :text="translations.docs.tooltips.wordCloud[store.lang]" />
        ...
        <Box ref="box" showSlots showEmits showThemes showCallbacks showResponsive schema="vue_ui_word_cloud">
            <template #tab0>
