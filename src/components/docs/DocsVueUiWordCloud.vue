...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.wordCloud[store.lang]"
        />
                    ...
                    <VueDataUi
                        ...
                        :config="
                            isDarkMode
                                ...
                                : { ...mutableConfig, theme: selectedTheme }
                        "
                        :key="key"
                    />
                </BaseCard>
        ...
        <div class="w-full flex justify-center mt-6">
            <BaseViewExampleButton
                link="/examples/categories#vue-ui-word-cloud"
            />
        </div>
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiWordCloudConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiWordCloudConfig"
                        equal
                    >
                        <span
                            >responsive: false,
                        ...
                        >
                        <BaseAttr
                            name="strictPixelPadding"
                            attr="strictPixelPadding"
                            type="checkbox"
                            defaultVal="true"
                            :light="mutableConfig"
                            :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                <BaseDetails
                                    attr="words"
                                    :level="3"
                                    title="style.chart.words"
                                >
                                    <BaseAttr
                                        name="maxFontSize"
                                        attr="style.chart.words.maxFontSize"
                                        type="number"
                                        defaultVal="100"
                                        :min="20"
                                        :max="200"
                                    ...
                                    <BaseAttr
                                        name="minFontSize"
                                        attr="style.chart.words.minFontSize"
                                        type="number"
                                        defaultVal="10"
                                        :min="10"
                                        :max="200"
                                    ...
                                    <BaseAttr
                                        name="usePalette"
                                        attr="style.chart.words.usePalette"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="hoverOpacity"
                                        attr="style.chart.words.hoverOpacity"
                                        type="range"
                                        defaultVal="0.5"
                                        :min="0"
                                        :max="1"
                                    ...
                                    <BaseAttr
                                        name="selectedStroke"
                                        attr="style.chart.words.selectedStroke"
                                        type="color"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-word-cloud.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
