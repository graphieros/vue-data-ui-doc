            ...
            <BaseDetails attr="chart" :level="2" title="style.chart">
                ...
                <BaseDetails attr="layout" :level="3" title="style.chart.layout">
                    <BaseDetails attr="grid" :level="4" title="style.chart.layout.grid">
                        ...
                        <span>spaceBetween: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.grid.spaceBetween" :min="0" :max="5" :step="0.1"/><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.grid.spaceBetween" :min="0" :max="5" :step="0.1"/>, (default: 0)</span>
