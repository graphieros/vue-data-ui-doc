            ...
            <BaseDetails attr="chart" :level="2" title="style.chart">
                ...
                <BaseDetails attr="layout" :level="3" title="style.chart.layout">
                    <BaseDetails attr="grid" :level="4" title="style.chart.layout.grid">
                        <span>size: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.grid.size" :min="2" :max="50"/><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.grid.size" :min="2" :max="50"/>, (default: 20), <span class="text-app-blue text-xs">// {{ translations.docs.comments.waffle.gridSize[store.lang] }}</span></span>
                        <span>spaceBetween: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.grid.spaceBetween" :min="0" :max="5" :step="0.1" @change="forceChartUpdate"/><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.grid.spaceBetween" :min="0" :max="5" :step="0.1" @change="forceChartUpdate"/>, (default: 0)</span>
                    ...
                    <BaseDetails attr="labels" :level="4" title="style.chart.layout.labels">
                        <BaseDetails attr="captions" :level="5" title="style.chart.layout.labels.captions">
                            ...
                            <span>serieNameMaxAbbreviationSize: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.labels.captions.serieNameMaxAbbreviationSize" :min="0" :max="12" /><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.labels.captions.serieNameMaxAbbreviationSize" :min="0" :max="12"/>, (default: 3)</span>
                            <span>fontSize: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.labels.captions.fontSize" :min="8" :max="42" /><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.labels.captions.fontSize" :min="8" :max="42"/>, (default: 12)</span>
                            ...
                            <span>roundingValue: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.labels.captions.roundingValue" :min="0" :max="6" /><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.labels.captions.roundingValue" :min="0" :max="6"/>, (default: 0)</span>
                            <span>roundingPercentage: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.labels.captions.roundingPercentage" :min="0" :max="6" /><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.labels.captions.roundingPercentage" :min="0" :max="6"/>, (default: 0)</span>
                            <span>offsetX: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.labels.captions.offsetX" :min="-100" :max="100" /><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.labels.captions.offsetX" :min="-100" :max="100"/>, (default: 0)</span>
                            <span>offsetY: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.labels.captions.offsetY" :min="-100" :max="100" /><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.labels.captions.offsetY" :min="-100" :max="100"/>, (default: 0)</span>
                        </BaseDetails>
                    ...
                    <BaseDetails attr="rect" :level="4" title="style.chart.layout.rect">
                        ...
                        <span>rounding: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.rect.rounding" :min="0" :max="6"/><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.rect.rounding" :min="0" :max="6"/>, (default: 2)</span>
                        ...
                        <span>strokeWidth: <BaseNumberInput v-if="isDarkMode" v-model:value="mutableConfigDarkMode.style.chart.layout.rect.strokeWidth" :min="0" :max="12"/><BaseNumberInput v-else v-model:value="mutableConfig.style.chart.layout.rect.strokeWidth" :min="0" :max="12"/>, (default: 2)</span>
