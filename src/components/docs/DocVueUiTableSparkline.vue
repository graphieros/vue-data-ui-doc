...
<template>
    <div class="overflow-x-auto">
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.sparklineTable[store.lang]"
        />
        ...
        <div
            :class="`transition-all mx-auto no-style ${isFixed ? 'fixed bottom-16 w-[300px] max-h-[500px] left-0 z-50 border border-black dark:border-white bg-gray-100 dark:bg-[rgb(26,26,26)] shadow-xl' : 'max-w-[1200px]'}`"
        >
            <Suspense>
                <template #default>
                    <BaseCard>
        ...
        <Box ref="box" showEmits showSlots showCallbacks signInfo="both">
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiTableSparklineConfig</code>
                </div>
                ...
                <code ref="configCode">
                    ...
                    >
                        ...
                        />
                        <BaseAttr
                            name="roundingAverage"
                            attr="roundingAverage"
                            type="number"
                            defaultVal="0"
                            :min="0"
                            :max="6"
                        ...
                        <span
                            ...
                            <BaseComment
                                >Since v2.4.49 Include data column indices to
                                enable sorting functionality</BaseComment
                            ></span
                        >
                        <BaseAttr
                            name="sortedSeriesName"
                            attr="sortedSeriesName"
                            type="checkbox"
                            defaultVal="false"
                            :light="mutableConfig"
                            :dark="mutableConfigDarkMode"
                            comment="Since v2.4.49"
                        />
                        <BaseAttr
                            name="sortedSum"
                            attr="sortedSum"
                        ...
                        />
                        <BaseAttr
                            name="resetSortOnClickOutside"
                            attr="resetSortOnClickOutside"
                            type="checkbox"
                            defaultVal="false"
                            :light="mutableConfig"
                            :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="sparkline" :level="1">
                            ...
                            >
                                <BaseAttr
                                    name="width"
                                    attr="sparkline.dimensions.width"
                                    type="number"
                                    defaultVal="150"
                                    :min="100"
                                    :max="300"
                                ...
                                <BaseAttr
                                    name="heightRatio"
                                    attr="sparkline.dimensions.heightRatio"
                                    type="range"
                                    defaultVal="1"
                                    :min="0.5"
                                    :max="2"
                            ...
                            <BaseDetails
                                attr="animation"
                                :level="2"
                                title="sparkline.animation"
                            >
                                <BaseAttr
                                    name="show"
                                    attr="sparkline.animation.show"
                                    type="checkbox"
                                    defaultVal="true"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    ...
                                    attr="sparkline.animation.animationFrames"
                                    type="number"
                                    defaultVal="360"
                                    :min="60"
                                    :max="600"
                        ...
                        <BaseDetails attr="tbody" :level="1">
                            ...
                            />
                            <BaseAttr
                                name="showColorMarker"
                                attr="tbody.showColorMarker"
                                type="checkbox"
                                defaultVal="true"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            ...
                            <BaseDetails
                                attr="selectedColor"
                                :level="2"
                                title="tbody.selectedColor"
                            >
                                <BaseAttr
                                    name="useSerieColor"
                                    attr="tbody.selectedColor.useSerieColor"
                                    type="checkbox"
                                    defaultVal="true"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                ...
                                <BaseAttr
                                    name="fallback"
                                    attr="tbody.selectedColor.fallback"
                                    type="text"
                                    defaultVal="#E1E5E8"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                        ...
                        <BaseDetails attr="translations" :level="1">
                            ...
                            <BaseAttr
                                name="chart"
                                attr="translations.chart"
                                type="text"
                                defaultVal="Evolution"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                        </BaseDetails>
