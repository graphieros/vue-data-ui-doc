...
<template>
    <div class="overflow-x-auto">
        ...
        <div :class="`transition-all mx-auto no-style ${isFixed ? 'fixed bottom-0 w-[300px] max-h-[500px] left-0 z-50 overflow-auto border border-black dark:border-white bg-gray-100 dark:bg-[rgb(26,26,26)] shadow-xl' : 'max-w-[1200px] overflow-x-auto'}`">
