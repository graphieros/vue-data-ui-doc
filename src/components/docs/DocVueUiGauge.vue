...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.gauge[store.lang]"
        />
        ...
        >
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                >
                                    <BaseAttr
                                        name="radiusRatio"
                                        attr="style.chart.layout.radiusRatio"
                                        type="range"
                                        defaultVal="1"
                                        :min="0.5"
                                        :max="1"
                                    ...
                                    <BaseDetails
                                        attr="markers"
                                        :level="4"
                                        title="style.chart.layout.markers"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.markers.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.layout.markers.prefix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.layout.markers.suffix"
                                            type="text"
                                            defaultVal="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.markers.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.layout.markers.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSizeRatio"
                                            attr="style.chart.layout.markers.fontSizeRatio"
                                            type="range"
                                            defaultVal="1"
                                            :min="0.5"
                                            :max="2"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.layout.markers.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="roundingValue"
                                            attr="style.chart.layout.markers.roundingValue"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                    ...
                                    <BaseDetails
                                        attr="segmentNames"
                                        :level="4"
                                        title="style.chart.layout.segmentNames"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.segmentNames.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="curved"
                                            attr="style.chart.layout.segmentNames.curved"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetRatio"
                                            attr="style.chart.layout.segmentNames.offsetRatio"
                                            type="range"
                                            defaultVal="1.1"
                                            :min="0.6"
                                            :max="1.2"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.layout.segmentNames.fontSize"
                                            type="number"
                                            defaultVal="16"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="minFontSize"
                                            attr="style.chart.layout.segmentNames.minFontSize"
                                            type="number"
                                            defaultVal="6"
                                            :min="6"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="useSerieColor"
                                            attr="style.chart.layout.segmentNames.useSerieColor"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.segmentNames.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.layout.segmentNames.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="segmentSeparators"
                                        :level="4"
                                        title="style.chart.layout.segmentSeparators"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.segmentSeparators.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetOut"
                                            attr="style.chart.layout.segmentSeparators.offsetOut"
                                            type="range"
                                            defaultVal="0"
                                            :min="0"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="offsetIn"
                                            attr="style.chart.layout.segmentSeparators.offsetIn"
                                            type="range"
                                            defaultVal="0"
                                            :min="0"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.segmentSeparators.stroke"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.segmentSeparators.strokeWidth"
                                            type="number"
                                            defaultVal="2"
                                            :min="1"
                                            :max="12"
                                    ...
                                    <BaseDetails
                                        attr="indicatorArc"
                                        :level="4"
                                        title="style.chart.layout.indicatorArc"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.indicatorArc.show"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="Since v2.4.90"
                                        />
                                        <BaseAttr
                                            name="radius"
                                            attr="style.chart.layout.indicatorArc.radius"
                                            type="range"
                                            defaultVal="123"
                                            :min="0"
                                            :max="200"
                                        ...
                                        <BaseAttr
                                            name="fill"
                                            attr="style.chart.layout.indicatorArc.fill"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="pointer"
                                        :level="4"
                                        title="style.chart.layout.pointer"
                                    >
                                        <BaseAttr
                                            name="show"
                                            attr="style.chart.layout.pointer.show"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="type"
                                            attr="style.chart.layout.pointer.type"
                                            type="select"
                                            defaultVal="rounded"
                                        ...
                                        <BaseAttr
                                            name="size"
                                            attr="style.chart.layout.pointer.size"
                                            type="range"
                                            defaultVal="1"
                                            :min="0.5"
                                            :max="1.4"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.pointer.stroke"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.pointer.strokeWidth"
                                            type="number"
                                            defaultVal="12"
                                            :min="0"
                                            :max="12"
                                            ...
                                            :dark="mutableConfigDarkMode"
                                            @change="forceChartUpdate()"
                                            comment="Usable with pointer type rounded"
                                        />
                                        <BaseAttr
                                            name="useRatingColor"
                                            attr="style.chart.layout.pointer.useRatingColor"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.pointer.color"
                                            type="color"
                                            defaultVal="#CCCCCC"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="With useRatingColor set to false"
                                        />
                                        <BaseDetails
                                            attr="circle"
                                            :level="5"
                                            title="style.chart.layout.pointer.circle"
                                        >
                                            <BaseAttr
                                                name="radius"
                                                attr="style.chart.layout.pointer.circle.radius"
                                                type="number"
                                                defaultVal="10"
                                                :min="0"
                                                :max="24"
                                            ...
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.layout.pointer.circle.stroke"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="strokeWidth"
                                                attr="style.chart.layout.pointer.circle.strokeWidth"
                                                type="number"
                                                defaultVal="2"
                                                :min="0"
                                                :max="24"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.pointer.circle.color"
                                                type="color"
                                                defaultVal="#FFFFFF"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        <BaseAttr
                                            name="size"
                                            attr="style.chart.layout.track.size"
                                            type="range"
                                            defaultVal="1"
                                            :min="0.5"
                                            :max="4.5"
                                        ...
                                        <BaseAttr
                                            name="useGradient"
                                            attr="style.chart.layout.track.useGradient"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.layout.track.gradientIntensity"
                                            type="range"
                                            defaultVal="20"
                                            :min="8"
                                            :max="20"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="showPlusSymbol"
                                        attr="style.chart.legend.showPlusSymbol"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="useRatingColor"
                                        attr="style.chart.legend.useRatingColor"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
            ...
            <template #tab2>
                <ComponentEmits component="VueUiGauge" :names="['copyAlt']" />
                <ExposedMethods
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-gauge.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
