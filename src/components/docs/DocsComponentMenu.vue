            ...
            },
            {
                ...
                nodes: [
                    ...
                    { route: "/docs#vue-ui-kpi", name: "Kpi", icon: "kpiBox" },
                    {
                        ...
                        name: translations.value.utilityFunctions[store.lang],
                        icon: "func",
                    },
                ],
                icon: "func",
            ...
            <template #node="{ node }">
                <RouterLink v-if="node.route" :to="node.route">
                    ...
                    >
                        <VueUiIcon
                            size="100%"
                            :name="node.icon"
                            :stroke="adaptColorToBackground(node.color)"
                        />
                    </div>
                </RouterLink>
                <div
                ...
                >
                    ...
                    <img
                        ...
                        class="mx-auto drop-shadow-xl logo-shape"
                    />
                </div>
            </template>
        </VueUiMolecule>
