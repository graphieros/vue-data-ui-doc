...
const <span class="text-black dark:text-app-green">dataset: VueUiXyCanvasDatasetItem[]</span> = [
    ...
    <code>
        ...
        <div class="pt-4 border-t border-gray-700 overflow-x-auto">
          ...
          <div class="text-gray-400 pl-5 mb-4">
            {{ translations.docs.emits.generateCsv[store.lang] }}
          </div>
        </div>
        <div class="pt-4 border-t border-gray-700 overflow-x-auto">
        ...
        <div class="pt-4 border-t border-gray-700 overflow-x-auto">
          ...
          <div class="text-gray-400 pl-5 mb-4">
            {{ translations.docs.emits.toggleTable[store.lang] }}
          </div>
        </div>
        <div class="pt-4 border-t border-gray-700 overflow-x-auto">
          <div><code>toggleLabels</code></div>
          <div class="text-gray-400 pl-5 mb-4">
            {{ translations.docs.emits.toggleLabels[store.lang] }}
          </div>
        </div>
        <div class="pt-4 border-t border-gray-700 overflow-x-auto">
          <div><code>toggleStack</code></div>
          <div class="text-gray-400 pl-5 mb-4">
            {{ translations.docs.emits.toggleStack[store.lang] }}
          </div>
        </div>
      </template>
