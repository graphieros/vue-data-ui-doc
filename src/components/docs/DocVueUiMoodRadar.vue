...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.moodRadar[store.lang]"
        />
        ...
        >
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiMoodRadarConfig</code>
                </div>
                ...
                <code ref="configCode">
                    <BaseDetails
                        attr="const config: VueUiMoodRadarConfig"
                        equal
                    >
                        <span
                            >responsive: false;
                            ...
                            >
                                ...
                                >
                                    <BaseDetails
                                        attr="dataLabel"
                                        :level="4"
                                        title="style.chart.layout.dataLabel"
                                    >
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.dataLabel.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="roundingValue"
                                            attr="style.chart.layout.dataLabel.roundingValue"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.layout.dataLabel.roundingPercentage"
                                            type="number"
                                            defaultVal="0"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.layout.dataLabel.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="prefix"
                                            attr="style.chart.layout.dataLabel.prefix"
                                            type="text"
                                            defaultval="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="suffix"
                                            attr="style.chart.layout.dataLabel.suffix"
                                            type="text"
                                            defaultval="''"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.dataPolygon.color"
                                            type="color"
                                            defaultVal="#5F8BEE"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.layout.dataPolygon.stroke"
                                            type="color"
                                            defaultVal="#5F8BEE"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="gradient"
                                            :level="5"
                                            title="style.chart.layout.dataPolygon.gradient"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.dataPolygon.gradient.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="intensity"
                                                attr="style.chart.layout.dataPolygon.gradient.intensity"
                                                type="range"
                                                defaultVal="5"
                                                :min="0"
                                                :max="100"
                                    ...
                                    <BaseDetails
                                        attr="smileys"
                                        :level="4"
                                        title="style.chart.layout.smileys"
                                    >
                                        <BaseDetails
                                            attr="colors"
                                            :level="5"
                                            title="style.chart.layout.smileys.colors"
                                        >
                                            <BaseAttr
                                                name="'1'"
                                                :attr="`style.chart.layout.smileys.colors.1`"
                                                type="color"
                                                defaultVal="#E20001"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="'2'"
                                                :attr="`style.chart.layout.smileys.colors.2`"
                                                type="color"
                                                defaultVal="#FF9F03"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="'3'"
                                                :attr="`style.chart.layout.smileys.colors.3`"
                                                type="color"
                                                defaultVal="#FFD004"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="'4'"
                                                :attr="`style.chart.layout.smileys.colors.4`"
                                                type="color"
                                                defaultVal="#9AC900"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="'5'"
                                                :attr="`style.chart.layout.smileys.colors.5`"
                                                type="color"
                                                defaultVal="#059F00"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-mood-radar.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
