...
<template>
    <div>
        ...
        <div style="min-height: 100vh">
            ...
            <BaseDocDescription
                :text="translations.docs.tooltips.cursor[store.lang]"
            />
            ...
            <div class="my-12 w-full flex place-items-center justify-center">
                <button
                    :class="`select-none flex flex-col gap-2 place-items-center justify-center h-[100px] w-[100px] rounded-full text-black shadow-md cursor-pointer ${isActive ? 'bg-app-orange' : 'bg-app-green'} transition-colors`"
                    @click="isActive = !isActive"
                >
                    <VueUiIcon
                        :name="isActive ? 'squareFill' : 'arrowRight'"
                        stroke="#1A1A1A"
                    />
                    {{ isActive ? "STOP" : "START" }}
                </button>
            ...
            >
                <div class="flex flex-col mb-6 gap-2" v-if="isFixed">
                    ...
                    <button
                        @click="
                            copyToClipboard(
                                isDarkMode ? darkModeConfig : config,
                            )
                        "
            ...
            <Box :activeTab="1">
                ...
                <template #tab1>
                    ...
                    <div class="mt-4">
                        TS type:
                        <code class="text-app-blue">VueUiCursorConfig</code>
                    </div>
                    ...
                    <code ref="configCode">
                        <BaseDetails
                            attr="const config: VueUiCursorConfig"
                            equal
                        >
                            <BaseAttr
                                name="bubbleEffect"
                            ...
                            />
                            <BaseAttr
                                name="bubbleEffectColor"
                                attr="bubbleEffectColor"
                                type="color"
                                defaultVal="#FFFFFF"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="bubbleEffectOpacity"
                                attr="bubbleEffectOpacity"
                                type="range"
                                defaultVal="0.1"
                                :min="0"
                                :max="1"
                            ...
                            />
                            <BaseAttr
                                name="centerCircleDasharray"
                                attr="centerCircleDasharray"
                                type="range"
                                defaultVal="0"
                                :min="0"
                                :max="100"
                            ...
                            />
                            <BaseAttr
                                name="centerCircleOpacity"
                                attr="centerCircleOpacity"
                                type="range"
                                defaultVal="0"
                                :min="0"
                                :max="1"
                            ...
                            />
                            <BaseAttr
                                name="centerCircleStroke"
                                attr="centerCircleStroke"
                                type="color"
                                defaultVal="#CCCCCC"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            ...
                            <BaseAttr
                                ...
                                attr="showCoordinates"
                                type="checkbox"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="coordinatesColor"
                                attr="coordinatesColor"
                                type="color"
                                defaultVal="#CCCCCC"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="coordinatesFontSize"
                                attr="coordinatesFontSize"
                                type="range"
                                defaultVal="10"
                                :min="8"
                                :max="42"
                            ...
                            />
                            <BaseAttr
                                name="coordinatesOffset"
                                attr="coordinatesOffset"
                                type="range"
                                defaultVal="0"
                                :min="-100"
                                :max="100"
                            ...
                            />
                            <BaseAttr
                                name="crosshairDasharray"
                                attr="crosshairDasharray"
                                type="range"
                                defaultVal="0"
                                :min="0"
                                :max="100"
                            ...
                            />
                            <BaseAttr
                                name="crosshairStroke"
                                attr="crosshairStroke"
                                type="color"
                                defaultVal="#CCCCCC"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="crosshairStrokeWidth"
                                attr="crosshairStrokeWidth"
                                type="range"
                                defaultVal="0.5"
                                :min="0"
                                :max="24"
                            ...
                            <BaseAttr
                                name="showIntersectCircles"
                                attr="showIntersectCircles"
                                type="checkbox"
                                defaultVal="true"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="intersectCirclesFill"
                                attr="intersectCirclesFill"
                                type="color"
                                defaultVal="#CCCCCC"
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                            />
                            <BaseAttr
                                name="intersectCirclesRadius"
                                attr="intersectCirclesRadius"
                                type="range"
                                defaultVal="2"
                                :min="0"
                                :max="24"
                            ...
                            <BaseAttr
                                ...
                                :light="mutableConfig"
                                :dark="mutableConfigDarkMode"
                                comment="Use an id to only show the cursor on a specific element"
                            />
                            <BaseAttr
                                name="useWaveOnClick"
                                attr="useWaveOnClick"
