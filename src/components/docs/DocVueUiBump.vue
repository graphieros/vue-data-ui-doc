...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.bump[store.lang]"
        />
                    ...
                    <BaseDetails attr="const config: VueUiBumpConfig" equal>
                            ...
                            >
                                ...
                                >
                                    <BaseDetails
                                        attr="lines"
                                        :level="4"
                                        title="style.chart.layout.lines"
                                    >
                                        <BaseAttr
                                            name="smooth"
                                            attr="style.chart.layout.lines.smooth"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.layout.lines.strokeWidth"
                                            type="number"
                                            defaultVal="4"
                                            :min="0"
                                            :max="12"
                                        ...
                                        <BaseAttr
                                            name="coatingColor"
                                            attr="style.chart.layout.lines.coatingColor"
                                            type="color"
                                            defaultVal="#FFFFFF"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        ...
                                        <BaseDetails
                                            attr="labels"
                                            :level="5"
                                            title="style.chart.layout.plots.labels"
                                        >
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.layout.plots.labels.color"
                                                type="text"
                                                defaultVal="'auto'"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.plots.labels.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.layout.plots.labels.bold"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="displayedValue"
                                                attr="style.chart.layout.plots.labels.displayedValue"
                                                type="select"
                                                defaultVal="value"
                                                :options="['rank', 'value']"
                                                :light="mutableConfig"
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.layout.plots.labels.fontSize"
                                                type="number"
                                                defaultVal="12"
                                                :min="8"
                                                :max="24"
                                            ...
                                            <BaseAttr
                                                name="prefix"
                                                attr="style.chart.layout.plots.labels.prefix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="suffix"
                                                attr="style.chart.layout.plots.labels.suffix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="rounding"
                                                attr="style.chart.layout.plots.labels.rounding"
                                                type="number"
                                                defaultVal="0"
                                                :min="0"
                                                :max="6"
                                    ...
                                    <BaseDetails
                                        attr="nameLabels"
                                        :level="4"
                                        title="style.chart.layout.nameLabels"
                                    >
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.layout.nameLabels.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.nameLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="useSerieColor"
                                            attr="style.chart.layout.nameLabels.useSerieColor"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.layout.nameLabels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetX"
                                            attr="style.chart.layout.nameLabels.offsetX"
                                            type="number"
                                            defaultVal="0"
                                            :min="-24"
                                            :max="24"
                                        ...
                                        <BaseDetails
                                            attr="leftLabels"
                                            :level="5"
                                            title="style.chart.layout.nameLabels.leftLabels"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.nameLabels.leftLabels.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="rightLabels"
                                            :level="5"
                                            title="style.chart.layout.nameLabels.rightLabels"
                                        >
                                            <BaseAttr
                                                name="show"
                                                attr="style.chart.layout.nameLabels.rightLabels.show"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.layout.timeLabels.fontSize"
                                            type="number"
                                            defaultVal="14"
                                            :min="8"
                                            :max="42"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.layout.timeLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.layout.timeLabels.offsetY"
                                            type="number"
                                            defaultVal="0"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.layout.timeLabels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rotation"
                                            attr="style.chart.layout.timeLabels.rotation"
                                            type="range"
                                            defaultVal="0"
                                            :min="-90"
                                            :max="90"
                                        ...
                                        <BaseDetails
                                            attr="autoRotate"
                                            title="style.chart.layout.timeLabels.autoRotate"
                                        >
                                            <BaseAttr
                                                name="enable"
                                                type="checkbox"
                                                defaultVal="true"
                                                attr="style.chart.layout.timeLabels.autoRotate.enable"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            />
                                            <BaseAttr
                                                ...
                                                :min="-90"
                                                :max="90"
                                                attr="style.chart.layout.timeLabels.autoRotate.angle"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            />
                                        </BaseDetails>
                                        <BaseDetails
                                            ...
                                            :level="6"
                                            title="style.chart.layout.timeLabels.datetimeFormatter"
                                        >
                                            <BaseAttr
                                                name="enable"
                                                attr="style.chart.layout.timeLabels.datetimeFormatter.enable"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="locale"
                                                attr="style.chart.layout.timeLabels.datetimeFormatter.locale"
                                                type="select"
                                                defaultVal="en"
                                            ...
                                            <BaseAttr
                                                name="useUTC"
                                                attr="style.chart.layout.timeLabels.datetimeFormatter.useUTC"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="januaryAsYear"
                                                attr="style.chart.layout.timeLabels.datetimeFormatter.januaryAsYear"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseDetails
                                                attr="options"
                                                :level="7"
                                                title="style.chart.layout.timeLabels.datetimeFormatter.options"
                                            >
                                                <BaseAttr
                                                    name="year"
                                                    attr="style.chart.layout.timeLabels.datetimeFormatter.options.year"
                                                    type="text"
                                                    defaultVal="yyyy"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="month"
                                                    attr="style.chart.layout.timeLabels.datetimeFormatter.options.month"
                                                    type="text"
                                                    :defaultVal="`MMM 'yy`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="day"
                                                    attr="style.chart.layout.timeLabels.datetimeFormatter.options.day"
                                                    type="text"
                                                    :defaultVal="`dd MMM`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="minute"
                                                    attr="style.chart.layout.timeLabels.datetimeFormatter.options.minute"
                                                    type="text"
                                                    :defaultVal="`HH:mm:ss`"
                                                    :light="mutableConfig"
                                                    :dark="
                                                ...
                                                <BaseAttr
                                                    name="second"
                                                    attr="style.chart.layout.timeLabels.datetimeFormatter.options.second"
                                                    type="text"
                                                    :defaultVal="`HH:mm:ss`"
                                                    :light="mutableConfig"
                                                    :dark="
                        ...
                        <BaseDetails attr="table" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="ranking"
                                    attr="table.columnNames.ranking"
                                    type="text"
                                    defaultVal="Ranking"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
