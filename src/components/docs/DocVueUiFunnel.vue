...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.funnel[store.lang]"
        />
        ...
        <Box
            ...
            showThemes
            showResponsive
            schema="vue_ui_funnel"
            signInfo="positiveOnly"
        >
            <template #tab0>
                <div
                    class="w-full overflow-x-auto border-b my-6 border-gray-700"
                >
                    <CodeParser
                        language="typescript"
                        @copy="store.copy()"
            ...
            <template #tab1>
                ...
                <div class="mt-4">
                    TS type:
                    <code class="text-app-blue">VueUiFunnelConfig</code>
                </div>
                <div class="my-4">
                    Toggle tree view:
                    ...
                    <BaseDetails attr="const config: VueUiFunnelConfig" equal>
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                />
                                <BaseAttr
                                    name="barCircleSpacingRatio"
                                    attr="style.chart.barCircleSpacingRatio"
                                    type="range"
                                    defaultVal="0.05"
                                    :min="0"
                                    :max="1"
                                ...
                                <BaseDetails
                                    attr="circles"
                                    :level="3"
                                    title="style.chart.circles"
                                >
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.circles.stroke"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.circles.strokeWidth"
                                        type="range"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseDetails
                                        attr="dataLabels"
                                        :level="4"
                                        title="style.chart.circles.dataLabels"
                                    >
                                        <div
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.circles.dataLabels.fontSize"
                                            defaultVal="16"
                                            :min="8"
                                            :max="42"
                                            type="number"
                                        ...
                                        <BaseAttr
                                            name="offsetY"
                                            attr="style.chart.circles.dataLabels.offsetY"
                                            defaultVal="0"
                                            type="number"
                                            :min="-100"
                                            :max="100"
                                        ...
                                        <BaseAttr
                                            ...
                                            attr="style.chart.circles.dataLabels.adaptColorToBackground"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.circles.dataLabels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="rounding"
                                            attr="style.chart.circles.dataLabels.rounding"
                                            type="number"
                                            defaultVal="1"
                                            :min="0"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.circles.dataLabels.bold"
                                            type="checkbox"
                                            defaultVal="true"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="circleLinks"
                                    :level="3"
                                    title="style.chart.circleLinks"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.circleLinks.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.chart.circleLinks.color"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="widthRatio"
                                        attr="style.chart.circleLinks.widthRatio"
                                        type="range"
                                        :min="0.1"
                                        :max="3"
                                        :step="0.1"
                                ...
                                >
                                    ...
                                    <BaseAttr
                                        name="defaultColor"
                                        attr="style.chart.bars.defaultColor"
                                        type="color"
                                        defaultVal="#1f77b4"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    >
                                        <BaseDetails
                                            attr="name"
                                            :level="5"
                                            title="style.chart.bars.dataLabels.name"
                                        >
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.bars.dataLabels.name.fontSize"
                                                type="number"
                                                defaultVal="16"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.bars.dataLabels.name.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.bars.dataLabels.name.bold"
                                                type="checkbox"
                                                defaultVal="true"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.bars.dataLabels.name.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.chart.bars.dataLabels.name.offsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                        ...
                                        <BaseDetails
                                            attr="value"
                                            :level="5"
                                            title="style.chart.bars.dataLabels.value"
                                        >
                                            <div
                                                class="flex flex-row gap-2 place-items-center"
                                            >
                                            ...
                                            <BaseAttr
                                                name="fontSize"
                                                attr="style.chart.bars.dataLabels.value.fontSize"
                                                type="number"
                                                defaultVal="16"
                                                :min="8"
                                                :max="42"
                                            ...
                                            <BaseAttr
                                                name="rounding"
                                                attr="style.chart.bars.dataLabels.value.rounding"
                                                type="number"
                                                defaultVal="0"
                                                :min="0"
                                                :max="6"
                                            ...
                                            <BaseAttr
                                                name="bold"
                                                attr="style.chart.bars.dataLabels.value.bold"
                                                type="checkbox"
                                                defaultVal="false"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="color"
                                                attr="style.chart.bars.dataLabels.value.color"
                                                type="color"
                                                defaultVal="#2D353C"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="prefix"
                                                attr="style.chart.bars.dataLabels.value.prefix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="suffix"
                                                attr="style.chart.bars.dataLabels.value.suffix"
                                                type="text"
                                                defaultVal="''"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="offsetX"
                                                attr="style.chart.bars.dataLabels.value.offsetX"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
                                            ...
                                            <BaseAttr
                                                name="offsetY"
                                                attr="style.chart.bars.dataLabels.value.offsetY"
                                                type="number"
                                                defaultVal="0"
                                                :min="-100"
                                                :max="100"
            ...
            <!--EMITS-->
            <template #tab2>
                <ComponentEmits component="VueUiFunnel" :names="['copyAlt']" />
                <ExposedMethods
                    component="VueUiFunnel"
                    getImage
        ...
        <span class="text-gray-400">&lt;/script&gt;</span>
            ...
            <template #tab3>
                <BaseSlotDocumenter
                    ...
                    :types="['svg', 'watermark', 'source', 'chart-background']"
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-funnel.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
