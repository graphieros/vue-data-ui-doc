...
<template>
    <div>
        ...
        <BaseDocDescription
            :text="translations.docs.tooltips.dag[store.lang]"
        />
                    ...
                    <BaseDetails attr="const config: VueUiDagConfig" equal>
                        ...
                        <BaseDetails attr="userOptions" :level="1">
                            ...
                            >
                                ...
                                <BaseAttr
                                    name="zoom"
                                    attr="userOptions.buttonTitles.zoom"
                                    type="text"
                                    defaultVal="Toggle zoom lock"
                                    :light="mutableConfig"
                                    :dark="mutableConfigDarkMode"
                                />
                            </BaseDetails>
                        ...
                        <BaseDetails attr="style" :level="1">
                            ...
                            >
                                ...
                                />
                                <BaseDetails
                                    attr="backgroundPattern"
                                    title="style.chart.backgroundPattern"
                                    :level="3"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.backgroundPattern.show"
                                        type="checkbox"
                                        defaultVal="false"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="spacingRatio"
                                        attr="style.chart.backgroundPattern.spacingRatio"
                                        type="range"
                                        defaultVal="3"
                                        :min="1"
                                        :max="5"
                                    ...
                                    <BaseAttr
                                        name="dotRadiusRatio"
                                        attr="style.chart.backgroundPattern.dotRadiusRatio"
                                        type="range"
                                        defaultVal="5"
                                        :min="1"
                                        :max="10"
                                    ...
                                    <BaseAttr
                                        name="dotColor"
                                        attr="style.chart.backgroundPattern.dotColor"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="opacity"
                                        attr="style.chart.backgroundPattern.opacity"
                                        type="range"
                                        defaultVal="1"
                                        :min="0"
                                        :max="1"
                                ...
                                >
                                    <BaseAttr
                                        name="rankDirection"
                                        attr="style.chart.layout.rankDirection"
                                        type="select"
                                        defaultVal="TB"
                                        :options="['TB', 'RL', 'BT', 'RL']"
                                        :light="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="rankSeparation"
                                        attr="style.chart.layout.rankSeparation"
                                        type="number"
                                        defaultVal="60"
                                        :min="10"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="nodeSeparation"
                                        attr="style.chart.layout.nodeSeparation"
                                        type="number"
                                        defaultVal="50"
                                        :min="10"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="edgeSeparation"
                                        attr="style.chart.layout.edgeSeparation"
                                        type="number"
                                        defaultVal="30"
                                        :min="10"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="nodeWidth"
                                        attr="style.chart.layout.nodeWidth"
                                        type="number"
                                        defaultVal="100"
                                        :min="10"
                                        :max="200"
                                    ...
                                    <BaseAttr
                                        name="nodeHeight"
                                        attr="style.chart.layout.nodeHeight"
                                        type="number"
                                        defaultVal="40"
                                        :min="10"
                                        :max="80"
                                    ...
                                    <BaseAttr
                                        name="curvedEdges"
                                        attr="style.chart.layout.curvedEdges"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="padding"
                                        attr="style.chart.layout.padding"
                                        type="number"
                                        defaultVal="48"
                                        :min="0"
                                        :max="100"
                                    ...
                                    <BaseAttr
                                        name="arrowShape"
                                        attr="style.chart.layout.arrowShape"
                                        type="select"
                                        defaultVal="'vee'"
                                        :options="[
                                            'undirected',
                                    ...
                                    <BaseAttr
                                        name="arrowSize"
                                        attr="style.chart.layout.arrowSize"
                                        type="number"
                                        defaultVal="8"
                                        :min="2"
                                        :max="20"
                                ...
                                <BaseDetails
                                    attr="nodes"
                                    title="style.chart.nodes"
                                    :level="3"
                                >
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.nodes.stroke"
                                        type="color"
                                        defaultVal="#CCCCCC"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.nodes.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="borderRadius"
                                        attr="style.chart.nodes.borderRadius"
                                        type="number"
                                        defaultVal="3"
                                        :min="0"
                                        :max="12"
                                    ...
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.chart.nodes.backgroundColor"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Individual colors can be defined in the dataset"
                                    />
                                    <BaseDetails
                                        attr="labels"
                                        title="style.chart.nodes.labels"
                                        :level="4"
                                    >
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.nodes.labels.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="fontSize"
                                            attr="style.chart.nodes.labels.fontSize"
                                            type="number"
                                            defaultVal="12"
                                            :min="8"
                                            :max="24"
                                        ...
                                        <BaseAttr
                                            name="bold"
                                            attr="style.chart.nodes.labels.bold"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="tooltip"
                                        title="style.chart.nodes.tooltip"
                                        :level="4"
                                    >
                                        <BaseAttr
                                            name="showOnClick"
                                            attr="style.chart.nodes.tooltip.showOnClick"
                                            type="checkbox"
                                            defaultVal="false"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="Tip: use the #tooltip-node slot to customize tooltip content"
                                        />
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.chart.nodes.tooltip.backgroundColor"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.nodes.tooltip.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="maxWidth"
                                            attr="style.chart.nodes.tooltip.maxWidth"
                                            type="text"
                                            defaultVal="'300px'"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="selected"
                                        title="style.chart.nodes.selected"
                                        :level="4"
                                    >
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.nodes.selected.stroke"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="strokeWidth"
                                            attr="style.chart.nodes.selected.strokeWidth"
                                            type="number"
                                            defaultVal="null"
                                            :min="1"
                                            :max="6"
                                        ...
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.chart.nodes.selected.backgroundColor"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="labelColor"
                                            attr="style.chart.nodes.selected.labelColor"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        />
                                        <BaseDetails
                                            attr="downstreamEdges"
                                            title="style.chart.nodes.selected.downstreamEdges"
                                            :level="5"
                                        >
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.nodes.selected.downstreamEdges.stroke"
                                                type="color"
                                                defaultVal="null"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="animated"
                                                attr="style.chart.nodes.selected.downstreamEdges.animated"
                                                type="checkbox"
                                                defaultVal="null"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseDetails
                                            attr="upstreamEdges"
                                            title="style.chart.nodes.selected.upstreamEdges"
                                            :level="5"
                                        >
                                            <BaseAttr
                                                name="stroke"
                                                attr="style.chart.nodes.selected.upstreamEdges.stroke"
                                                type="color"
                                                defaultVal="null"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                            ...
                                            <BaseAttr
                                                name="animated"
                                                attr="style.chart.nodes.selected.upstreamEdges.animated"
                                                type="checkbox"
                                                defaultVal="null"
                                                :light="mutableConfig"
                                                :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="edges"
                                    title="style.chart.edges"
                                    :level="3"
                                >
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.edges.stroke"
                                        type="color"
                                        defaultVal="#CCCCCC"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.edges.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="1"
                                        :max="12"
                                    ...
                                    <BaseDetails
                                        attr="animations"
                                        :level="4"
                                        title="style.chart.edges.animations"
                                    >
                                        <BaseAttr
                                            name="dasharray"
                                            attr="style.chart.edges.animations.dasharray"
                                            type="text"
                                            defaultVal="'2 6'"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                            comment="Can also be set individually in dataset.edges"
                                        />
                                        <BaseAttr
                                            name="animationDurationMs"
                                            attr="style.chart.edges.animations.animationDurationMs"
                                            type="number"
                                            defaultVal="1000"
                                            :min="0"
                                            :max="5000"
                                ...
                                <BaseDetails
                                    attr="midpoints"
                                    title="style.chart.midpoints"
                                    :level="3"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.midpoints.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="Tip: use the #tooltip-midpoint slot to customize tooltip content"
                                    />
                                    <BaseAttr
                                        name="radius"
                                        attr="style.chart.midpoints.radius"
                                        type="number"
                                        defaultVal="4"
                                        :min="0"
                                        :max="16"
                                    ...
                                    <BaseAttr
                                        name="stroke"
                                        attr="style.chart.midpoints.stroke"
                                        type="color"
                                        defaultVal="#CCCCCC"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="fill"
                                        attr="style.chart.midpoints.fill"
                                        type="color"
                                        defaultVal="#FFFFFF"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="strokeWidth"
                                        attr="style.chart.midpoints.strokeWidth"
                                        type="number"
                                        defaultVal="1"
                                        :min="1"
                                        :max="12"
                                    ...
                                    <BaseDetails
                                        attr="tooltip"
                                        title="style.chart.midpoints.tooltip"
                                        :level="4"
                                    >
                                        <BaseAttr
                                            name="maxWidth"
                                            attr="style.chart.midpoints.tooltip.maxWidth"
                                            type="text"
                                            defaultVal="'300px'"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="backgroundColor"
                                            attr="style.chart.midpoints.tooltip.backgroundColor"
                                            type="color"
                                            defaultVal="#E1E5E8"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="color"
                                            attr="style.chart.midpoints.tooltip.color"
                                            type="color"
                                            defaultVal="#2D353C"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseDetails
                                        attr="selectedEdge"
                                        title="style.chart.midpoints.selectedEdge"
                                        :level="4"
                                    >
                                        <BaseAttr
                                            name="stroke"
                                            attr="style.chart.midpoints.selectedEdge.stroke"
                                            type="color"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                        ...
                                        <BaseAttr
                                            name="animated"
                                            attr="style.chart.midpoints.selectedEdge.animated"
                                            type="checkbox"
                                            defaultVal="null"
                                            :light="mutableConfig"
                                            :dark="mutableConfigDarkMode"
                                ...
                                <BaseDetails
                                    attr="controls"
                                    title="style.chart.controls"
                                    :level="3"
                                >
                                    <BaseAttr
                                        name="show"
                                        attr="style.chart.controls.show"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="position"
                                        attr="style.chart.controls.position"
                                        type="select"
                                        defaultVal="'bottom'"
                                        :options="['top', 'bottom']"
                                        :light="mutableConfig"
                                    ...
                                    <BaseAttr
                                        name="backgroundColor"
                                        attr="style.chart.controls.backgroundColor"
                                        type="color"
                                        defaultVal="#E1E5E8"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="color"
                                        attr="style.chart.controls.color"
                                        type="color"
                                        defaultVal="#2D353C"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="fontSize"
                                        attr="style.chart.controls.fontSize"
                                        type="number"
                                        defaultVal="14"
                                        :min="8"
                                        :max="24"
                                    ...
                                    <BaseAttr
                                        name="border"
                                        attr="style.chart.controls.border"
                                        type="text"
                                    ...
                                    <BaseAttr
                                        name="padding"
                                        attr="style.chart.controls.padding"
                                        type="text"
                                        defaultVal="'0.5rem'"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                    ...
                                    <BaseAttr
                                        name="borderRadius"
                                        attr="style.chart.controls.borderRadius"
                                        type="text"
                                        defaultVal="'0.25rem'"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                ...
                                >
                                    <BaseAttr
                                        name="active"
                                        attr="style.chart.zoom.active"
                                        type="checkbox"
                                        defaultVal="true"
                                        :light="mutableConfig"
                                        :dark="mutableConfigDarkMode"
                                        comment="When inactive, pan zoom is disabled, but controls can still be used"
                                    />
                                </BaseDetails>
                                <BaseDetails
                                    attr="title"
                ...
                >
                    <template #top>
                        <BaseSlotsImplementationLink
                            link="https://github.com/graphieros/vue-data-ui/blob/master/ts-playground/src/components/charts/ts-vue-ui-dag.vue"
                        />
                    </template>
                </BaseSlotDocumenter>
            </template>
