...
<template>
    <div>
        <h1 class="text-center font-inter-medium text-app-blue mb-2 text-2xl">
            {{ title }}
        </h1>
        <p
        ...
        <div class="w-full flex place-items-center place-content-center my-6">
            <BaseButton
                ...
                :callback="
                    () => callbacks.copyToClipboard(mainConfig[jsonConfig])
                "
            >
                <template #icon>
                    <CopyIcon />
