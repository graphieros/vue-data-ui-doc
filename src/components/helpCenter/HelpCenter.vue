...
<template>
    <button @click="openHelpCenter" class="fixed z-50 right-2 top-[130px] flex place-items-center justify-center rounded-full bg-gradient-to-b from-[#ffa793] to-[#dd7963] h-[42px] w-[42px] hover:-translate-y-[2px] transition-all">
