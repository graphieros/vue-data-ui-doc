...
const dataset = computed(() => {
    return [
        ...
        {
            name: "Vue Data UI - Nuxt",
            value: store.stars_nuxt,
            color: "#42d392",
        },
        {
            name: "Vue Data UI - Docs",
            value: store.stars_docs,
            color: "#42d392",
        },
    ];
});
...
const hasAccess = computed(() => {
    return (
        store.stars && store.stars_cli && store.stars_nuxt && store.stars_docs
    );
});
        ...
        style: {
            ...
            chart: {
                ...
                layout: {
                    ...
                    highlighter: {
                        color: isDarkMode.value ? "#5f8aee" : "#1A1A1A",
                        opacity: 5,
                    },
                    separators: {
                        show: false,
