...
const methodMap = computed(() => {
    return {
        ...
        toggleTooltip: { name: 'toggleTooltip', description: translations.value.docs.emits.toggleTooltip[store.lang]},
        toggleFullscreen: { name: 'toggleFullscreen', description: translations.value.docs.emits.toggleFullscreen[store.lang]},
        toggleAnnotator: { name: 'toggleAnnotator', description: translations.value.docs.emits.toggleAnnotator[store.lang]},
        focusLocation: { name: 'focusLocation', description: translations.value.docs.emits.focusLocation[store.lang]},
