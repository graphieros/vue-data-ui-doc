...
<template>
    <dialog ref="chartMakerDialog" class="fixed p-6 glass h-screen  w-full max-w-[800px] rounded-lg bg-[#e1e5e890] dark:bg-[#2A2A2AAF] text-black dark:text-gray-300 border dark:border-app-green overflow-hidden" style="width:calc(100% - 48px);max-width:1200px">
        ...
        <div class="w-full overflow-y-auto mt-[64px]" style="height:calc(100% - 64px)">
            ...
            <div class="flex flex-row gap-3 place-items-end">
                ...
                <div class="w-full max-w-[500px]" v-if="datasetItems.length > 0 && datasetItems[0].series.length">
            ...
            <div class="flex flex-col gap-2">
                <div class="w-full relative bg-[#e1e5e866] shadow dark:shadow-md dark:bg-[#e1e5e812] p-3 rounded flex flex-row gap-3" v-for="(ds, i) in datasetItems">
