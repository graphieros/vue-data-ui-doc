...
const fncsy = ref({
    ...
    ja: `<span class="text-app-green-dark dark:text-app-green">作業時間を大幅に節約</span>できる
                ...
                <br/>
                <br/>
                すぐに利用可能な<span class="text-app-green-dark dark:text-app-green">本番環境対応ツール</span>にアクセス。クリエイター、デザイナー、開発者に信頼されています。スマートなパターンでデータを抽出、QRコードを生成、通貨を変換、CSVデータを変換、Base64をエンコード、UUIDを生成、IPを確認、サブネットを計算、パターンを作成 — <span class="text-app-green-dark dark:text-app-green">すべて数秒で、完全無料です</span>`,
