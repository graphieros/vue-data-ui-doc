...
<template>
    <router-link :to="link" @click="scrollToTop">
            <div class="relative peer h-full rounded-md flex flex-col gap-2 place-items-center place-content-center justify-between border border-black bg-gray-100 dark:bg-[rgb(35,35,35)] hover:shadow-xl hover:outline hover:outline-app-green transition-all">
