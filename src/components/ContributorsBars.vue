            ...
            chart: {
                ...
                tooltip: {
                    ...
                    customFormat: ({ datapoint }) => {
                        return `<div style="display: flex; flex-direction: column; align-items:center; justify-content:center; padding: 1rem; color:${isDarkMode.value ? '#CCCCCC' : '#1A1A1A'}">
                            <img height="40" width="40" style="height:40px;width:40px;border-radius:50%;box-shadow: 0 3px 6px - 3px rgba(0,0,0,0.3)" src="${datapoint.avatar}"/>
