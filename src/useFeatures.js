export function useFeatures() {
    const mapping = {
        ...
        VueUiHorizontalBar: { link: 'vue-ui-horizontal-bar', icon: 'chartVerticalBar', tooltip: true, legend: true, customPalette: true, },
        ...
        VueUiStackline: { link: 'vue-ui-stackline', icon: 'chartStackline', tooltip: true, legend: true, customPalette: true, },
