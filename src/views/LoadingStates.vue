...
<template>
    ...
    <div class="max-w-[1280px] px-12 2xl:px-4 mx-auto relative my-12">
        <h1 dir="auto" class="text-[36px] text-center">
    ...
    <div class="mx-auto max-w-[1000px] mb-12" dir="auto">
        ...
        <div
            class="mt-4 w-full max-w-[400px] mx-auto p-4 rounded bg-white dark:bg-[#1A1A1A]"
        >
            <VueUiXy />
        </div>
    </div>
    ...
    <div
        class="flex place-items-center mx-auto max-w-[1000px] justify-center mb-12"
        dir="auto"
    >
    ...
    <article
        class="mx-auto max-w-[1000px] bg-white dark:bg-[#2A2A2A] py-2 px-4"
        dir="auto"
    >
        ...
        <p class="text-gray-500">
            {{ localTranslations.twinChartDescription[store.lang] }}
        </p>

        <div class="w-full max-w-[600px] mx-auto flex flex-col">
            <div class="flex flex-row gap-2 place-items-center my-4">
                <label for="toggleTwin">{{
                    localTranslations.toggleState[store.lang]
                }}</label>
                <input
                    id="toggleTwin"
                    type="checkbox"
                    v-model="loadingStates.twin"
                />
            </div>
            ...
            <ExampleLoadingXy
                :loading="loadingStates.twin"
                randomized-loading-data
            />

            <div class="mx-auto mt-12">
                <button
                    class="py-1 px-4 bg-gray-100 dark:bg-[#FFFFFF20] hover:bg-gray-200 dark:hover:bg-[#FFFFFF30] transition-colors flex flex-row place-items-center gap-2 justify-center"
                >
                    <BrandGithubFilledIcon />
                    <a
                        href="https://github.com/graphieros/vue-data-ui-doc/blob/master/src/components/examples/ExampleLoadingXy.vue"
                        target="_blank"
                    >
        ...
        <div class="w-full max-w-[600px] mx-auto flex flex-col mt-12">
            ...
            <div class="mx-auto mt-12">
                ...
                >
                    <BrandGithubFilledIcon />
                    <a
                        href="https://github.com/graphieros/vue-data-ui-doc/blob/master/src/components/examples/ExampleLoadingDonut.vue"
                        target="_blank"
                    >
                        {{ translations.githubCode[store.lang] }}
                    </a>
