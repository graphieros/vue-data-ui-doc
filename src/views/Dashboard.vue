    ...
    return [
        {
            component: defineAsyncComponent(() =>
                import("vue-data-ui").then((module) => module.VueUiXy),
            ),
            padding: "p-6",
            cols: "one",
            config: {
            ...
            dataset: [
                {
                    name: "Count",
                    series: [
                        2.54313038, 2.590270899, 2.640278797, 2.691979339,
                        2.746072141, 2.801002631, 2.857866857, 2.916108097,
                        2.970292188, 3.019233434, 3.068370609, 3.126686743,
                        3.195779247, 3.267212338, 3.337111983, 3.406417036,
                        3.475448166, 3.546810808, 3.620655275, 3.695390336,
                        3.770163092, 3.844800885, 3.920251504, 3.995517077,
                        4.069437231, 4.142505882, 4.21577249, 4.289657708,
                        4.365582871, 4.444007706, 4.524627658, 4.607984871,
                        4.691884238, 4.775836074, 4.861730613, 4.950063339,
                        5.040984495, 5.132293974, 5.223704308, 5.316175862,
                        5.406245867, 5.492686093, 5.577433523, 5.660727993,
                        5.743219454, 5.825145298, 5.906481261, 5.98731248,
                        6.067758458, 6.148898975, 6.230746982, 6.31240736,
                        6.393898365, 6.475751478, 6.558176119, 6.641416218,
                        6.725948544, 6.811597272, 6.898305908, 6.985603105,
                        7.073125425, 7.161697921, 7.25059337, 7.339013419,
                        7.426597537, 7.513474238, 7.599822404, 7.683789828,
                        7.764951032, 7.84095288, 7.909295151, 7.975105156,
                        8.045311447,
                    ],
                    type: "bar",
                },
        ...
        {
            component: defineAsyncComponent(() =>
                import("vue-data-ui").then((module) => module.VueUiDonut),
            ),
            padding: "p-6",
            cols: "one",
            config: {
        ...
        {
            component: defineAsyncComponent(() =>
                import("vue-data-ui").then((module) => module.VueUiRadar),
            ),
            padding: "p-6 px-10",
            cols: "one",
            config: {
        ...
        {
            component: defineAsyncComponent(() =>
                import("vue-data-ui").then((module) => module.VueUiChestnut),
            ),
            padding: "p-6",
            cols: "all",
            config: {
        ...
        {
            component: defineAsyncComponent(() =>
                import("vue-data-ui").then((module) => module.VueUiHeatmap),
            ),
            padding: "p-6",
            cols: "all",
                ...
                style: {
                    ...
                    layout: {
                        ...
                        dataLabels: {
                            xAxis: {
                                show: true,
                                values: heatmapDataset.value.map(
                                    (p) => p.short,
                                ),
                                fontSize: 8,
        ...
        {
            component: defineAsyncComponent(() =>
                import("vue-data-ui").then((module) => module.VueUiOnion),
            ),
            padding: "p-6",
            cols: "one",
            config: {
    ...
    <div class="mx-auto w-5/6 mt-12">
        ...
        >
            <div
                ...
                :style="
                    isDarkMode
                        ? 'background:radial-gradient(#5f8bee, transparent) !important'
                        : 'background:radial-gradient(#F3F4F6, transparent)'
                "
            />
            <AppSkeletons />
        </div>
