...
import TreemapXy from "../components/TreemapXy.vue";
...
const crumbs = ref([
    ...
    {
        description: translations.value.docs.dontTryThisAtHome[store.lang],
    },
]);
</script>
...
<template>
    ...
    <div
        class="max-w-[800px] mx-auto gap-4 mt-12 p-4 bg-white dark:bg-[#3A3A3A]"
    >
        <TreemapXy />
    </div>
</template>
